!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e, r) {
      ...
      var o = !1,
        ...
        s = !1,
        l = void 0,
        c = "object" === typeof self ? self : "object" === typeof e ? e : {},
        h = void 0;
      "undefined" !== typeof r ? (h = r) : "undefined" !== typeof c.vscode && (h = c.vscode.process);
      var f =
          "string" ===
            typeof (null === (i = null === h || void 0 === h ? void 0 : h.versions) || void 0 === i
              ? void 0
              : i.electron) && "renderer" === h.type,
        d = f && (null === h || void 0 === h ? void 0 : h.sandboxed);
      !(function () {
        if (d) return "bypassHeatCheck";
        var e = null === h || void 0 === h ? void 0 : h.env.ENABLE_VSCODE_BROWSER_CODE_LOADING;
      })();
      if ("object" !== typeof navigator || f)
        if ("object" === typeof h) {
          (o = "win32" === h.platform),
            (a = "darwin" === h.platform),
            (u = "linux" === h.platform) && !!h.env.SNAP && !!h.env.SNAP_REVISION,
            "en",
            "en";
          var m = h.env.VSCODE_NLS_CONFIG;
          if (m)
            try {
              var g = JSON.parse(m),
                v = g.availableLanguages["*"];
              g.locale, v || "en", g._translationsConfigFile;
            } catch (L) {}
          !0;
        } else console.error("Unable to resolve platform.");
      else
        (o = (l = navigator.userAgent).indexOf("Windows") >= 0),
      ...
      var p = o,
        ...
        C = (function () {
          ...
          if ("function" === typeof b.postMessage && !b.importScripts) {
            var e = [];
            ...
            return function (n) {
              var r = ++t;
              e.push({ id: r, callback: n }), b.postMessage({ vscodeSetImmediateId: r }, "*");
            };
          }
          if (h && "function" === typeof h.nextTick) return h.nextTick.bind(h);
  ...
  function (e, t) {
    ...
    var s,
      ...
      h = -1;
    function f() {
      c && s && ((c = !1), s.length ? (l = s.concat(l)) : (h = -1), l.length && d());
    }
    function d() {
      if (!c) {
        var e = u(f);
      ...
      return (
        ...
        (S.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            return (
              (a.type = e), (a.arg = t), o ? ((this.method = "next"), (this.next = o.finallyLoc), c) : this.complete(a)
            );
          },
          ...
          finish: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
              ...
              if (n.finallyLoc === e) return this.complete(n.completion, n.afterLoc), L(n), c;
            }
          },
          catch: function (e) {
            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
  ...
  function (e, t, n) {
          ...
          function (i) {
            for (;;)
              switch ((i.prev = i.next)) {
                case 0:
                  for (e = c.length, t = new Array(e), n = 0; n < e; n++) t[n] = c[n];
                  (r = 0), (o = t);
                case 2:
                  if (!(r < o.length)) {
                    i.next = 24;
            ...
            for (;;)
              switch ((o.prev = o.next)) {
                ...
                case 3:
                  ...
                  (r = n.value), (i = y(r)), (o.prev = 6), i.s();
                case 8:
                  if ((a = i.n()).done) {
                    o.next = 14;
                    break;
                  }
                  return (u = a.value), (o.next = 12), u;
                case 12:
                  o.next = 8;
                  break;
                case 14:
    ...
    function A(e) {
      return N ? (N.trackDisposable(e), e) : e;
    }
    var x = (function (e) {
      i(n, e);
      var t = l(n);
    ...
    function O(e) {
      if (S.is(e)) {
        ...
        if (n.length > 1) throw new x(n);
        return Array.isArray(e) ? [] : e;
      }
      if (e) return w(e), e.dispose(), e;
    }
    function T() {
        ...
        f(e, [
          {
            key: "dispose",
            value: function () {
              this._isDisposed || (w(this), (this._isDisposed = !0), this.clear());
            },
          },
          {
            key: "clear",
    ...
    var P = (function () {
      function e() {
        c(this, e), (this._store = new M()), A(this);
      }
      return (
        f(e, [
          {
    ...
    P.None = Object.freeze({ dispose: function () {} });
    var R = n(1);
    function U(e) {
      var t,
        n = [],
            ...
            },
            {
              ...
              value: function (e, t, n, r) {
                ...
                return this._requestHandlerFactory
                  ? ((this._requestHandler = this._requestHandlerFactory(o)), Promise.resolve(U(this._requestHandler)))
                  : (t &&
                      ...
                      self.require(
                        ...
                        function (n) {
                          (i._requestHandler = n.create(o)),
                            i._requestHandler ? e(U(i._requestHandler)) : t(new Error("No RequestHandler!"));
                        },
                        t,
                      );
                    }));
      ...
      return (
        (function e(t, n, r, i, o) {
          ...
          !(function (e, t, n, r, i, o) {
            ...
            for (var l = n; l <= i; l++)
              a > r ? (e[l] = o[u++]) : u > i ? (e[l] = o[a++]) : t(o[u], o[a]) < 0 ? (e[l] = o[u++]) : (e[l] = o[a++]);
          })(t, n, r, a, i, o);
        })(e, t, 0, e.length - 1, []),
        e
      );
    ...
    function Q(e, t) {
      t = z(149417, t);
      for (var n = 0, r = e.length; n < r; n++) t = z(e.charCodeAt(n), t);
      return t;
    }
    function X(e, t) {
          ...
          f(e, [
              ...
              value: function () {
                return (
                  this._finished ||
                    ...
                    this._wrapUp()),
                  J(this._h0) + J(this._h1) + J(this._h2) + J(this._h3) + J(this._h4)
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                for (
                  var o, a, u, s = this._h0, l = this._h1, c = this._h2, h = this._h3, f = this._h4, d = 0;
                  d < 80;
                  d++
                )
                  d < 20
                    ...
                    (u = (X(s, 5) + o + f + a + t.getUint32(4 * d, !1)) & 4294967295),
                    (f = h),
                    (h = c),
                    (c = X(l, 30)),
                    (l = s),
          ...
          f(e, [
            {
              ...
              value: function () {
                (this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
                  this.m_changes.push(
                    new H(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
                  ),
                  (this.m_originalCount = 0),
                  (this.m_modifiedCount = 0),
                  (this.m_originalStart = 1073741824),
            ...
            [
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  if (!i[0]) {
                    ...
                    return (
                      (f = i[0]
                        ? [new H(l + 1, t - (l + 1) + 1, c + 1, r - (c + 1) + 1)]
                        : this.ComputeDiffRecursive(l + 1, t, c + 1, r, i)),
                      this.ConcatenateChanges(h, f)
                    );
                  }
                  return [new H(e, t - e + 1, n, r - n + 1)];
                },
              },
              {
                key: "WALKTRACE",
                value: function (e, t, n, r, i, o, a, u, s, l, c, h, f, d, m, g, v, p) {
                  var _,
                    y = null,
                    b = new ie(),
                    C = t,
                  ...
                  do {
                    ...
                    N === C || (N < L && s[N - 1] < s[N + 1])
                      ...
                      : ((d = (c = s[N - 1] + 1) - S - r),
                        ...
                        (S = N - 1 - e)),
                      E >= 0 && ((e = (s = this.m_forwardHistory[E])[0]), (C = 1), (L = s.length - 1));
                  } while (--E >= -1);
                  if (((_ = b.getReverseChanges()), p[0])) {
                    ...
                    if (null !== _ && _.length > 0) {
                      var x = _[_.length - 1];
                      (w = Math.max(w, x.getOriginalEnd())), (A = Math.max(A, x.getModifiedEnd()));
                    }
                    y = [new H(w, h - w + 1, A, m - A + 1)];
                  } else {
                    (b = new ie()),
                      (C = o),
                      (L = a),
                      (S = f[0] - g[0] - u),
                      (k = 1073741824),
                      (E = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2);
                    do {
                      var O = S + i;
                      O === C || (O < L && l[O - 1] >= l[O + 1])
                        ? ((d = (c = l[O + 1] - 1) - S - u),
                        ...
                        : ((d = (c = l[O - 1]) - S - u),
                          ...
                          (S = O - 1 - i)),
                        E >= 0 && ((i = (l = this.m_reverseHistory[E])[0]), (C = 1), (L = l.length - 1));
                    } while (--E >= -1);
                    y = b.getChanges();
                  }
              ...
              },
              {
                ...
                value: function (e, t, n, r, i, o, a) {
                  ...
                  for (var L = 1; L <= d / 2 + 1; L++) {
                    var S = 0,
                      k = 0;
                    (l = this.ClipDiagonalBound(p - L, L, p, m)), (c = this.ClipDiagonalBound(p + L, L, p, m));
                    for (var E = l; E <= c; E += 2) {
                      s = (u = E === l || (E < c && g[E - 1] < g[E + 1]) ? g[E + 1] : g[E - 1] + 1) - (E - p) - y;
                      for (var N = u; u < t && s < r && this.ElementsAreEqual(u + 1, s + 1); ) u++, s++;
                      if (
                        ((g[E] = u), u + s > S + k && ((S = u), (k = s)), !C && Math.abs(E - _) <= L - 1 && u >= v[E])
                      )
                        return (
                          (i[0] = u),
                          (o[0] = s),
                          N <= v[E] && L <= 1448
                            ? this.WALKTRACE(p, l, c, y, _, h, f, b, g, v, u, t, i, s, r, o, C, a)
                            : null
                        );
                    }
                    var w = (S - e + (k - n) - L) / 2;
                    if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(S, w))
                      return (
                        (a[0] = !0),
                        (i[0] = S),
                        (o[0] = k),
                        w > 0 && L <= 1448
                          ? this.WALKTRACE(p, l, c, y, _, h, f, b, g, v, u, t, i, s, r, o, C, a)
                          : (e++, n++, [new H(e, t - e + 1, n, r - n + 1)])
                      );
                    (h = this.ClipDiagonalBound(_ - L, L, _, m)), (f = this.ClipDiagonalBound(_ + L, L, _, m));
                    for (var A = h; A <= f; A += 2) {
                      s = (u = A === h || (A < f && v[A - 1] >= v[A + 1]) ? v[A + 1] - 1 : v[A - 1]) - (A - _) - b;
                      for (var x = u; u > e && s > n && this.ElementsAreEqual(u, s); ) u--, s--;
                    ...
                    if (L <= 1447) {
                      ...
                      (O[0] = p - l + 1),
                        re.Copy2(g, l, O, 1, c - l + 1),
                        this.m_forwardHistory.push(O),
                        ((O = new Int32Array(f - h + 2))[0] = _ - h + 1),
                        re.Copy2(v, h, O, 1, f - h + 1),
                        this.m_reverseHistory.push(O);
                    }
                  }
                  return this.WALKTRACE(p, l, c, y, _, h, f, b, g, v, u, t, i, s, r, o, C, a);
                },
              },
              {
                key: "PrettifyChanges",
                value: function (e) {
                  ...
                  for (var s = e.length - 1; s >= 0; s--) {
                    ...
                    if (s > 0) {
                      var f = e[s - 1];
                      f.originalLength > 0 && (c = f.originalStart + f.originalLength),
                        f.modifiedLength > 0 && (h = f.modifiedStart + f.modifiedLength);
                    }
                    for (
                      var d = l.originalLength > 0,
                        m = l.modifiedLength > 0,
                        g = 0,
                        v = this._boundaryScore(l.originalStart, l.originalLength, l.modifiedStart, l.modifiedLength),
                        p = 1;
                      ;
                      p++
                    ) {
                      var _ = l.originalStart - p,
                        y = l.modifiedStart - p;
                      if (_ < c || y < h) break;
                      if (d && !this.OriginalElementsAreEqual(_, _ + l.originalLength)) break;
                      if (m && !this.ModifiedElementsAreEqual(y, y + l.modifiedLength)) break;
                      var b = this._boundaryScore(_, l.originalLength, y, l.modifiedLength);
                      b > v && ((v = b), (g = p));
                    }
                  ...
                  if (this._hasStrings)
                    for (var C = 1, L = e.length; C < L; C++) {
                      var S = e[C - 1],
                        k = e[C],
                        E = k.originalStart - S.originalStart - S.originalLength,
                        N = S.originalStart,
                        w = k.originalStart + k.originalLength,
                        A = w - N,
                        x = S.modifiedStart,
                        O = k.modifiedStart + k.modifiedLength,
                        T = O - x;
                      if (E < 5 && A < 20 && T < 20) {
                        var I = this._findBetterContiguousSequence(N, A, x, T, E);
                        if (I) {
                          var M = q(I, 2),
                            P = M[0],
                            R = M[1];
                          (P === S.originalStart + S.originalLength && R === S.modifiedStart + S.modifiedLength) ||
                            ((S.originalLength = P - S.originalStart),
                            (S.modifiedLength = R - S.modifiedStart),
                            (k.originalStart = P + E),
                            (k.modifiedStart = R + E),
                            (k.originalLength = w - k.originalStart),
                            (k.modifiedLength = O - k.modifiedStart));
                        }
                      }
                    }
                  return e;
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  for (var o = e + t - i + 1, a = n + r - i + 1, u = 0, s = 0, l = 0, c = e; c < o; c++)
                    for (var h = n; h < a; h++) {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (e._isStringArray(n)) {
                    for (var r = new Int32Array(n.length), i = 0, o = n.length; i < o; i++) r[i] = Q(n[i], 0);
                    return [n, r, !0];
                  }
      ...
      ue = (function (e) {
        ...
        function n(e, r, i) {
          ...
          var u = -1 !== e.indexOf(".") ? "property" : "argument",
            s = 'The "'.concat(e, '" ').concat(u, " ").concat(a, " of type ").concat(r);
          return (s += ". Received type ".concat(typeof i)), ((o = t.call(this, s)).code = "ERR_INVALID_ARG_TYPE"), o;
        }
        return f(n);
      })(C(Error));
    function se(e, t) {
      if ("string" !== typeof e) throw new ue(t, "string", e);
    }
    function le(e) {
      return 47 === e || 92 === e;
    }
          ...
          if (a === l - 1 || 1 === u);
            ...
            if (i.length < 2 || 2 !== o || 46 !== i.charCodeAt(i.length - 1) || 46 !== i.charCodeAt(i.length - 2)) {
              if (i.length > 2) {
                ...
                -1 === c ? ((i = ""), (o = 0)) : (o = (i = i.slice(0, c)).length - 1 - i.lastIndexOf(n)),
                  (a = l),
                  (u = 0);
                continue;
              }
            ...
            i.length > 0 ? (i += "".concat(n).concat(e.slice(a + 1, l))) : (i = e.slice(a + 1, l)), (o = l - a - 1);
          (a = l), (u = 0);
        } else 46 === s && -1 !== u ? ++u : (u = -1);
      }
      return i;
    ...
    function de(e, t) {
      if (null === t || "object" !== typeof t) throw new ue("pathObject", "Object", t);
      var n = t.dir || t.root,
    ...
    var me = {
        resolve: function () {
          for (var e = "", t = "", n = !1, r = arguments.length - 1; r >= -1; r--) {
            var i = void 0;
            if (r >= 0) {
              if ((se((i = r < 0 || arguments.length <= r ? void 0 : arguments[r]), "path"), 0 === i.length)) continue;
            } else
              0 === e.length
                ? (i = ae.a())
            ...
            if (1 === o) le(l) && ((a = 1), (s = !0));
              ...
              if (((s = !0), le(i.charCodeAt(1)))) {
                for (var c = 2, h = c; c < o && !le(i.charCodeAt(c)); ) c++;
                if (c < o && c !== h) {
                  var f = i.slice(h, c);
                  for (h = c; c < o && le(i.charCodeAt(c)); ) c++;
                  if (c < o && c !== h) {
                    for (h = c; c < o && !le(i.charCodeAt(c)); ) c++;
                    (c !== o && c === h) || ((u = "\\\\".concat(f, "\\").concat(i.slice(h, c))), (a = c));
                  }
                }
              } else a = 1;
            else
              he(l) &&
                58 === i.charCodeAt(1) &&
                ((u = i.slice(0, 2)), (a = 2), o > 2 && le(i.charCodeAt(2)) && ((s = !0), (a = 3)));
            if (u.length > 0)
              if (e.length > 0) {
            ...
            if (n) {
              if (e.length > 0) break;
            } else if (((t = "".concat(i.slice(a), "\\").concat(t)), (n = s), s && e.length > 0)) break;
          }
          return (t = fe(t, !n, "\\", le)), n ? "".concat(e, "\\").concat(t) : "".concat(e).concat(t) || ".";
        },
        normalize: function (e) {
          ...
          var n,
            ...
            i = !1,
            o = e.charCodeAt(0);
          if (1 === t) return ce(o) ? "\\" : e;
          if (le(o))
            if (((i = !0), le(e.charCodeAt(1)))) {
              for (var a = 2, u = a; a < t && !le(e.charCodeAt(a)); ) a++;
              if (a < t && a !== u) {
                var s = e.slice(u, a);
                for (u = a; a < t && le(e.charCodeAt(a)); ) a++;
                if (a < t && a !== u) {
                  for (u = a; a < t && !le(e.charCodeAt(a)); ) a++;
                  if (a === t) return "\\\\".concat(s, "\\").concat(e.slice(u), "\\");
                  a !== u && ((n = "\\\\".concat(s, "\\").concat(e.slice(u, a))), (r = a));
                }
              }
            } else r = 1;
          else
            he(o) &&
              58 === e.charCodeAt(1) &&
              ((n = e.slice(0, 2)), (r = 2), t > 2 && le(e.charCodeAt(2)) && ((i = !0), (r = 3)));
          var l = r < t ? fe(e.slice(r), !i, "\\", le) : "";
          return (
            0 !== l.length || i || (l = "."),
            l.length > 0 && le(e.charCodeAt(t - 1)) && (l += "\\"),
            void 0 === n ? (i ? "\\".concat(l) : l) : i ? "".concat(n, "\\").concat(l) : "".concat(n).concat(l)
          );
        },
        isAbsolute: function (e) {
          ...
          return le(n) || (t > 2 && he(n) && 58 === e.charCodeAt(1) && le(e.charCodeAt(2)));
        },
        join: function () {
          if (0 === arguments.length) return ".";
          for (var e, t, n = 0; n < arguments.length; ++n) {
            var r = n < 0 || arguments.length <= n ? void 0 : arguments[n];
            se(r, "path"), r.length > 0 && (void 0 === e ? (e = t = r) : (e += "\\".concat(r)));
          }
          if (void 0 === e) return ".";
          var i = !0,
            o = 0;
          if ("string" === typeof t && le(t.charCodeAt(0))) {
            ++o;
            var a = t.length;
            a > 1 && le(t.charCodeAt(1)) && (++o, a > 2 && (le(t.charCodeAt(2)) ? ++o : (i = !1)));
          }
          if (i) {
            for (; o < e.length && le(e.charCodeAt(o)); ) o++;
        ...
        relative: function (e, t) {
          ...
          for (var a = o - i, u = 0; u < t.length && 92 === t.charCodeAt(u); ) u++;
          ...
          if (f !== c) {
            ...
            a > c && (92 === e.charCodeAt(i + f) ? (h = f) : 2 === f && (h = 3)), -1 === h && (h = 0);
          }
          var m = "";
          for (f = i + h + 1; f <= o; ++f) (f !== o && 92 !== e.charCodeAt(f)) || (m += 0 === m.length ? ".." : "\\..");
          return (
            (u += h), m.length > 0 ? "".concat(m).concat(r.slice(u, s)) : (92 === r.charCodeAt(u) && ++u, r.slice(u, s))
          );
        },
        toNamespacedPath: function (e) {
          ...
          } else if (he(t.charCodeAt(0)) && 58 === t.charCodeAt(1) && 92 === t.charCodeAt(2))
            return "\\\\?\\".concat(t);
          return e;
        },
        dirname: function (e) {
          ...
          var n = -1,
            r = 0,
            i = e.charCodeAt(0);
          if (1 === t) return le(i) ? e : ".";
          if (le(i)) {
            if (((n = r = 1), le(e.charCodeAt(1)))) {
              for (var o = 2, a = o; o < t && !le(e.charCodeAt(o)); ) o++;
              if (o < t && o !== a) {
                for (a = o; o < t && le(e.charCodeAt(o)); ) o++;
                if (o < t && o !== a) {
                  for (a = o; o < t && !le(e.charCodeAt(o)); ) o++;
                  if (o === t) return e;
                  o !== a && (n = r = o + 1);
          ...
          } else he(i) && 58 === e.charCodeAt(1) && (r = n = t > 2 && le(e.charCodeAt(2)) ? 3 : 2);
          for (var u = -1, s = !0, l = t - 1; l >= r; --l)
            if (le(e.charCodeAt(l))) {
              if (!s) {
                u = l;
                break;
              }
        ...
        basename: function (e, t) {
          ...
          var n,
            ...
            o = !0;
          if (
            (e.length >= 2 && he(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (r = 2),
            ...
            for (n = e.length - 1; n >= r; --n) {
              ...
              if (le(s)) {
                ...
                -1 === u && ((o = !1), (u = n + 1)),
                  a >= 0 && (s === t.charCodeAt(a) ? -1 === --a && (i = n) : ((a = -1), (i = u)));
            }
            return r === i ? (i = u) : -1 === i && (i = e.length), e.slice(r, i);
          }
          for (n = e.length - 1; n >= r; --n)
        ...
        extname: function (e) {
          ...
          var t = 0,
            ...
            o = !0,
            a = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && he(e.charCodeAt(0)) && (t = r = 2);
        ...
        parse: function (e) {
          ...
          var n = e.length,
            r = 0,
            i = e.charCodeAt(0);
          if (1 === n) return le(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
          if (le(i)) {
            if (((r = 1), le(e.charCodeAt(1)))) {
              for (var o = 2, a = o; o < n && !le(e.charCodeAt(o)); ) o++;
              if (o < n && o !== a) {
                for (a = o; o < n && le(e.charCodeAt(o)); ) o++;
                if (o < n && o !== a) {
                  for (a = o; o < n && !le(e.charCodeAt(o)); ) o++;
                  o === n ? (r = o) : o !== a && (r = o + 1);
                }
          ...
          } else if (he(i) && 58 === e.charCodeAt(1)) {
            if (n <= 2) return (t.root = t.dir = e), t;
            if (((r = 2), le(e.charCodeAt(2)))) {
              if (3 === n) return (t.root = t.dir = e), t;
              r = 3;
            }
          }
          r > 0 && (t.root = e.slice(0, r));
          for (var u = -1, s = r, l = -1, c = !0, h = e.length - 1, f = 0; h >= r; --h)
            if (le((i = e.charCodeAt(h)))) {
              if (!c) {
                s = h + 1;
                break;
              }
              ...
              -1 === l && ((c = !1), (l = h + 1)),
                46 === i ? (-1 === u ? (u = h) : 1 !== f && (f = 1)) : -1 !== u && (f = -1);
          return (
            -1 !== l &&
              (-1 === u || 0 === f || (1 === f && u === l - 1 && u === s + 1)
                ? (t.base = t.name = e.slice(s, l))
                : ((t.name = e.slice(s, u)), (t.base = e.slice(s, l)), (t.ext = e.slice(u, l)))),
      ...
      ge = {
        resolve: function () {
          ...
          return (e = fe(e, !t, "/", ce)), t ? "/".concat(e) : e.length > 0 ? e : ".";
        },
        normalize: function (e) {
          if ((se(e, "path"), 0 === e.length)) return ".";
          var t = 47 === e.charCodeAt(0),
            n = 47 === e.charCodeAt(e.length - 1);
          return 0 === (e = fe(e, !t, "/", ce)).length
            ? t
              ? "/"
              : n
                ? "./"
        ...
        isAbsolute: function (e) {
          return se(e, "path"), e.length > 0 && 47 === e.charCodeAt(0);
        },
        join: function () {
          if (0 === arguments.length) return ".";
        ...
        relative: function (e, t) {
          ...
          for (var n = e.length, r = n - 1, i = t.length - 1, o = r < i ? r : i, a = -1, u = 0; u < o; u++) {
          ...
          if (u === o)
            ...
            } else r > o && (47 === e.charCodeAt(1 + u) ? (a = u) : 0 === u && (a = 0));
          var l = "";
          for (u = 1 + a + 1; u <= n; ++u) (u !== n && 47 !== e.charCodeAt(u)) || (l += 0 === l.length ? ".." : "/..");
        ...
        parse: function (e) {
          ...
          var n,
            r = 47 === e.charCodeAt(0);
          r ? ((t.root = "/"), (n = 1)) : (n = 0);
          for (var i = -1, o = 0, a = -1, u = !0, s = e.length - 1, l = 0; s >= n; --s) {
            var c = e.charCodeAt(s);
            if (47 !== c)
              -1 === a && ((u = !1), (a = s + 1)),
                46 === c ? (-1 === i ? (i = s) : 1 !== l && (l = 1)) : -1 !== i && (l = -1);
            else if (!u) {
              o = s + 1;
              break;
            }
          ...
          if (-1 !== a) {
            ...
            -1 === i || 0 === l || (1 === l && i === a - 1 && i === o + 1)
              ...
              : ((t.name = e.slice(h, i)), (t.base = e.slice(h, a)), (t.ext = e.slice(i, a)));
          }
    ...
    function be(e, t) {
      ...
      if (e.scheme && !pe.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
      if (e.path)
        if (e.authority) {
          if (!_e.test(e.path))
            throw new Error(
    ...
    var Se = "/",
              ...
              },
              {
                ...
                value: function (e) {
                  var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    n = ke.exec(e);
                  return n
                    ? new we(n[2] || "", Pe(n[4] || ""), Pe(n[5] || ""), Pe(n[7] || ""), Pe(n[9] || ""), t)
                    : new we("", "", "", "", "");
                },
              },
              {
                ...
                value: function (e) {
                  var t = "";
                  if ((R.d && (e = e.replace(/\\/g, Se)), e[0] === Se && e[1] === Se)) {
                    var n = e.indexOf(Se, 2);
                    -1 === n ? ((t = e.substring(2)), (e = Se)) : ((t = e.substring(2, n)), (e = e.substring(n) || Se));
                  }
                  return new we("file", t, e, "", "");
                },
              },
              {
                key: "from",
                value: function (e) {
                  return new we(e.scheme, e.authority, e.path, e.query, e.fragment);
                },
              },
              {
                key: "joinPath",
                value: function (t) {
                  ...
                  for (var n, r, i, o = arguments.length, a = new Array(o > 1 ? o - 1 : 0), u = 1; u < o; u++)
                    a[u - 1] = arguments[u];
                  R.d && "file" === t.scheme
                    ? (n = e.file((r = me).join.apply(r, [Te(t, !0)].concat(a))).path)
              ...
              },
              {
                ...
                value: function (t) {
                  if (t) {
                    ...
                    var n = new we(t);
                    return (n._formatted = t.external), (n._fsPath = t._sep === Ne ? t.fsPath : null), n;
                  }
                  return t;
                },
              },
      ...
      we = (function (e) {
        ...
        function n() {
          var e;
          return c(this, n), ((e = t.apply(this, arguments))._formatted = null), (e._fsPath = null), e;
        }
        return (
          f(n, [
            {
            ...
            },
            {
              ...
              value: function () {
                var e = { $mid: 1 };
                return (
                  this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Ne)),
    ...
    function Ie(e, t) {
      ...
      if (a) {
        if (a.length >= 3 && 47 === a.charCodeAt(0) && 58 === a.charCodeAt(2)) {
          ...
          h >= 65 && h <= 90 && (a = "/".concat(String.fromCharCode(h + 32), ":").concat(a.substr(3)));
        } else if (a.length >= 2 && 58 === a.charCodeAt(1)) {
          var f = a.charCodeAt(0);
          f >= 65 && f <= 90 && (a = "".concat(String.fromCharCode(f + 32), ":").concat(a.substr(2)));
        }
        r += n(a, !0);
      }
      return u && ((r += "?"), (r += n(u, !1))), s && ((r += "#"), (r += t ? s : xe(s, !1))), r;
    }
              ...
              },
              {
                ...
                value: function (t, n) {
                  var r = t.startLineNumber,
                    ...
                    c = n.endColumn;
                  return (
                    r < u ? ((r = u), (i = s)) : r === u && (i = Math.max(i, s)),
                    o > l ? ((o = l), (a = c)) : o === l && (a = Math.min(a, c)),
                    ...
                    if (n === r) {
                      ...
                      if (i === o) {
                        var a = 0 | e.endLineNumber,
                          u = 0 | t.endLineNumber;
                        return a === u ? (0 | e.endColumn) - (0 | t.endColumn) : a - u;
                      }
                      return i - o;
                    }
                    return n - r;
    ...
    var Fe = (function () {
        function e(t) {
          c(this, e);
          for (var n = [], r = [], i = 0, o = t.length; i < o; i++) (n[i] = He(t[i], 1)), (r[i] = Ve(t[i], 1));
              ...
              value: function (e, t, n) {
                for (var r = [], i = [], o = [], a = 0, u = t; u <= n; u++)
                  for (
                    ...
                    (r[a] = s.charCodeAt(h - 1)), (i[a] = u + 1), (o[a] = h), a++;
                return new Ke(r, i, o);
              },
            },
          ]),
      ...
      Ke = (function () {
        function e(t, n, r) {
          c(this, e), (this._charCodes = t), (this._lineNumbers = n), (this._columns = r);
        }
        return (
          f(e, [
            {
              ...
              value: function (t, n, r, i, o, a, u) {
                ...
                if (
                  ...
                  u &&
                    ...
                    (f = []);
                  for (var v = 0, p = g.length; v < p; v++) f.push(Be.createFromDiffChange(g[v], d, m));
                }
      ...
      qe = (function () {
        function e(t, n, r) {
          c(this, e),
            ...
            (this.continueLineDiff = Ye(r.maxComputationTime)),
            (this.continueCharDiff = Ye(0 === r.maxComputationTime ? 0 : Math.min(r.maxComputationTime, 5e3)));
        }
        return (
          f(e, [
            {
              ...
              value: function () {
                ...
                for (var a = [], u = 0, s = 0, l = -1, c = t.length; l < c; l++) {
                  for (
                    ...
                    if (m !== g) {
                      for (var v = He(m, 1), p = He(g, 1); v > 1 && p > 1; ) {
                        if (m.charCodeAt(v - 2) !== g.charCodeAt(p - 2)) break;
                        v--, p--;
                      }
                      (v > 1 || p > 1) && this._pushTrimWhitespaceCharChange(a, u + 1, 1, v, s + 1, 1, p);
                      for (var _ = Ve(m, 1), y = Ve(g, 1), b = m.length + 1, C = g.length + 1; _ < b && y < C; ) {
                        if (m.charCodeAt(_ - 1) !== m.charCodeAt(y - 1)) break;
                        _++, y++;
                      }
                      (_ < b || y < C) && this._pushTrimWhitespaceCharChange(a, u + 1, _, b, s + 1, y, C);
                    }
                    u++, s++;
                  }
                  h &&
            ...
            },
            {
              ...
              value: function (e, t, n, r, i, o, a) {
                if (!this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, a)) {
                  var u = void 0;
                  this.shouldComputeCharChanges && (u = [new Be(t, n, t, r, i, o, i, a)]),
                    e.push(new We(t, t, i, i, u));
                }
              },
            },
            {
              ...
              value: function (e, t, n, r, i, o, a) {
                ...
                return (
                  ...
                  this.shouldComputeCharChanges && s.charChanges && s.charChanges.push(new Be(t, n, t, r, i, o, i, a)),
                  !0)
                );
              },
            },
        ...
        return (
          f(e, [
            ...
            },
            {
              ...
              value: function (e) {
                return e < 0 ? 0 : ((e = Ge(e)), this._getAccumulatedValue(e));
              },
            },
            {
    ...
    var et = (function () {
      ...
      nt = (function () {
        function e(t) {
          ...
          n++, r++;
          for (var h = new tt(r, n, 0), f = 0, d = t.length; f < d; f++) {
            var m = q(t[f], 3),
              g = m[0],
              v = m[1],
              p = m[2];
            ...
            value: function (e, t, n, r, i) {
              ...
              if (r > 0) {
                var u = t.charCodeAt(r - 1),
                  s = t.charCodeAt(o);
                ((40 === u && 41 === s) || (91 === u && 93 === s) || (123 === u && 125 === s)) && o--;
              }
              return {
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                for (
                  var u = t.getLineContent(o), s = u.length, l = 0, c = 0, h = 0, f = 1, d = !1, m = !1, g = !1, v = !1;
                  l < s;
                  ...
                  if (13 === f) {
                    ...
                    1 === y && (i.push(e._createLink(r, u, o, c, l)), (p = !0));
                  } else if (12 === f) {
                    var b = void 0;
                    91 === _ ? ((m = !0), (b = 0)) : (b = r.get(_)), 1 === b ? (p = !0) : (f = 13);
                  } else 0 === (f = n.nextState(f, _)) && (p = !0);
                  p && ((f = 1), (d = !1), (m = !1), (v = !1), (c = l + 1), (h = _)), l++;
                }
    ...
    var ct = f(function e(t) {
      c(this, e), (this.element = t), (this.next = e.Undefined), (this.prev = e.Undefined);
    });
    ct.Undefined = new ct(void 0);
    var ht,
      ft = (function (e) {
        function t() {
          c(this, t), (this._first = ct.Undefined), (this._last = ct.Undefined), (this._size = 0);
        }
        return (
          f(t, [
            {
            ...
            },
            {
              key: "isEmpty",
              value: function () {
                return this._first === ct.Undefined;
              },
            },
            {
              key: "clear",
              value: function () {
                (this._first = ct.Undefined), (this._last = ct.Undefined), (this._size = 0);
              },
            },
            {
              key: "unshift",
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this,
                  r = new ct(e);
                if (this._first === ct.Undefined) (this._first = r), (this._last = r);
                else if (t) {
                  var i = this._last;
            ...
            },
            {
              key: "_remove",
              value: function (e) {
                if (e.prev !== ct.Undefined && e.next !== ct.Undefined) {
                  var t = e.prev;
                  (t.next = e.next), (e.next.prev = t);
                } else
                  e.prev === ct.Undefined && e.next === ct.Undefined
                    ? ((this._first = ct.Undefined), (this._last = ct.Undefined))
                    : e.next === ct.Undefined
                      ? ((this._last = this._last.prev), (this._last.next = ct.Undefined))
                      : e.prev === ct.Undefined &&
                        ((this._first = this._first.next), (this._first.prev = ct.Undefined));
                this._size -= 1;
              },
            },
            {
      ...
      mt = (function () {
        function e(t) {
          c(this, e), (this._highResolution = dt && t), (this._startTime = this._now()), (this._stopTime = -1);
        }
        return (
          f(
            e,
              ...
              n = e(function (e) {
                s++,
                  ...
                  (u = setTimeout(function () {
                    var e = a;
                    (a = void 0), (u = void 0), (!i || s > 1) && l.fire(e), (s = 0);
                  }, r));
              });
            },
            onLastListenerRemove: function () {
      ...
      (e.chain = function (e) {
        ...
        (e.fromNodeEventEmitter = function (e, t) {
          var n =
            ...
            a = new vt({ onFirstListenerAdd: i, onLastListenerRemove: o });
          return a.event;
        }),
        ...
        f(e, [
              ...
              return (
                this._event ||
                  (this._event = function (n, r, i) {
                    var o;
                    t._listeners || (t._listeners = new ft());
                    ...
                    var s,
                      l = null === (o = t._leakageMon) || void 0 === o ? void 0 : o.check(t._listeners.size);
                    return (
                      (s = {
                        dispose: function () {
                          (l && l(), (s.dispose = e._noop), t._disposed) ||
                            (u(),
                            t._options &&
          ...
          },
          {
            ...
            value: function (e) {
              var t, n;
              if (this._listeners) {
                this._deliveryQueue || (this._deliveryQueue = new ft());
                var r,
                  i = y(this._listeners);
                try {
                  for (i.s(); !(r = i.n()).done; ) {
                ...
                for (
                  ...
                  var a = q(this._deliveryQueue.shift(), 2),
                    u = a[0],
                    s = a[1];
                  try {
                    "function" === typeof u ? u.call(void 0, s) : u[0].call(u[1], s);
                  } catch (c) {
                    m(c);
                  }
                }
    ...
    ((_t = pt || (pt = {})).isCancellationToken = function (e) {
      return (
        e === _t.None ||
        e === _t.Cancelled ||
        e instanceof Ct ||
      ...
      (_t.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: ht.None })),
      (_t.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: yt }));
    var bt,
      Ct = (function () {
        function e() {
        ...
        return (
          f(e, [
            ...
            },
            {
              ...
              get: function () {
                return this._isCancelled ? yt : (this._emitter || (this._emitter = new vt()), this._emitter.event);
              },
            },
            {
              key: "dispose",
        ...
        return (
          f(e, [
            ...
            },
            {
              key: "cancel",
              value: function () {
                this._token ? this._token instanceof Ct && this._token.cancel() : (this._token = pt.Cancelled);
              },
            },
            {
              key: "dispose",
              value: function () {
                ...
                e && this.cancel(),
                  ...
                  this._token ? this._token instanceof Ct && this._token.dispose() : (this._token = pt.None);
              },
            },
          ]),
          e
      ...
      St = (function () {
        function e() {
          c(this, e), (this._keyCodeToStr = []), (this._strToKeyCode = Object.create(null));
        }
        return (
          f(e, [
            {
    ...
    !(function () {
      function e(e, t) {
        ...
        kt.define(e, t), Et.define(e, n), Nt.define(e, r);
      }
      e(0, "unknown"),
        e(1, "Backspace"),
        e(2, "Tab"),
      ...
      (function (e) {
        (e.toString = function (e) {
          ...
          (e.fromUserSettings = function (e) {
            return Et.strToKeyCode(e) || Nt.strToKeyCode(e);
          });
      })(bt || (bt = {}));
    var wt,
      At,
      ...
      ln = (function () {
        function e(t, n, r) {
          c(this, e), (this.offset = 0 | t), (this.type = n), (this.language = r);
        }
        return (
          f(e, [
            {
    ...
    (cn.CtrlCmd = 2048), (cn.Shift = 1024), (cn.Alt = 512), (cn.WinCtrl = 256);
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = (function e(t, n, r, i) {
                  var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : $e;
                  if (r.length > o.maxLen) {
                    var a = t - o.maxLen / 2;
                    return a < 0 ? (a = 0) : (i += a), e(t, n, (r = r.substring(a, t + o.maxLen / 2)), i, o);
                  }
                  for (
                    var u = Date.now(), s = t - 1 - i, l = -1, c = null, h = 1;
                    !(Date.now() - u >= o.timeBudget);
                    h++
                  ) {
                    var f = s - o.windowSize * h;
                  ...
                  if (c) {
                    var m = { word: c[0], startColumn: i + 1 + c.index, endColumn: i + 1 + c.index + c[0].length };
                ...
                return n ? new Ue(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null;
              },
            },
            {
              key: "words",
                      ...
                      for (;;)
                        switch ((u.prev = u.next)) {
                          case 0:
                            ...
                            return (s = i.substring(a[o].start, a[o].end)), (o += 1), (u.next = 6), s;
                          case 6:
                            u.next = 16;
                            break;
                          case 8:
                            ...
                            (i = t[r]), (a = n(i, e)), (o = 0), (r += 1), (u.next = 16);
                            break;
                          case 15:
        ...
        return (
          f(e, [
            ...
            },
            {
              key: "acceptNewModel",
              value: function (e) {
                this._models[e.url] = new fn(Ee.parse(e.url), e.lines, e.EOL, e.versionId);
              },
            },
            {
                          ...
                          switch ((i.prev = i.next)) {
                            ...
                            case 4:
                              return (
                                ...
                                (c = l.computeDiff()),
                                (h = !(c.changes.length > 0) && this._modelsAreIdentical(o, a)),
                                i.abrupt("return", { quitEarly: c.quitEarly, identical: h, changes: c.changes })
                              );
                            case 10:
                            case "end":
                              return i.stop();
            ...
            },
            {
              ...
              value: function (t, n) {
                return hn(
                  ...
                  void 0,
                  E.a.mark(function r() {
                    var i, o, a, u, s, l, c, h, f, d, m, g, v, p, _, b, C, L;
                    return E.a.wrap(
                      function (r) {
                        for (;;)
                          switch ((r.prev = r.next)) {
                              ...
                              (o = []),
                                ...
                                (n = W(n, function (e, t) {
                                  return e.range && t.range
                                    ? Ue.compareRangesUsingStarts(e.range, t.range)
                            ...
                            case 14:
                              if (((d = i.getValueInRange(c)), (h = h.replace(/\r\n|\n|\r/g, i.eol)), d !== h)) {
                                r.next = 18;
                                break;
                              }
                              return r.abrupt("continue", 25);
                            case 18:
                              if (!(Math.max(h.length, d.length) > e._diffLimit)) {
                                r.next = 21;
                                break;
                              }
                              return o.push({ range: c, text: h }), r.abrupt("continue", 25);
                            case 21:
                              (m = te(d, h, !1)), (g = i.offsetAt(Ue.lift(c).getStartPosition())), (v = y(m));
                              try {
                                for (v.s(); !(p = v.n()).done; )
                                  (_ = p.value),
                                    (b = i.positionAt(g + _.originalStart)),
                                    (C = i.positionAt(g + _.originalStart + _.originalLength)),
                                    (L = {
                                    ...
                                    i.getValueInRange(L.range) !== L.text && o.push(L);
                              } catch (S) {
                                v.e(S);
                              } finally {
                                v.f();
                        ...
                        for (;;)
                          switch ((o.prev = o.next)) {
                            ...
                            case 6:
                              ...
                              if (((h = c.value), (f = this._getModel(h)))) {
                                o.next = 11;
                                break;
                              }
                              return o.abrupt("continue", 31);
                            case 11:
                              (d = y(f.words(u))), (o.prev = 12), d.s();
                            case 14:
                              if ((m = d.n()).done) {
                                o.next = 23;
                                break;
                            ...
                            case 18:
                              if ((s.add(g), !(s.size > e._suggestionsLimit))) {
                                o.next = 21;
                                break;
                              }
                            ...
                            case 41:
                              return o.abrupt("return", { words: Array.from(s), duration: a.elapsed() });
                            case 42:
                            case "end":
                              return o.stop();
                          }
                      ...
                      function (i) {
                        for (;;)
                          switch ((i.prev = i.next)) {
                            ...
                            case 3:
                              (a = new RegExp(n, r)), (u = Object.create(null)), (s = t.startLineNumber);
                            case 6:
                              if (!(s < t.endLineNumber)) {
                                i.next = 31;
                                break;
                              }
                              (l = o.getLineWords(s, a)), (c = y(l)), (i.prev = 9), c.s();
                            case 11:
                              if ((h = c.n()).done) {
                                i.next = 20;
                                break;
                          ...
                          switch ((o.prev = o.next)) {
                            ...
                            case 3:
                              if (
                                ...
                                (l = a.getWordAtPosition({ lineNumber: t.startLineNumber, column: t.startColumn }, u)))
                              ) {
                                o.next = 9;
                                break;
                              }
                            ...
                            case 9:
                              return (
                                ...
                                (h = lt.INSTANCE.navigateValueSet(t, s, l, c, n)),
                                o.abrupt("return", h)
                              );
                            case 12:
                            case "end":
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                return this._foreignModuleFactory
                  ? ((this._foreignModule = this._foreignModuleFactory(i, t)), Promise.resolve(U(this._foreignModule)))
