  ...
  function (e, t, n) {
    ...
    (function (e, r) {
      ...
      var o = !1,
        ...
        u = !1,
        c = void 0,
        l = "object" === typeof self ? self : "object" === typeof e ? e : {},
        f = void 0;
      "undefined" !== typeof r ? (f = r) : "undefined" !== typeof l.vscode && (f = l.vscode.process);
      var h =
          "string" ===
            typeof (null === (i = null === f || void 0 === f ? void 0 : f.versions) || void 0 === i
              ? void 0
              : i.electron) && "renderer" === f.type,
        d = h && (null === f || void 0 === f ? void 0 : f.sandboxed);
      !(function () {
        if (d) return "bypassHeatCheck";
        var e = null === f || void 0 === f ? void 0 : f.env.ENABLE_VSCODE_BROWSER_CODE_LOADING;
      })();
      if ("object" !== typeof navigator || h)
        if ("object" === typeof f) {
          (o = "win32" === f.platform),
            (a = "darwin" === f.platform),
            (s = "linux" === f.platform) && !!f.env.SNAP && !!f.env.SNAP_REVISION,
            "en",
            "en";
          var m = f.env.VSCODE_NLS_CONFIG;
          if (m)
            try {
              var g = JSON.parse(m),
                p = g.availableLanguages["*"];
              g.locale, p || "en", g._translationsConfigFile;
            } catch (S) {}
          !0;
        } else console.error("Unable to resolve platform.");
      else
        (o = (c = navigator.userAgent).indexOf("Windows") >= 0),
          (a = c.indexOf("Macintosh") >= 0),
          (c.indexOf("Macintosh") >= 0 || c.indexOf("iPad") >= 0 || c.indexOf("iPhone") >= 0) &&
      ...
      var v = o,
        ...
        C = (function () {
          ...
          if (f && "function" === typeof f.nextTick) return f.nextTick.bind(f);
                  ...
                  cwd: function () {
                    return (
                      ...
                      i.a.vscode.process.execPath.substr(
                        0,
                        i.a.vscode.process.execPath.lastIndexOf("win32" === i.a.vscode.process.platform ? "\\" : "/"),
                      )
                    );
                  },
                }
              ...
              470: function (t) {
                ...
                var i = {
                  ...
                  normalize: function (e) {
                    ...
                    return (
                      0 !== (e = r(e, !t)).length || t || (e = "."), e.length > 0 && i && (e += "/"), t ? "/" + e : e
                    );
                  },
                  ...
                  extname: function (e) {
                    ...
                    return -1 === t || -1 === i || 0 === a || (1 === a && t === i - 1 && t === r + 1)
                      ? ""
                      : e.slice(t, i);
                  },
                  format: function (e) {
              ...
              447: function (t, n, r) {
                  ...
                  g = (function () {
                    ...
                    return (
                      ...
                      (e.parse = function (e, t) {
                        ...
                        var n = m.exec(e);
                        return n
                          ? new v(n[2] || h, x(n[4] || h), x(n[5] || h), x(n[7] || h), x(n[9] || h), t)
                          : new v(h, h, h, h, h);
                      }),
                      (e.file = function (e) {
                        var t = h;
                ...
                !(function (e) {
                  (e.joinPath = function (e) {
                    ...
                    return e.with({ path: L.join.apply(L, E([e.path], t)) });
                  }),
                    (e.resolvePath = function (e) {
                      for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                      var r = e.path || "/";
                      return e.with({ path: L.resolve.apply(L, E([r], t)) });
                    }),
  ...
  function (e, t, n) {
    var r = (function (e) {
      ...
      return (
        ...
        (e.mark = function (e) {
          return (
            Object.setPrototypeOf ? Object.setPrototypeOf(e, d) : ((e.__proto__ = d), s(e, a, "GeneratorFunction")),
  ...
  function (e, t, n) {
    ...
    function C(e) {
      ...
      return (C = function (e) {
        ...
        function i() {
          return _(e, arguments, o(this).constructor);
        }
        return (
          ...
          function (i) {
            for (;;)
              switch ((i.prev = i.next)) {
                case 0:
                  for (e = l.length, t = new Array(e), n = 0; n < e; n++) t[n] = l[n];
                  (r = 0), (o = t);
                case 2:
                  if (!(r < o.length)) {
                    i.next = 24;
    ...
    function L(e) {
      return w ? (w.trackDisposable(e), e) : e;
    }
    var N = (function (e) {
      i(n, e);
      var t = c(n);
      function n(e) {
        ...
        return (
          ...
          ((r = t.call(
            this,
            "Encountered errors while disposing of store. Errors: [".concat(e.join(", "), "]"),
          )).errors = e),
          r
        );
      }
    ...
    function T(e) {
      if (k.is(e)) {
        ...
        if (n.length > 1) throw new N(n);
        return Array.isArray(e) ? [] : e;
      }
      if (e) return E(e), e.dispose(), e;
    }
    function O() {
        ...
        h(e, [
          {
            key: "dispose",
            value: function () {
              this._isDisposed || (E(this), (this._isDisposed = !0), this.clear());
            },
          },
          {
            key: "clear",
    ...
    var M = (function () {
      function e() {
        l(this, e), (this._store = new P()), L(this);
      }
      return (
        h(e, [
          {
    ...
    M.None = Object.freeze({ dispose: function () {} });
    var R = n(1);
    function j(e) {
      var t,
        n = [],
              ...
              value: function (e) {
                ...
                if (e.seq) {
                  ...
                  if ((delete this._pendingReplies[n.seq], n.err)) {
                    ...
                    return (
                      n.err.$isError &&
                        (((i = new Error()).name = n.err.name), (i.message = n.err.message), (i.stack = n.err.stack)),
                      void r.reject(i)
                    );
                  }
                  r.resolve(n.res);
                  ...
                  this._handler.handleMessage(o.method, o.args).then(
                    ...
                    function (e) {
                      e.detail instanceof Error && (e.detail = g(e.detail)),
                        t._send({ vsWorker: t._workerId, seq: a, res: void 0, err: g(e) });
                    },
                  );
                }
              },
          ...
          h(e, [
            ...
            },
            {
              ...
              value: function (e, t, n, r) {
                ...
                var o = D(r, function (e, t) {
                  return i._protocol.sendMessage(e, t);
                });
                return this._requestHandlerFactory
                  ? ((this._requestHandler = this._requestHandlerFactory(o)), Promise.resolve(j(this._requestHandler)))
                  : (t &&
                      ...
                      self.require(
                        ...
                        function (n) {
                          (i._requestHandler = n.create(o)),
                            i._requestHandler ? e(j(i._requestHandler)) : t(new Error("No RequestHandler!"));
                        },
                        t,
                      );
                    }));
    ...
    function q(e, t) {
      return (
        (function e(t, n, r, i, o) {
          if (i <= r) return;
          var a = (r + (i - r) / 2) | 0;
          if ((e(t, n, r, a, o), e(t, n, a + 1, i, o), n(t[a], t[a + 1]) <= 0)) return;
          !(function (e, t, n, r, i, o) {
            for (var a = n, s = r + 1, u = n; u <= i; u++) o[u] = e[u];
            for (var c = n; c <= i; c++)
              a > r ? (e[c] = o[s++]) : s > i ? (e[c] = o[a++]) : t(o[s], o[a]) < 0 ? (e[c] = o[s++]) : (e[c] = o[a++]);
          })(t, n, r, a, i, o);
        })(e, t, 0, e.length - 1, []),
        e
      );
    ...
    function J(e, t) {
      var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 32,
        r = n - t,
        i = ~((1 << r) - 1);
      return ((e << t) | ((i & e) >>> r)) >>> 0;
    }
    ...
    function X(e, t) {
      for (var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "0"; e.length < t; ) e = n + e;
      return e;
    }
    function Z(e) {
          ...
          h(e, [
            {
              ...
              value: function (e) {
                ...
                if (0 !== t) {
                  ...
                  for (0 !== a ? ((n = a), (r = -1), (a = 0)) : ((n = e.charCodeAt(0)), (r = 0)); ; ) {
                    var s = n;
                    if (K(n)) {
                      if (!(r + 1 < t)) {
                        a = n;
              ...
              value: function () {
                return (
                  this._finished ||
                    ...
                    this._wrapUp()),
                  Z(this._h0) + Z(this._h1) + Z(this._h2) + Z(this._h3) + Z(this._h4)
                );
              },
            },
            {
              ...
              value: function () {
                (this._buff[this._buffLen++] = 128),
                  Q(this._buff, this._buffLen),
                  this._buffLen > 56 && (this._step(), Q(this._buff));
            ...
            },
            {
              key: "_step",
              value: function () {
                for (var t = e._bigBlock32, n = this._buffDV, r = 0; r < 64; r += 4)
                ...
                for (
                  var o, a, s, u = this._h0, c = this._h1, l = this._h2, f = this._h3, h = this._h4, d = 0;
                  d < 80;
                  d++
                )
                  d < 20
                    ...
                    (s = (J(u, 5) + o + h + a + t.getUint32(4 * d, !1)) & 4294967295),
                    (h = f),
                    (f = l),
                    (l = J(c, 30)),
                    (c = u),
    ...
    function te(e, t, n) {
      return new oe(new ee(e), new ee(t)).ComputeDiff(n).changes;
    }
    var ne = (function () {
        function e() {
          l(this, e);
          ...
          h(e, [
            {
              ...
              value: function () {
                (this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
                  this.m_changes.push(
                    new B(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
                  ),
                  (this.m_originalCount = 0),
                  (this.m_modifiedCount = 0),
                  (this.m_originalStart = 1073741824),
        ...
        return (
          h(
            ...
            [
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  if (e > t || n > r)
                    return (
                      n <= r
                        ? (ne.Assert(e === t + 1, "originalStart should only be one more than originalEnd"),
                          (o = [new B(e, 0, n, r - n + 1)]))
                        : e <= t
                          ? (ne.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                            (o = [new B(e, t - e + 1, n, 0)]))
                          : (ne.Assert(e === t + 1, "originalStart should only be one more than originalEnd"),
                            ne.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"),
                            (o = [])),
              ...
              {
                key: "WALKTRACE",
                value: function (e, t, n, r, i, o, a, s, u, c, l, f, h, d, m, g, p, v) {
                  var y,
                    b = null,
                    _ = new ie(),
                    C = t,
                  ...
                  do {
                    ...
                    w === C || (w < S && u[w - 1] < u[w + 1])
                      ...
                      : ((d = (l = u[w - 1] + 1) - k - r),
                        ...
                        (k = w - 1 - e)),
                      A >= 0 && ((e = (u = this.m_forwardHistory[A])[0]), (C = 1), (S = u.length - 1));
                  } while (--A >= -1);
                  if (((y = _.getReverseChanges()), v[0])) {
                    ...
                    if (null !== y && y.length > 0) {
                      var N = y[y.length - 1];
                      (E = Math.max(E, N.getOriginalEnd())), (L = Math.max(L, N.getModifiedEnd()));
                    }
                    b = [new B(E, f - E + 1, L, m - L + 1)];
                  } else {
                    (_ = new ie()),
                      (C = o),
                      (S = a),
                      (k = h[0] - g[0] - s),
                      (x = 1073741824),
                      (A = p ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2);
                    do {
                      var T = k + i;
                      T === C || (T < S && c[T - 1] >= c[T + 1])
                        ? ((d = (l = c[T + 1] - 1) - k - s),
                        ...
                        : ((d = (l = c[T - 1]) - k - s),
                          ...
                          (k = T - 1 - i)),
                        A >= 0 && ((i = (c = this.m_reverseHistory[A])[0]), (C = 1), (S = c.length - 1));
                    } while (--A >= -1);
                    b = _.getChanges();
                  }
              ...
              },
              {
                ...
                value: function (e, t, n, r, i, o, a) {
                  ...
                  for (var S = 1; S <= d / 2 + 1; S++) {
                    var k = 0,
                      x = 0;
                    (c = this.ClipDiagonalBound(v - S, S, v, m)), (l = this.ClipDiagonalBound(v + S, S, v, m));
                    for (var A = c; A <= l; A += 2) {
                      u = (s = A === c || (A < l && g[A - 1] < g[A + 1]) ? g[A + 1] : g[A - 1] + 1) - (A - v) - b;
                      for (var w = s; s < t && u < r && this.ElementsAreEqual(s + 1, u + 1); ) s++, u++;
                      if (
                        ((g[A] = s), s + u > k + x && ((k = s), (x = u)), !C && Math.abs(A - y) <= S - 1 && s >= p[A])
                      )
                        return (
                          (i[0] = s),
                          (o[0] = u),
                          w <= p[A] && S <= 1448
                            ? this.WALKTRACE(v, c, l, b, y, f, h, _, g, p, s, t, i, u, r, o, C, a)
                            : null
                        );
                    }
                    var E = (k - e + (x - n) - S) / 2;
                    if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(k, E))
                      return (
                        (a[0] = !0),
                        (i[0] = k),
                        (o[0] = x),
                    ...
                    (f = this.ClipDiagonalBound(y - S, S, y, m)), (h = this.ClipDiagonalBound(y + S, S, y, m));
                    for (var L = f; L <= h; L += 2) {
                      u = (s = L === f || (L < h && p[L - 1] >= p[L + 1]) ? p[L + 1] - 1 : p[L - 1]) - (L - y) - _;
                      for (var N = s; s > e && u > n && this.ElementsAreEqual(s, u); ) s--, u--;
                      if (((p[L] = s), C && Math.abs(L - v) <= S && s <= g[L]))
                        return (
                          (i[0] = s),
                          (o[0] = u),
                          N >= g[L] && S <= 1448
                    ...
                    if (S <= 1447) {
                      ...
                      (T[0] = v - c + 1),
                        re.Copy2(g, c, T, 1, l - c + 1),
                        this.m_forwardHistory.push(T),
                        ((T = new Int32Array(h - f + 2))[0] = y - f + 1),
                        re.Copy2(p, f, T, 1, h - f + 1),
                        this.m_reverseHistory.push(T);
                    }
                  }
                  return this.WALKTRACE(v, c, l, b, y, f, h, _, g, p, s, t, i, u, r, o, C, a);
                },
              },
              {
                key: "PrettifyChanges",
                value: function (e) {
                  for (var t = 0; t < e.length; t++) {
                    for (
                      ...
                      (!a || this.ModifiedElementsAreEqual(n.modifiedStart, n.modifiedStart + n.modifiedLength));
                  ...
                  for (var u = e.length - 1; u >= 0; u--) {
                    ...
                    if (u > 0) {
                      var h = e[u - 1];
                      h.originalLength > 0 && (l = h.originalStart + h.originalLength),
                        h.modifiedLength > 0 && (f = h.modifiedStart + h.modifiedLength);
                    }
                    for (
                      var d = c.originalLength > 0,
                        m = c.modifiedLength > 0,
                        g = 0,
                        p = this._boundaryScore(c.originalStart, c.originalLength, c.modifiedStart, c.modifiedLength),
                        v = 1;
                      ;
                      v++
                    ) {
                      var y = c.originalStart - v,
                        b = c.modifiedStart - v;
                      if (y < l || b < f) break;
                      if (d && !this.OriginalElementsAreEqual(y, y + c.originalLength)) break;
                      if (m && !this.ModifiedElementsAreEqual(b, b + c.modifiedLength)) break;
                      var _ = this._boundaryScore(y, c.originalLength, b, c.modifiedLength);
                      _ > p && ((p = _), (g = v));
                    }
                    (c.originalStart -= g), (c.modifiedStart -= g);
                  }
                  if (this._hasStrings)
                    for (var C = 1, S = e.length; C < S; C++) {
                      var k = e[C - 1],
                        x = e[C],
                        A = x.originalStart - k.originalStart - k.originalLength,
                        w = k.originalStart,
                        E = x.originalStart + x.originalLength,
                        L = E - w,
                        N = k.modifiedStart,
                        T = x.modifiedStart + x.modifiedLength,
                        O = T - N;
                      if (A < 5 && L < 20 && O < 20) {
                        var I = this._findBetterContiguousSequence(w, L, N, O, A);
                        if (I) {
                          var P = W(I, 2),
                            M = P[0],
                            R = P[1];
                          (M === k.originalStart + k.originalLength && R === k.modifiedStart + k.modifiedLength) ||
                            ((k.originalLength = M - k.originalStart),
                            (k.modifiedLength = R - k.modifiedStart),
                            (x.originalStart = M + A),
                            (x.modifiedStart = R + A),
                            (x.originalLength = E - x.originalStart),
                            (x.modifiedLength = T - x.modifiedStart));
                        }
                      }
                    }
                  return e;
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  for (var o = e + t - i + 1, a = n + r - i + 1, s = 0, u = 0, c = 0, l = e; l < o; l++)
                    for (var f = n; f < a; f++) {
              ...
              },
              {
                ...
                value: function (e, t, n, r) {
                  return (
                    (this._OriginalRegionIsBoundary(e, t) ? 1 : 0) + (this._ModifiedRegionIsBoundary(n, r) ? 1 : 0)
                  );
                },
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                    ...
                    return (
                      re.Copy(e, 0, r, 0, e.length - 1),
                      (r[e.length - 1] = n[0]),
                      re.Copy(t, 1, r, e.length, t.length - 1),
                      r
                    );
                  }
                  var i = new Array(e.length + t.length);
                  return re.Copy(e, 0, i, 0, e.length), re.Copy(t, 0, i, e.length, t.length), i;
                },
              },
              {
                key: "ChangesOverlap",
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (e._isStringArray(n)) {
                    for (var r = new Int32Array(n.length), i = 0, o = n.length; i < o; i++) r[i] = z(n[i], 0);
                    return [n, r, !0];
                  }
      ...
      se = (function (e) {
        ...
        function n(e, r, i) {
          ...
          var s = -1 !== e.indexOf(".") ? "property" : "argument",
            u = 'The "'.concat(e, '" ').concat(s, " ").concat(a, " of type ").concat(r);
          return (u += ". Received type ".concat(typeof i)), ((o = t.call(this, u)).code = "ERR_INVALID_ARG_TYPE"), o;
        }
        return h(n);
      })(C(Error));
    function ue(e, t) {
          ...
          if (a === c - 1 || 1 === s);
            ...
            if (i.length < 2 || 2 !== o || 46 !== i.charCodeAt(i.length - 1) || 46 !== i.charCodeAt(i.length - 2)) {
              if (i.length > 2) {
                ...
                -1 === l ? ((i = ""), (o = 0)) : (o = (i = i.slice(0, l)).length - 1 - i.lastIndexOf(n)),
                  (a = c),
                  (s = 0);
                continue;
              }
            ...
            i.length > 0 ? (i += "".concat(n).concat(e.slice(a + 1, c))) : (i = e.slice(a + 1, c)), (o = c - a - 1);
          (a = c), (s = 0);
        } else 46 === u && -1 !== s ? ++s : (s = -1);
      }
      return i;
    ...
    var me = {
        resolve: function () {
          for (var e = "", t = "", n = !1, r = arguments.length - 1; r >= -1; r--) {
            var i = void 0;
            if (r >= 0) {
              if ((ue((i = r < 0 || arguments.length <= r ? void 0 : arguments[r]), "path"), 0 === i.length)) continue;
            } else
              0 === e.length
                ? (i = ae.a())
                : (void 0 === (i = ae.b["=".concat(e)] || ae.a()) ||
                    (i.slice(0, 2).toLowerCase() !== e.toLowerCase() && 92 === i.charCodeAt(2))) &&
                  (i = "".concat(e, "\\"));
            var o = i.length,
              a = 0,
              s = "",
            ...
            if (1 === o) ce(c) && ((a = 1), (u = !0));
              ...
              if (((u = !0), ce(i.charCodeAt(1)))) {
                for (var l = 2, f = l; l < o && !ce(i.charCodeAt(l)); ) l++;
                if (l < o && l !== f) {
                  var h = i.slice(f, l);
                  for (f = l; l < o && ce(i.charCodeAt(l)); ) l++;
                  if (l < o && l !== f) {
                    for (f = l; l < o && !ce(i.charCodeAt(l)); ) l++;
                    (l !== o && l === f) || ((s = "\\\\".concat(h, "\\").concat(i.slice(f, l))), (a = l));
                  }
                }
              } else a = 1;
            else
              fe(c) &&
                58 === i.charCodeAt(1) &&
                ((s = i.slice(0, 2)), (a = 2), o > 2 && ce(i.charCodeAt(2)) && ((u = !0), (a = 3)));
            if (s.length > 0)
              if (e.length > 0) {
            ...
            if (n) {
              if (e.length > 0) break;
            } else if (((t = "".concat(i.slice(a), "\\").concat(t)), (n = u), u && e.length > 0)) break;
          }
          return (t = he(t, !n, "\\", ce)), n ? "".concat(e, "\\").concat(t) : "".concat(e).concat(t) || ".";
        },
        normalize: function (e) {
          ue(e, "path");
          var t = e.length;
          ...
          if (ce(o))
            if (((i = !0), ce(e.charCodeAt(1)))) {
              for (var a = 2, s = a; a < t && !ce(e.charCodeAt(a)); ) a++;
              if (a < t && a !== s) {
                var u = e.slice(s, a);
                for (s = a; a < t && ce(e.charCodeAt(a)); ) a++;
                if (a < t && a !== s) {
                  for (s = a; a < t && !ce(e.charCodeAt(a)); ) a++;
                  if (a === t) return "\\\\".concat(u, "\\").concat(e.slice(s), "\\");
                  a !== s && ((n = "\\\\".concat(u, "\\").concat(e.slice(s, a))), (r = a));
                }
              }
            } else r = 1;
          else
            fe(o) &&
              58 === e.charCodeAt(1) &&
              ((n = e.slice(0, 2)), (r = 2), t > 2 && ce(e.charCodeAt(2)) && ((i = !0), (r = 3)));
          var c = r < t ? he(e.slice(r), !i, "\\", ce) : "";
          return (
            0 !== c.length || i || (c = "."),
            c.length > 0 && ce(e.charCodeAt(t - 1)) && (c += "\\"),
            void 0 === n ? (i ? "\\".concat(c) : c) : i ? "".concat(n, "\\").concat(c) : "".concat(n).concat(c)
          );
        },
        isAbsolute: function (e) {
          ue(e, "path");
          ...
          return ce(n) || (t > 2 && fe(n) && 58 === e.charCodeAt(1) && ce(e.charCodeAt(2)));
        },
        join: function () {
          if (0 === arguments.length) return ".";
          for (var e, t, n = 0; n < arguments.length; ++n) {
            var r = n < 0 || arguments.length <= n ? void 0 : arguments[n];
            ue(r, "path"), r.length > 0 && (void 0 === e ? (e = t = r) : (e += "\\".concat(r)));
          }
          if (void 0 === e) return ".";
          var i = !0,
            o = 0;
          if ("string" === typeof t && ce(t.charCodeAt(0))) {
            ++o;
            var a = t.length;
            a > 1 && ce(t.charCodeAt(1)) && (++o, a > 2 && (ce(t.charCodeAt(2)) ? ++o : (i = !1)));
          }
          if (i) {
            for (; o < e.length && ce(e.charCodeAt(o)); ) o++;
            o >= 2 && (e = "\\".concat(e.slice(o)));
          }
          return me.normalize(e);
        },
        relative: function (e, t) {
          if ((ue(e, "from"), ue(t, "to"), e === t)) return "";
          var n = me.resolve(e),
            r = me.resolve(t);
          if (n === r) return "";
          ...
          for (var a = o - i, s = 0; s < t.length && 92 === t.charCodeAt(s); ) s++;
          ...
          if (h !== l) {
            ...
            a > l && (92 === e.charCodeAt(i + h) ? (f = h) : 2 === h && (f = 3)), -1 === f && (f = 0);
          }
          var m = "";
          for (h = i + f + 1; h <= o; ++h) (h !== o && 92 !== e.charCodeAt(h)) || (m += 0 === m.length ? ".." : "\\..");
          return (
            (s += f), m.length > 0 ? "".concat(m).concat(r.slice(s, u)) : (92 === r.charCodeAt(s) && ++s, r.slice(s, u))
          );
        },
        toNamespacedPath: function (e) {
          ...
          if (92 === t.charCodeAt(0)) {
            if (92 === t.charCodeAt(1)) {
              ...
              if (63 !== n && 46 !== n) return "\\\\?\\UNC\\".concat(t.slice(2));
            }
          } else if (fe(t.charCodeAt(0)) && 58 === t.charCodeAt(1) && 92 === t.charCodeAt(2))
            return "\\\\?\\".concat(t);
          return e;
        },
        dirname: function (e) {
          ...
          var n = -1,
            r = 0,
            i = e.charCodeAt(0);
          if (1 === t) return ce(i) ? e : ".";
          if (ce(i)) {
            if (((n = r = 1), ce(e.charCodeAt(1)))) {
              for (var o = 2, a = o; o < t && !ce(e.charCodeAt(o)); ) o++;
              if (o < t && o !== a) {
                for (a = o; o < t && ce(e.charCodeAt(o)); ) o++;
                if (o < t && o !== a) {
                  for (a = o; o < t && !ce(e.charCodeAt(o)); ) o++;
                  if (o === t) return e;
                  o !== a && (n = r = o + 1);
          ...
          } else fe(i) && 58 === e.charCodeAt(1) && (r = n = t > 2 && ce(e.charCodeAt(2)) ? 3 : 2);
          for (var s = -1, u = !0, c = t - 1; c >= r; --c)
            if (ce(e.charCodeAt(c))) {
              if (!u) {
                s = c;
                break;
              }
        ...
        basename: function (e, t) {
          void 0 !== t && ue(t, "ext"), ue(e, "path");
          var n,
            r = 0,
            i = -1,
            o = !0;
          if (
            (e.length >= 2 && fe(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (r = 2),
            ...
            for (n = e.length - 1; n >= r; --n) {
              ...
              if (ce(u)) {
                ...
                -1 === s && ((o = !1), (s = n + 1)),
                  a >= 0 && (u === t.charCodeAt(a) ? -1 === --a && (i = n) : ((a = -1), (i = s)));
            }
            return r === i ? (i = s) : -1 === i && (i = e.length), e.slice(r, i);
          }
          for (n = e.length - 1; n >= r; --n)
            if (ce(e.charCodeAt(n))) {
              if (!o) {
                r = n + 1;
                break;
              }
        ...
        extname: function (e) {
          ...
          var t = 0,
            ...
            o = !0,
            a = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && fe(e.charCodeAt(0)) && (t = r = 2);
        ...
        parse: function (e) {
          ...
          var n = e.length,
            r = 0,
            i = e.charCodeAt(0);
          if (1 === n) return ce(i) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
          if (ce(i)) {
            if (((r = 1), ce(e.charCodeAt(1)))) {
              for (var o = 2, a = o; o < n && !ce(e.charCodeAt(o)); ) o++;
              if (o < n && o !== a) {
                for (a = o; o < n && ce(e.charCodeAt(o)); ) o++;
                if (o < n && o !== a) {
                  for (a = o; o < n && !ce(e.charCodeAt(o)); ) o++;
                  o === n ? (r = o) : o !== a && (r = o + 1);
                }
          ...
          } else if (fe(i) && 58 === e.charCodeAt(1)) {
            if (n <= 2) return (t.root = t.dir = e), t;
            if (((r = 2), ce(e.charCodeAt(2)))) {
              if (3 === n) return (t.root = t.dir = e), t;
              r = 3;
            }
          }
          r > 0 && (t.root = e.slice(0, r));
          for (var s = -1, u = r, c = -1, l = !0, f = e.length - 1, h = 0; f >= r; --f)
            if (ce((i = e.charCodeAt(f)))) {
              if (!l) {
                u = f + 1;
                break;
              }
              ...
              -1 === c && ((l = !1), (c = f + 1)),
                46 === i ? (-1 === s ? (s = f) : 1 !== h && (h = 1)) : -1 !== s && (h = -1);
          return (
            -1 !== c &&
              (-1 === s || 0 === h || (1 === h && s === c - 1 && s === u + 1)
                ? (t.base = t.name = e.slice(u, c))
                : ((t.name = e.slice(u, s)), (t.base = e.slice(u, c)), (t.ext = e.slice(s, c)))),
      ...
      ge = {
        resolve: function () {
          for (var e = "", t = !1, n = arguments.length - 1; n >= -1 && !t; n--) {
            var r = n >= 0 ? (n < 0 || arguments.length <= n ? void 0 : arguments[n]) : ae.a();
            ue(r, "path"), 0 !== r.length && ((e = "".concat(r, "/").concat(e)), (t = 47 === r.charCodeAt(0)));
          }
          return (e = he(e, !t, "/", le)), t ? "/".concat(e) : e.length > 0 ? e : ".";
        },
        normalize: function (e) {
          if ((ue(e, "path"), 0 === e.length)) return ".";
          var t = 47 === e.charCodeAt(0),
        ...
        isAbsolute: function (e) {
          return ue(e, "path"), e.length > 0 && 47 === e.charCodeAt(0);
        },
        join: function () {
          if (0 === arguments.length) return ".";
          for (var e, t = 0; t < arguments.length; ++t) {
            var n = t < 0 || arguments.length <= t ? void 0 : arguments[t];
            ue(n, "path"), n.length > 0 && (void 0 === e ? (e = n) : (e += "/".concat(n)));
          }
          return void 0 === e ? "." : ge.normalize(e);
        },
        relative: function (e, t) {
          if ((ue(e, "from"), ue(t, "to"), e === t)) return "";
          if ((e = ge.resolve(e)) === (t = ge.resolve(t))) return "";
          for (var n = e.length, r = n - 1, i = t.length - 1, o = r < i ? r : i, a = -1, s = 0; s < o; s++) {
          ...
          if (s === o)
            ...
            } else r > o && (47 === e.charCodeAt(1 + s) ? (a = s) : 0 === s && (a = 0));
          var c = "";
          for (s = 1 + a + 1; s <= n; ++s) (s !== n && 47 !== e.charCodeAt(s)) || (c += 0 === c.length ? ".." : "/..");
        ...
        dirname: function (e) {
          if ((ue(e, "path"), 0 === e.length)) return ".";
          for (var t = 47 === e.charCodeAt(0), n = -1, r = !0, i = e.length - 1; i >= 1; --i)
        ...
        parse: function (e) {
          ...
          var n,
            r = 47 === e.charCodeAt(0);
          r ? ((t.root = "/"), (n = 1)) : (n = 0);
          for (var i = -1, o = 0, a = -1, s = !0, u = e.length - 1, c = 0; u >= n; --u) {
            var l = e.charCodeAt(u);
            if (47 !== l)
              -1 === a && ((s = !1), (a = u + 1)),
                46 === l ? (-1 === i ? (i = u) : 1 !== c && (c = 1)) : -1 !== i && (c = -1);
            else if (!s) {
              o = u + 1;
              break;
            }
          ...
          if (-1 !== a) {
            ...
            -1 === i || 0 === c || (1 === c && i === a - 1 && i === o + 1)
              ...
              : ((t.name = e.slice(f, i)), (t.base = e.slice(f, a)), (t.ext = e.slice(i, a)));
          }
    ...
    (ge.win32 = me.win32 = me), (ge.posix = me.posix = ge);
    "win32" === ae.c ? me.normalize : ge.normalize,
      "win32" === ae.c ? me.resolve : ge.resolve,
      "win32" === ae.c ? me.relative : ge.relative,
      "win32" === ae.c ? me.dirname : ge.dirname,
      "win32" === ae.c ? me.basename : ge.basename,
      "win32" === ae.c ? me.extname : ge.extname,
      "win32" === ae.c ? me.sep : ge.sep;
    var pe,
      ve = /^\w[\w\d+.-]*$/,
      ye = /^\//,
      be = /^\/\//;
    function _e(e, t) {
      ...
      if (e.scheme && !ve.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
      if (e.path)
        if (e.authority) {
          if (!ye.test(e.path))
            throw new Error(
    ...
    var ke = "/",
              ...
              },
              {
                ...
                value: function (e) {
                  var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    n = xe.exec(e);
                  return n
                    ? new Ee(n[2] || "", Me(n[4] || ""), Me(n[5] || ""), Me(n[7] || ""), Me(n[9] || ""), t)
                    : new Ee("", "", "", "", "");
                },
              },
              {
                ...
                value: function (e) {
                  var t = "";
                  if ((R.d && (e = e.replace(/\\/g, ke)), e[0] === ke && e[1] === ke)) {
                    var n = e.indexOf(ke, 2);
                    -1 === n ? ((t = e.substring(2)), (e = ke)) : ((t = e.substring(2, n)), (e = e.substring(n) || ke));
                  }
                  return new Ee("file", t, e, "", "");
                },
              },
              {
                key: "from",
                value: function (e) {
                  return new Ee(e.scheme, e.authority, e.path, e.query, e.fragment);
                },
              },
              {
                key: "joinPath",
                value: function (t) {
                  ...
                  for (var n, r, i, o = arguments.length, a = new Array(o > 1 ? o - 1 : 0), s = 1; s < o; s++)
                    a[s - 1] = arguments[s];
                  R.d && "file" === t.scheme
                    ? (n = e.file((r = me).join.apply(r, [Oe(t, !0)].concat(a))).path)
                    : (n = (i = ge).join.apply(i, [t.path].concat(a)));
              ...
              },
              {
                ...
                value: function (t) {
                  if (t) {
                    if (t instanceof e) return t;
                    var n = new Ee(t);
                    return (n._formatted = t.external), (n._fsPath = t._sep === we ? t.fsPath : null), n;
                  }
                  return t;
                },
              },
      ...
      Ee = (function (e) {
        ...
        function n() {
          var e;
          return l(this, n), ((e = t.apply(this, arguments))._formatted = null), (e._fsPath = null), e;
        }
        return (
          h(n, [
            {
            ...
            },
            {
              ...
              value: function () {
                var e = { $mid: 1 };
                return (
                  this._fsPath && ((e.fsPath = this._fsPath), (e._sep = we)),
                  this._formatted && (e.external = this._formatted),
                  this.path && (e.path = this.path),
                  this.scheme && (e.scheme = this.scheme),
                  this.authority && (e.authority = this.authority),
    ...
    function Te(e) {
      for (var t = void 0, n = 0; n < e.length; n++) {
        var r = e.charCodeAt(n);
        35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), (t += Le[r])) : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    function Oe(e, t) {
    ...
    function Ie(e, t) {
      var n = t ? Te : Ne,
        ...
        s = e.query,
        u = e.fragment;
      if ((i && ((r += i), (r += ":")), (o || "file" === i) && ((r += ke), (r += ke)), o)) {
        var c = o.indexOf("@");
        if (-1 !== c) {
          var l = o.substr(0, c);
          (o = o.substr(c + 1)),
      ...
      if (a) {
        if (a.length >= 3 && 47 === a.charCodeAt(0) && 58 === a.charCodeAt(2)) {
          ...
          f >= 65 && f <= 90 && (a = "/".concat(String.fromCharCode(f + 32), ":").concat(a.substr(3)));
        } else if (a.length >= 2 && 58 === a.charCodeAt(1)) {
          var h = a.charCodeAt(0);
          h >= 65 && h <= 90 && (a = "".concat(String.fromCharCode(h + 32), ":").concat(a.substr(2)));
        }
        r += n(a, !0);
      }
      return s && ((r += "?"), (r += n(s, !1))), u && ((r += "#"), (r += t ? u : Ne(u, !1))), r;
    }
    var Pe = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function Me(e) {
      return e.match(Pe)
    ...
    var Re = (function () {
            ...
            [
              {
                key: "with",
                value: function () {
                  var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.lineNumber,
                    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.column;
      ...
      je = (function () {
        function e(t, n, r, i) {
          l(this, e),
            t > r || (t === r && n > i)
              ? ((this.startLineNumber = r), (this.startColumn = i), (this.endLineNumber = t), (this.endColumn = n))
              : ((this.startLineNumber = t), (this.startColumn = n), (this.endLineNumber = r), (this.endColumn = i));
        }
        return (
          h(
            e,
                ...
                value: function (t, n) {
                  ...
                  return (
                    ...
                    n.endLineNumber > t.endLineNumber
                      ...
                      : n.endLineNumber === t.endLineNumber
                        ? ((o = n.endLineNumber), (a = Math.max(n.endColumn, t.endColumn)))
              ...
              },
              {
                ...
                value: function (t, n) {
                  var r = t.startLineNumber,
                    ...
                    l = n.endColumn;
                  return (
                    r < s ? ((r = s), (i = u)) : r === s && (i = Math.max(i, u)),
                    o > c ? ((o = c), (a = l)) : o === c && (a = Math.min(a, l)),
                    ...
                    if (n === r) {
                      ...
                      if (i === o) {
                        var a = 0 | e.endLineNumber,
                          s = 0 | t.endLineNumber;
                        return a === s ? (0 | e.endColumn) - (0 | t.endColumn) : a - s;
                      }
                      return i - o;
                    }
                    return n - r;
    ...
    var Fe = (function () {
        function e(t) {
          l(this, e);
          for (var n = [], r = [], i = 0, o = t.length; i < o; i++) (n[i] = Be(t[i], 1)), (r[i] = Ke(t[i], 1));
      ...
      Ue = (function () {
        function e(t, n, r) {
          l(this, e), (this._charCodes = t), (this._lineNumbers = n), (this._columns = r);
        }
        return (
          h(e, [
            {
                ...
                return (
                  0 === t.originalLength
                    ...
                    : ((i = n.getStartLineNumber(t.originalStart)),
                      ...
                      (s = n.getEndColumn(t.originalStart + t.originalLength - 1))),
                  0 === t.modifiedLength
                    ? ((u = 0), (c = 0), (l = 0), (f = 0))
          ...
          h(e, null, [
            {
              ...
              value: function (t, n, r, i, o, a, s) {
                ...
                if (
                  ...
                  var d = r.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1),
                    m = i.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1),
                    g = De(d, m, o, !0).changes;
                  s &&
                    (g = (function (e) {
                    ...
                    (h = []);
                  for (var p = 0, v = g.length; p < v; p++) h.push(Ve.createFromDiffChange(g[p], d, m));
                }
      ...
      We = (function () {
        function e(t, n, r) {
          l(this, e),
            ...
            (this.original = new Fe(t)),
            (this.modified = new Fe(n)),
            (this.continueLineDiff = $e(r.maxComputationTime)),
            (this.continueCharDiff = $e(0 === r.maxComputationTime ? 0 : Math.min(r.maxComputationTime, 5e3)));
        }
        return (
          h(e, [
            {
              ...
              value: function () {
                ...
                var e = De(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
                  t = e.changes,
                  n = e.quitEarly;
                ...
                for (var a = [], s = 0, u = 0, c = -1, l = t.length; c < l; c++) {
                  for (
                    ...
                    if (m !== g) {
                      for (var p = Be(m, 1), v = Be(g, 1); p > 1 && v > 1; ) {
                        if (m.charCodeAt(p - 2) !== g.charCodeAt(v - 2)) break;
                        p--, v--;
                      }
                      (p > 1 || v > 1) && this._pushTrimWhitespaceCharChange(a, s + 1, 1, p, u + 1, 1, v);
                      for (var y = Ke(m, 1), b = Ke(g, 1), _ = m.length + 1, C = g.length + 1; y < _ && b < C; ) {
                        if (m.charCodeAt(y - 1) !== m.charCodeAt(b - 1)) break;
                        y++, b++;
                      }
                      (y < _ || b < C) && this._pushTrimWhitespaceCharChange(a, s + 1, y, _, u + 1, b, C);
                    }
                    s++, u++;
                  }
                  f &&
            ...
            },
            {
              ...
              value: function (e, t, n, r, i, o, a) {
                if (!this._mergeTrimWhitespaceCharChange(e, t, n, r, i, o, a)) {
                  var s = void 0;
                  this.shouldComputeCharChanges && (s = [new Ve(t, n, t, r, i, o, i, a)]),
                    e.push(new qe(t, t, i, i, s));
                }
              },
            },
            {
              ...
              value: function (e, t, n, r, i, o, a) {
                ...
                return (
                  ...
                  this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new Ve(t, n, t, r, i, o, i, a)),
                  !0)
                );
              },
            },
    ...
    function Ke(e, t) {
      var n = (function (e) {
        for (
          var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.length - 1, n = t;
          n >= 0;
          n--
        ) {
          var r = e.charCodeAt(n);
        ...
        return (
          h(e, [
            ...
            },
            {
              ...
              value: function (e) {
                return e < 0 ? 0 : ((e = Ye(e)), this._getAccumulatedValue(e));
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                for (var t = 0, n = this.values.length - 1, r = 0, i = 0, o = 0; t <= n; )
                  if (((r = (t + (n - t) / 2) | 0), e < (o = (i = this.prefixSum[r]) - this.values[r]))) n = r - 1;
                  else {
                    if (!(e >= i)) break;
                    t = r + 1;
                  }
                ...
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    this._acceptDeleteRange(r.range),
                      this._acceptInsertText(new Re(r.range.startLineNumber, r.range.startColumn), r.text);
                  }
                } catch (i) {
                  n.e(i);
                } finally {
    ...
    var Xe = { maxLen: 1e3, windowSize: 15, timeBudget: 150 };
    function Ze(e, t, n, r) {
    ...
    var et = (function () {
      ...
      tt = (function () {
        function e(t, n, r) {
          l(this, e);
          for (var i = new Uint8Array(t * n), o = 0, a = t * n; o < a; o++) i[o] = r;
      ...
      nt = (function () {
        function e(t) {
          ...
          n++, r++;
          for (var f = new tt(r, n, 0), h = 0, d = t.length; h < d; h++) {
            var m = W(t[h], 3),
              g = m[0],
              p = m[1],
              v = m[2];
    ...
    function at() {
      if (null === ot) {
        ...
        for (var t = 0; t < ".,;".length; t++) ot.set(".,;".charCodeAt(t), 2);
      }
      return ot;
    }
    var st = (function () {
      ...
      return (
        h(e, null, [
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : it(),
                  r = at(),
                  i = [],
                  o = 1,
                  a = t.getLineCount();
                ...
                for (
                  var s = t.getLineContent(o), u = s.length, c = 0, l = 0, f = 0, h = 1, d = !1, m = !1, g = !1, p = !1;
                  c < u;
                  ...
                  if (13 === h) {
                    ...
                    var _ = void 0;
                    91 === y ? ((m = !0), (_ = 0)) : (_ = r.get(y)), 1 === _ ? (v = !0) : (h = 13);
                  } else 0 === (h = n.nextState(h, y)) && (v = !0);
                  v && ((h = 1), (d = !1), (m = !1), (p = !1), (l = c + 1), (f = y)), c++;
                }
    ...
    var lt = h(function e(t) {
      l(this, e), (this.element = t), (this.next = e.Undefined), (this.prev = e.Undefined);
    });
    lt.Undefined = new lt(void 0);
    var ft,
      ht = (function (e) {
        function t() {
          l(this, t), (this._first = lt.Undefined), (this._last = lt.Undefined), (this._size = 0);
        }
        return (
          h(t, [
            {
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this,
                  r = new lt(e);
                if (this._first === lt.Undefined) (this._first = r), (this._last = r);
                else if (t) {
                  var i = this._last;
            ...
            },
            {
              key: "_remove",
              value: function (e) {
                if (e.prev !== lt.Undefined && e.next !== lt.Undefined) {
                  var t = e.prev;
                  (t.next = e.next), (e.next.prev = t);
                } else
                  e.prev === lt.Undefined && e.next === lt.Undefined
                    ? ((this._first = lt.Undefined), (this._last = lt.Undefined))
                    : e.next === lt.Undefined
                      ? ((this._last = this._last.prev), (this._last.next = lt.Undefined))
                      : e.prev === lt.Undefined &&
                        ((this._first = this._first.next), (this._first.prev = lt.Undefined));
                this._size -= 1;
              },
            },
            {
      ...
      dt = R.a.performance && "function" === typeof R.a.performance.now,
      mt = (function () {
        function e(t) {
          l(this, e), (this._highResolution = dt && t), (this._startTime = this._now()), (this._stopTime = -1);
        }
        return (
          h(
            e,
            [
              ...
              },
              {
                key: "_now",
                value: function () {
                  return this._highResolution ? R.a.performance.now() : Date.now();
                },
              },
            ],
            [
              ...
              n = e(function (e) {
                u++,
                  ...
                  (s = setTimeout(function () {
                    var e = a;
                    (a = void 0), (s = void 0), (!i || u > 1) && c.fire(e), (u = 0);
                  }, r));
              });
            },
            onLastListenerRemove: function () {
      ...
      (e.chain = function (e) {
        ...
        (e.fromNodeEventEmitter = function (e, t) {
          var n =
            ...
            a = new pt({ onFirstListenerAdd: i, onLastListenerRemove: o });
          return a.event;
        }),
        ...
        h(e, [
          {
            key: "start",
            value: function (e) {
              (this._stopWatch = new mt(!0)), (this._listenerCount = e);
            },
          },
          {
            key: "stop",
    ...
    var pt = (function () {
      function e(t) {
        ...
        l(this, e),
          ...
          (this._perfMon = (null === (n = this._options) || void 0 === n ? void 0 : n._profName)
            ? new gt(this._options._profName)
            : void 0);
      }
      return (
        h(e, [
              ...
              return (
                this._event ||
                  (this._event = function (n, r, i) {
                    var o;
                    t._listeners || (t._listeners = new ht());
                    ...
                    a && t._options && t._options.onFirstListenerDidAdd && t._options.onFirstListenerDidAdd(t),
                      t._options && t._options.onListenerDidAdd && t._options.onListenerDidAdd(t, n, r);
                    var u,
                      c = null === (o = t._leakageMon) || void 0 === o ? void 0 : o.check(t._listeners.size);
                    return (
                      (u = {
                        dispose: function () {
                          (c && c(), (u.dispose = e._noop), t._disposed) ||
                            (s(),
                            t._options &&
                      ...
                      i instanceof P ? i.add(u) : Array.isArray(i) && i.push(u),
                      u
                    );
                  }),
                this._event
          ...
          },
          {
            ...
            value: function (e) {
              var t, n;
              if (this._listeners) {
                this._deliveryQueue || (this._deliveryQueue = new ht());
                var r,
                  i = b(this._listeners);
                try {
                  for (i.s(); !(r = i.n()).done; ) {
                ...
                for (
                  ...
                  var a = W(this._deliveryQueue.shift(), 2),
                    s = a[0],
                    u = a[1];
                  try {
    ...
    ((yt = vt || (vt = {})).isCancellationToken = function (e) {
      return (
        e === yt.None ||
        e === yt.Cancelled ||
        e instanceof Ct ||
      ...
      (yt.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: ft.None })),
      (yt.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: bt }));
    var _t,
      Ct = (function () {
        function e() {
        ...
        return (
          h(e, [
            ...
            },
            {
              ...
              get: function () {
                return this._isCancelled ? bt : (this._emitter || (this._emitter = new pt()), this._emitter.event);
              },
            },
            {
              key: "dispose",
        ...
        return (
          h(e, [
            ...
            },
            {
              key: "cancel",
              value: function () {
                this._token ? this._token instanceof Ct && this._token.cancel() : (this._token = vt.Cancelled);
              },
            },
            {
              key: "dispose",
              value: function () {
                ...
                e && this.cancel(),
                  ...
                  this._token ? this._token instanceof Ct && this._token.dispose() : (this._token = vt.None);
              },
            },
          ]),
          e
      ...
      kt = (function () {
        function e() {
          l(this, e), (this._keyCodeToStr = []), (this._strToKeyCode = Object.create(null));
        }
        return (
          h(e, [
            {
    ...
    !(function () {
      function e(e, t) {
        ...
        xt.define(e, t), At.define(e, n), wt.define(e, r);
      }
      e(0, "unknown"),
        e(1, "Backspace"),
        e(2, "Tab"),
      ...
      (function (e) {
        (e.toString = function (e) {
          ...
          (e.fromUserSettings = function (e) {
            return At.strToKeyCode(e) || wt.strToKeyCode(e);
          });
      })(_t || (_t = {}));
    var Et,
      Lt,
      ...
      cn = (function () {
        function e(t, n, r) {
          l(this, e), (this.offset = 0 | t), (this.type = n), (this.language = r);
        }
        return (
          h(e, [
            {
    ...
    !(function (e) {
      ...
      (function (e) {
        (e[(e.acceptSuggestionOnCommitCharacter = 0)] = "acceptSuggestionOnCommitCharacter"),
          ...
          (e[(e.disableMonospaceOptimizations = 26)] = "disableMonospaceOptimizations"),
          ...
          (e[(e.renderLineHighlightOnlyWhenFocus = 81)] = "renderLineHighlightOnlyWhenFocus"),
          (e[(e.renderValidationDecorations = 82)] = "renderValidationDecorations"),
          (e[(e.renderWhitespace = 83)] = "renderWhitespace"),
          (e[(e.revealHorizontalRightPadding = 84)] = "revealHorizontalRightPadding"),
          ...
          (e[(e.wordWrapBreakAfterCharacters = 112)] = "wordWrapBreakAfterCharacters"),
          (e[(e.wordWrapBreakBeforeCharacters = 113)] = "wordWrapBreakBeforeCharacters"),
    ...
    (ln.CtrlCmd = 2048), (ln.Shift = 1024), (ln.Alt = 512), (ln.WinCtrl = 256);
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = (function e(t, n, r, i) {
                  var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : Xe;
                  if (r.length > o.maxLen) {
                    var a = t - o.maxLen / 2;
                    return a < 0 ? (a = 0) : (i += a), e(t, n, (r = r.substring(a, t + o.maxLen / 2)), i, o);
                  }
                  for (
                    var s = Date.now(), u = t - 1 - i, c = -1, l = null, f = 1;
                    !(Date.now() - s >= o.timeBudget);
                    f++
                  ) {
                    var h = u - o.windowSize * f;
                  ...
                  if (l) {
                    var m = { word: l[0], startColumn: i + 1 + l.index, endColumn: i + 1 + l.index + l[0].length };
                ...
                return n ? new je(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null;
              },
            },
            {
              key: "words",
                      ...
                      for (;;)
                        switch ((s.prev = s.next)) {
                          case 0:
                            ...
                            return (u = i.substring(a[o].start, a[o].end)), (o += 1), (s.next = 6), u;
                          case 6:
                            s.next = 16;
                            break;
                          case 8:
                            ...
                            (i = t[r]), (a = n(i, e)), (o = 0), (r += 1), (s.next = 16);
                            break;
                          case 15:
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                try {
                  for (o.s(); !(n = o.n()).done; ) {
                    var a = n.value;
                    i.push({ word: r.substring(a.start, a.end), startColumn: a.start + 1, endColumn: a.end + 1 });
                  }
                } catch (s) {
                  o.e(s);
                } finally {
        ...
        return (
          h(e, [
            ...
            },
            {
              key: "acceptNewModel",
              value: function (e) {
                this._models[e.url] = new hn(Ae.parse(e.url), e.lines, e.EOL, e.versionId);
              },
            },
            {
                    ...
                    return A.a.wrap(
                      function (i) {
                        for (;;)
                          switch ((i.prev = i.next)) {
                            case 0:
                              if (((o = this._getModel(e)), (a = this._getModel(t)), o && a)) {
                                i.next = 4;
                                break;
                              }
                            ...
                            case 4:
                              return (
                                ...
                                (l = c.computeDiff()),
                                (f = !(l.changes.length > 0) && this._modelsAreIdentical(o, a)),
                                i.abrupt("return", { quitEarly: l.quitEarly, identical: f, changes: l.changes })
                              );
                            case 10:
                            case "end":
                              return i.stop();
            ...
            },
            {
              ...
              value: function (t, n) {
                return fn(
                  ...
                  void 0,
                  A.a.mark(function r() {
                    var i, o, a, s, u, c, l, f, h, d, m, g, p, v, y, _, C, S;
                    return A.a.wrap(
                      function (r) {
                        for (;;)
                          switch ((r.prev = r.next)) {
                              ...
                              (o = []),
                                ...
                                (n = q(n, function (e, t) {
                                  return e.range && t.range
                                    ? je.compareRangesUsingStarts(e.range, t.range)
                            ...
                            case 14:
                              if (((d = i.getValueInRange(l)), (f = f.replace(/\r\n|\n|\r/g, i.eol)), d !== f)) {
                                r.next = 18;
                                break;
                              }
                              return r.abrupt("continue", 25);
                            case 18:
                              if (!(Math.max(f.length, d.length) > e._diffLimit)) {
                                r.next = 21;
                                break;
                              }
                              return o.push({ range: l, text: f }), r.abrupt("continue", 25);
                            case 21:
                              (m = te(d, f, !1)), (g = i.offsetAt(je.lift(l).getStartPosition())), (p = b(m));
                              try {
                                for (p.s(); !(v = p.n()).done; )
                                  (y = v.value),
                                    (_ = i.positionAt(g + y.originalStart)),
                                    (C = i.positionAt(g + y.originalStart + y.originalLength)),
                                    (S = {
                                      text: f.substr(y.modifiedStart, y.modifiedLength),
                                      range: {
                        ...
                        for (;;)
                          switch ((o.prev = o.next)) {
                            ...
                            case 6:
                              ...
                              if (((f = l.value), (h = this._getModel(f)))) {
                                o.next = 11;
                                break;
                              }
                              return o.abrupt("continue", 31);
                            case 11:
                              (d = b(h.words(s))), (o.prev = 12), d.s();
                            case 14:
                              if ((m = d.n()).done) {
                                o.next = 23;
                                break;
                              }
                              if ((g = m.value) !== n && isNaN(Number(g))) {
                                o.next = 18;
                                break;
                              }
                            ...
                            case 41:
                              return o.abrupt("return", { words: Array.from(u), duration: a.elapsed() });
                            case 42:
                            case "end":
                              return o.stop();
                          }
                      ...
                      function (i) {
                        for (;;)
                          switch ((i.prev = i.next)) {
                            ...
                            case 3:
                              (a = new RegExp(n, r)), (s = Object.create(null)), (u = t.startLineNumber);
                            case 6:
                              if (!(u < t.endLineNumber)) {
                                i.next = 31;
                                break;
                              }
                              (c = o.getLineWords(u, a)), (l = b(c)), (i.prev = 9), l.s();
                            case 11:
                              if ((f = l.n()).done) {
                                i.next = 20;
                                break;
                          ...
                          switch ((o.prev = o.next)) {
                            ...
                            case 3:
                              if (
                                ...
                                (c = a.getWordAtPosition({ lineNumber: t.startLineNumber, column: t.startColumn }, s)))
                              ) {
                                o.next = 9;
                                break;
                              }
                            ...
                            case 9:
                              return (
                                ...
                                (f = ct.INSTANCE.navigateValueSet(t, u, c, l, n)),
                                o.abrupt("return", f)
                              );
                            case 12:
                            case "end":
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                return this._foreignModuleFactory
                  ? ((this._foreignModule = this._foreignModuleFactory(i, t)), Promise.resolve(j(this._foreignModule)))
    ...
    function vn(e, t) {
      ...
      function d() {
        if (((i = ""), (f = 0), (o = r), (u = s), (l = c), r >= n)) return (o = n), (a = 17);
        ...
        switch (t) {
          ...
          case 47:
            ...
            if (47 === e.charCodeAt(r + 1)) {
              for (r += 2; r < n && !bn(e.charCodeAt(r)); ) r++;
            ...
            if (42 === e.charCodeAt(r + 1)) {
              ...
              for (var g = n - 1, p = !1; r < g; ) {
                ...
                r++, bn(v) && (13 === v && 10 === e.charCodeAt(r) && r++, s++, (c = r));
              }
              return p || (r++, (f = 1)), (i = e.substring(d, r)), (a = 13);
            }
            return (i += String.fromCharCode(t)), r++, (a = 16);
          case 45:
            if (((i += String.fromCharCode(t)), ++r === n || !_n(e.charCodeAt(r)))) return (a = 16);
          case 48:
          case 49:
          case 50:
          case 51:
          ...
          case 57:
            return (
              (i += (function () {
                ...
                else for (r++; r < e.length && _n(e.charCodeAt(r)); ) r++;
                if (r < e.length && 46 === e.charCodeAt(r)) {
                  if (!(++r < e.length && _n(e.charCodeAt(r)))) return (f = 3), e.substring(t, r);
                  for (r++; r < e.length && _n(e.charCodeAt(r)); ) r++;
                }
                var n = r;
                if (r < e.length && (69 === e.charCodeAt(r) || 101 === e.charCodeAt(r)))
                  if (
                    (((++r < e.length && 43 === e.charCodeAt(r)) || 45 === e.charCodeAt(r)) && r++,
                    r < e.length && _n(e.charCodeAt(r)))
                  ) {
                    for (r++; r < e.length && _n(e.charCodeAt(r)); ) r++;
                    n = r;
                  } else f = 3;
    ...
    function Cn(e, t, n) {
      var r, i, o, a, s;
      if (t) {
        for (a = t.offset, s = a + t.length, o = a; o > 0 && !kn(e, o - 1); ) o--;
        for (var u = s; u < e.length && !kn(e, u); ) u++;
        (i = e.substring(o, u)),
          (r = (function (e, t) {
            var n = 0,
              r = 0,
      ...
      var c,
        ...
        f = !1,
        h = 0;
      c = n.insertSpaces ? Sn(" ", n.tabSize || 4) : "\t";
      var d = vn(i, !1),
        m = !1;
      function g() {
        return l + Sn(c, r + h);
      ...
      var v = [];
      function y(n, r, i) {
        m || (t && !(r < s && i > a)) || e.substring(r, i) === n || v.push({ offset: r, length: i - r, content: n });
      }
      var b = p();
      if (17 !== b) {
      ...
      for (; 17 !== b; ) {
        for (
          var C = d.getTokenOffset() + d.getTokenLength() + o, S = p(), k = "", x = !1;
          !f && (12 === S || 13 === S);
        ...
        17 === S && (k = n.insertFinalNewline ? l : ""), y(k, C, d.getTokenOffset() + o), (b = S);
      }
      return v;
    }
    function Sn(e, t) {
          ...
          case 3:
            return (function () {
              ...
              for (var e = !1; 4 !== r.getToken() && 17 !== r.getToken(); ) {
                if (5 === r.getToken()) {
                  if ((e || y(4, [], []), h(","), v(), 4 === r.getToken() && p)) break;
                } else e && y(6, [], []);
                _() || y(4, [], [4, 5]), (e = !0);
              }
          ...
          case 1:
            return (function () {
              ...
              for (var e = !1; 2 !== r.getToken() && 17 !== r.getToken(); ) {
                if (5 === r.getToken()) {
                  if ((e || y(4, [], []), h(","), v(), 2 === r.getToken() && p)) break;
                } else e && y(6, [], []);
                (10 !== r.getToken()
                  ? (y(3, [], [2, 5]), 0)
                  : (b(!1), 6 === r.getToken() ? (h(":"), v(), _() || y(4, [], [2, 5])) : y(5, [], [2, 5]), 1)) ||
                  y(4, [], [2, 5]),
                  (e = !0);
              }
    ...
    var An,
      ...
      Zn = vn,
      er = function (e, t, n) {
        void 0 === t && (t = []), void 0 === n && (n = mn.DEFAULT);
        var r = null,
          i = [],
          o = [];
        function a(e) {
      ...
      tr = function e(t, n, r) {
        if (
          ...
          (function (e, t, n) {
            return (
              void 0 === n && (n = !1), (t >= e.offset && t < e.offset + e.length) || (n && t === e.offset + e.length)
            );
          })(t, n, r))
        ) {
          var i = t.children;
    ...
    function ir(e, t) {
      ...
      if (Array.isArray(e)) {
        if (e.length !== t.length) return !1;
        for (n = 0; n < e.length; n++) if (!ir(e[n], t[n])) return !1;
      } else {
        var i = [];
        for (r in e) i.push(r);
        i.sort();
        var o = [];
        for (r in t) o.push(r);
        if ((o.sort(), !ir(i, o))) return !1;
        for (n = 0; n < i.length; n++) if (!ir(e[i[n]], t[i[n]])) return !1;
      }
      return !0;
    }
    function or(e) {
    ...
    !(function (e) {
      ...
      ((Ln = En || (En = {})).create = function (e, t) {
        return (
          e === Number.MAX_VALUE && (e = wn.MAX_VALUE),
          t === Number.MAX_VALUE && (t = wn.MAX_VALUE),
          { line: e, character: t }
        );
      }),
      (Ln.is = function (e) {
        var t = e;
        return qr.objectLiteral(t) && qr.uinteger(t.line) && qr.uinteger(t.character);
      }),
      ((Tn = Nn || (Nn = {})).create = function (e, t, n, r) {
        if (qr.uinteger(e) && qr.uinteger(t) && qr.uinteger(n) && qr.uinteger(r))
          return { start: En.create(e, t), end: En.create(n, r) };
        if (En.is(e) && En.is(t)) return { start: e, end: t };
        throw new Error("Range#create called with invalid arguments[" + e + ", " + t + ", " + n + ", " + r + "]");
      }),
      (Tn.is = function (e) {
        var t = e;
        return qr.objectLiteral(t) && En.is(t.start) && En.is(t.end);
      }),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && Nn.is(t.range) && (qr.string(t.uri) || qr.undefined(t.uri));
          });
      })(On || (On = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (Nn.is(t.targetSelectionRange) || qr.undefined(t.targetSelectionRange)) &&
              (Nn.is(t.originSelectionRange) || qr.undefined(t.originSelectionRange))
            );
          });
      })(In || (In = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              qr.numberRange(t.red, 0, 1) &&
              qr.numberRange(t.green, 0, 1) &&
              qr.numberRange(t.blue, 0, 1) &&
              qr.numberRange(t.alpha, 0, 1)
            );
          });
      })(Pn || (Pn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Nn.is(t.range) && Pn.is(t.color);
          });
      })(Mn || (Mn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              qr.string(t.label) &&
              (qr.undefined(t.textEdit) || Kn.is(t)) &&
              (qr.undefined(t.additionalTextEdits) || qr.typedArray(t.additionalTextEdits, Kn.is))
            );
          });
      })(Rn || (Rn = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n, r, i) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              qr.uinteger(t.startLine) &&
              qr.uinteger(t.startLine) &&
              (qr.undefined(t.startCharacter) || qr.uinteger(t.startCharacter)) &&
              (qr.undefined(t.endCharacter) || qr.uinteger(t.endCharacter)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && On.is(t.location) && qr.string(t.message);
          });
      })(Fn || (Fn = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          var t = e;
          return void 0 !== t && null !== t && qr.string(t.href);
        };
      })(qn || (qn = {})),
      (function (e) {
        (e.create = function (e, t, n, r, i, o) {
          ...
          return (
            qr.defined(n) && (a.severity = n),
            qr.defined(r) && (a.code = r),
            qr.defined(i) && (a.source = i),
            qr.defined(o) && (a.relatedInformation = o),
            a
          );
        }),
          (e.is = function (e) {
            ...
            return (
              ...
              Nn.is(n.range) &&
              qr.string(n.message) &&
              (qr.number(n.severity) || qr.undefined(n.severity)) &&
              (qr.integer(n.code) || qr.string(n.code) || qr.undefined(n.code)) &&
              (qr.undefined(n.codeDescription) ||
                qr.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) &&
              (qr.string(n.source) || qr.undefined(n.source)) &&
              (qr.undefined(n.relatedInformation) || qr.typedArray(n.relatedInformation, Fn.is))
            );
          });
      })(Wn || (Wn = {})),
      (function (e) {
      ...
      (function (e) {
        (e.replace = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.objectLiteral(t) && qr.string(t.newText) && Nn.is(t.range);
          });
      })(Kn || (Kn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              qr.objectLiteral(t) &&
              qr.string(t.label) &&
              (qr.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) &&
              (qr.string(t.description) || void 0 === t.description)
            );
          });
      })($n || ($n = {})),
      (function (e) {
      ...
      (function (e) {
        (e.replace = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return Kn.is(t) && ($n.is(t.annotationId) || Hn.is(t.annotationId));
          });
      })(Yn || (Yn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && lr.is(t.textDocument) && Array.isArray(t.edits);
          });
      })(Gn || (Gn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (void 0 === t.annotationId || Hn.is(t.annotationId))
            );
          });
      })(zn || (zn = {})),
      (function (e) {
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return qr.string(e.kind) ? zn.is(e) || Jn.is(e) || Qn.is(e) : Gn.is(e);
              }))
          );
        };
      })(Xn || (Xn = {}));
      ...
      Ur = (function () {
        ...
        return (
          ...
          (e.prototype.manage = function (e, t) {
            var n;
            if ((Hn.is(e) ? (n = e) : ((n = this.nextId()), (t = e)), void 0 !== this._annotations[n]))
      ...
      Object.defineProperty(e.prototype, "edit", {
        ...
        (e.prototype.getTextEditChange = function (e) {
          if (lr.is(e)) {
            ...
            if (!(r = this._textEditChanges[t.uri])) {
              ...
              this._workspaceEdit.documentChanges.push(n),
                (r = new Fr(i, this._changeAnnotations)),
          ...
          if (!(r = this._textEditChanges[e])) {
            var i = [];
            (this._workspaceEdit.changes[e] = i), (r = new Fr(i)), (this._textEditChanges[e] = r);
          }
          return r;
        }),
        ...
        (e.prototype.createFile = function (e, t, n) {
          ...
          var r, i, o;
          if (
            ($n.is(t) || Hn.is(t) ? (r = t) : (n = t),
            void 0 === r
              ? (i = zn.create(e, n))
              : ((o = Hn.is(r) ? r : this._changeAnnotations.manage(r)), (i = zn.create(e, n, o))),
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
          ...
          var i, o, a;
          if (
            ($n.is(n) || Hn.is(n) ? (i = n) : (r = n),
            void 0 === i
              ? (o = Jn.create(e, t, r))
              : ((a = Hn.is(i) ? i : this._changeAnnotations.manage(i)), (o = Jn.create(e, t, r, a))),
        ...
        (e.prototype.deleteFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === r
              ? (i = Qn.create(e, n))
              : ((o = Hn.is(r) ? r : this._changeAnnotations.manage(r)), (i = Qn.create(e, n, o))),
            this._workspaceEdit.documentChanges.push(i),
            void 0 !== o)
          )
            return o;
    ...
    !(function (e) {
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && qr.string(t.uri) && qr.integer(t.version);
          });
      })(cr || (cr = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && qr.string(t.uri) && (null === t.version || qr.integer(t.version));
          });
      })(lr || (lr = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              qr.defined(t) && qr.string(t.uri) && qr.string(t.languageId) && qr.integer(t.version) && qr.string(t.text)
            );
          });
      })(fr || (fr = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          var t = e;
          return qr.objectLiteral(e) && hr.is(t.kind) && qr.string(t.value);
        };
      })(dr || (dr = {})),
      (function (e) {
        (e.Text = 1),
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return t && qr.string(t.newText) && Nn.is(t.insert) && Nn.is(t.replace);
          });
      })(vr || (vr = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          ...
          return (
            !!t &&
            qr.objectLiteral(t) &&
            (dr.is(t.contents) || Cr.is(t.contents) || qr.typedArray(t.contents, Cr.is)) &&
            (void 0 === e.range || Nn.is(e.range))
          );
        };
      })(Sr || (Sr = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              qr.defined(t) &&
              qr.typedArray(t.diagnostics, Wn.is) &&
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          var r = { title: e },
            i = !0;
          return (
            "string" === typeof t ? ((i = !1), (r.kind = t)) : Bn.is(t) ? (r.command = t) : (r.edit = t),
            i && void 0 !== n && (r.kind = n),
            r
          );
        }),
          (e.is = function (e) {
            ...
            return (
              t &&
              qr.string(t.title) &&
              (void 0 === t.diagnostics || qr.typedArray(t.diagnostics, Wn.is)) &&
              (void 0 === t.kind || qr.string(t.kind)) &&
              (void 0 !== t.edit || void 0 !== t.command) &&
              (void 0 === t.command || Bn.is(t.command)) &&
              (void 0 === t.isPreferred || qr.boolean(t.isPreferred)) &&
              (void 0 === t.edit || Xn.is(t.edit))
            );
          });
      })(Pr || (Pr = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && Nn.is(t.range) && (qr.undefined(t.command) || Bn.is(t.command));
          });
      })(Mr || (Mr = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && qr.uinteger(t.tabSize) && qr.boolean(t.insertSpaces);
          });
      })(Rr || (Rr = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return qr.defined(t) && Nn.is(t.range) && (qr.undefined(t.target) || qr.string(t.target));
          });
      })(jr || (jr = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (t) {
            var n = t;
            return void 0 !== n && Nn.is(n.range) && (void 0 === n.parent || e.is(n.parent));
          });
      })(Dr || (Dr = {}));
    var Vr;
    !(function (e) {
        ...
        return (
          ...
          (e.prototype.positionAt = function (e) {
            ...
            var t = this.getLineOffsets(),
              n = 0,
              r = t.length;
            if (0 === r) return En.create(0, e);
            for (; n < r; ) {
              var i = Math.floor((n + r) / 2);
              t[i] > e ? (r = i) : (n = i + 1);
            }
            var o = n - 1;
            return En.create(o, e - t[o]);
          }),
    ...
    var Br,
      ...
      Hr = (function () {
        ...
        return (
          ...
          (e.prototype.getLineOffsets = function () {
            return void 0 === this._lineOffsets && (this._lineOffsets = Yr(this._content, !0)), this._lineOffsets;
          }),
          (e.prototype.positionAt = function (e) {
            e = Math.max(Math.min(e, this._content.length), 0);
            var t = this.getLineOffsets(),
    ...
    !(function (e) {
      (e.create = function (e, t, n, r) {
        ...
        (e.update = function (e, t, n) {
          if (e instanceof Hr) return e.update(t, n), e;
      ...
      (($r || ($r = {})).LATEST = {
        textDocument: {
          completion: {
            completionItem: { documentationFormat: [hr.Markdown, hr.PlainText], commitCharactersSupport: !0 },
          },
        },
      });
    var Zr,
      ...
      ni = {
        "color-hex": {
          errorMessage: ti("colorHexFormatWarning", "Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA."),
          pattern: /^#([0-9A-Fa-f]{3,4}|([0-9A-Fa-f]{2}){3,4})$/,
        },
        "date-time": {
          errorMessage: ti("dateTimeFormatWarning", "String is not a RFC3339 date-time."),
          pattern:
            /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i,
        },
        date: {
          errorMessage: ti("dateFormatWarning", "String is not a RFC3339 date."),
          pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i,
        },
        time: {
          errorMessage: ti("timeFormatWarning", "String is not a RFC3339 time."),
          pattern:
            /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i,
        },
        email: {
          errorMessage: ti("emailFormatWarning", "String is not an e-mail address."),
          pattern:
    ...
    var hi = (function () {
        ...
        return (
          ...
          (e.prototype.include = function (e) {
            return (-1 === this.focusOffset || vi(e, this.focusOffset)) && e !== this.exclude;
          }),
    ...
    var yi = (function () {
      ...
      return (
        (e.prototype.getNodeFromOffset = function (e, t) {
          if ((void 0 === t && (t = !1), this.root)) return tr(this.root, e, t);
        }),
        ...
        (e.prototype.validate = function (e, t, n) {
          if ((void 0 === n && (n = Un.Warning), this.root && t)) {
            var r = new mi();
            return (
              bi(this.root, t, r, di.instance),
              r.problems.map(function (t) {
                var r,
                  i = Nn.create(e.positionAt(t.location.offset), e.positionAt(t.location.offset + t.location.length));
                return Wn.create(i, t.message, null !== (r = t.severity) && void 0 !== r ? r : n, t.code);
              })
            );
          }
        }),
        (e.prototype.getMatchingSchemas = function (e, t, n) {
          void 0 === t && (t = -1);
          var r = new hi(t, n);
          return this.root && e && bi(this.root, e, new mi(), r), r.schemas;
        }),
        e
      );
    })();
          ...
          case "object":
            !(function (e, t, n, r) {
                ...
                for (var c = 0, l = t.required; c < l.length; c++) {
                  ...
                  if (!i[f]) {
                    var h = e.parent && "property" === e.parent.type && e.parent.keyNode,
                      d = h ? { offset: h.offset, length: h.length } : { offset: e.offset, length: 1 };
                    n.problems.push({
                      location: d,
                      message: ti("MissingRequiredPropWarning", 'Missing property "{0}".', f),
                    });
                  }
                }
              var m = function (e) {
                    ...
                    if (sr(v))
                      if (v) n.propertiesMatches++, n.propertiesValueMatches++;
                        ...
                        n.problems.push({
                          ...
                          message:
                            t.errorMessage || ti("DisallowedExtraPropWarning", "Property {0} is not allowed.", f),
                        });
                      }
                    else {
                      var b = new mi();
                      bi(T, v, b, r), n.mergePropertyMatch(b);
                    }
                }
              if (t.patternProperties)
                for (var _ = 0, C = Object.keys(t.patternProperties); _ < C.length; _++)
                  for (var S = C[_], k = new RegExp(S), x = 0, A = o.slice(0); x < A.length; x++) {
                    f = A[x];
                    if (k.test(f))
                      if ((m(f), (T = i[f])))
                        if (sr((v = t.patternProperties[S])))
                          if (v) n.propertiesMatches++, n.propertiesValueMatches++;
                          else {
                            y = T.parent;
                            n.problems.push({
              ...
              if ("object" === typeof t.additionalProperties)
                for (var w = 0, E = o; w < E.length; w++) {
                  f = E[w];
                  if ((T = i[f])) {
                    b = new mi();
                    bi(T, t.additionalProperties, b, r), n.mergePropertyMatch(b);
                  }
                }
              else if (!1 === t.additionalProperties && o.length > 0)
                for (var L = 0, N = o; L < N.length; L++) {
                  var T;
                  f = N[L];
                  if ((T = i[f])) {
                    y = T.parent;
                    n.problems.push({
                      location: { offset: y.keyNode.offset, length: y.keyNode.length },
                      message: t.errorMessage || ti("DisallowedExtraPropWarning", "Property {0} is not allowed.", f),
                    });
                  }
                }
              or(t.maxProperties) &&
                ...
                n.problems.push({
                  ...
                  message: ti("MaxPropWarning", "Object has more properties than limit of {0}.", t.maxProperties),
                });
              or(t.minProperties) &&
                ...
                for (var O = 0, I = Object.keys(t.dependencies); O < I.length; O++) {
                  ...
                  if (i[u]) {
                    ...
                    if (Array.isArray(P))
                      ...
                      b = new mi();
                      bi(e, v, b, r), n.mergePropertyMatch(b);
                    }
                  }
                }
              var D = fi(t.propertyNames);
              if (D)
                for (var F = 0, U = e.properties; F < U.length; F++) {
                  var V = U[F];
                  (u = V.keyNode) && bi(u, D, n, di.instance);
                }
            })(i, t, n, r);
            break;
          case "array":
              ...
              if (Array.isArray(t.items)) {
                for (var i = t.items, o = 0; o < i.length; o++) {
                  var a = fi(i[o]),
                    s = new mi();
                  (h = e.items[o])
                    ? (bi(h, a, s, r), n.mergePropertyMatch(s))
                ...
                if (e.items.length > i.length)
                  if ("object" === typeof t.additionalItems)
                    for (var u = i.length; u < e.items.length; u++) {
                      s = new mi();
                      bi(e.items[u], t.additionalItems, s, r), n.mergePropertyMatch(s);
                    }
                  else
                    !1 === t.additionalItems &&
                      n.problems.push({
                ...
                if (c)
                  for (var l = 0, f = e.items; l < f.length; l++) {
                    var h = f[l];
                    s = new mi();
                    bi(h, c, s, r), n.mergePropertyMatch(s);
                  }
              }
              var d = fi(t.contains);
              if (d) {
                e.items.some(function (e) {
                  var t = new mi();
                  return bi(e, d, t, di.instance), !t.hasProblems();
                }) ||
                  n.problems.push({
                    location: { offset: e.offset, length: e.length },
                    message:
                      t.errorMessage || ti("requiredItemMissingWarning", "Array does not contain required item."),
                  });
              }
              or(t.minItems) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("minItemsWarning", "Array has too few items. Expected {0} or more.", t.minItems),
                });
              or(t.maxItems) &&
                e.items.length > t.maxItems &&
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("maxItemsWarning", "Array has too many items. Expected {0} or fewer.", t.maxItems),
                });
              if (!0 === t.uniqueItems) {
                var m = gi(e);
                m.some(function (e, t) {
                  ...
                  n.problems.push({
                    location: { offset: e.offset, length: e.length },
                    message: ti("uniqueItemsWarning", "Array has duplicate items."),
                  });
              }
            })(i, t, n, r);
            break;
          case "string":
            !(function (e, t, n, r) {
              or(t.minLength) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("minLengthWarning", "String is shorter than the minimum length of {0}.", t.minLength),
                });
              or(t.maxLength) &&
                e.value.length > t.maxLength &&
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("maxLengthWarning", "String is longer than the maximum length of {0}.", t.maxLength),
                });
                ...
                new RegExp(t.pattern).test(e.value) ||
                  n.problems.push({
                    ...
                    message:
                      ...
                      t.errorMessage ||
                      ti("patternWarning", 'String does not match the pattern of "{0}".', t.pattern),
                  });
              }
              var i;
              if (t.format)
                switch (t.format) {
                  ...
                  case "uri-reference":
                    ...
                    if (e.value) {
                      var a = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(e.value);
                      a
                        ? a[2] || "uri" !== t.format || (o = ti("uriSchemeMissing", "URI with a scheme is expected."))
                        : (o = ti("uriMissing", "URI is expected."));
                    } else o = ti("uriEmpty", "URI expected.");
                    o &&
                      n.problems.push({
                        location: { offset: e.offset, length: e.length },
                        message:
                          t.patternErrorMessage ||
                          t.errorMessage ||
                          ti("uriFormatWarning", "String is not a URI: {0}", o),
                      });
                    break;
                  case "color-hex":
                  case "date-time":
          ...
          case "number":
            !(function (e, t, n, r) {
              ...
              function o(e) {
                ...
                return (
                  n && {
                    ...
                    multiplier:
                      ((null === (t = n[2]) || void 0 === t ? void 0 : t.length) || 0) - (parseInt(n[3]) || 0),
                  }
                );
              }
              if (or(t.multipleOf)) {
                ...
                0 !== a &&
                  n.problems.push({
                    location: { offset: e.offset, length: e.length },
                    message: ti("multipleOfWarning", "Value is not divisible by {0}.", t.multipleOf),
                  });
              }
              function l(e, t) {
                return or(t) ? t : sr(t) && t ? e : void 0;
              }
              function f(e, t) {
                if (!sr(t) || !t) return e;
              }
              ...
              or(h) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("exclusiveMinimumWarning", "Value is below the exclusive minimum of {0}.", h),
                });
              ...
              or(d) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("exclusiveMaximumWarning", "Value is above the exclusive maximum of {0}.", d),
                });
              ...
              or(m) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("minimumWarning", "Value is below the minimum of {0}.", m),
                });
              ...
              or(g) &&
                ...
                n.problems.push({
                  location: { offset: e.offset, length: e.length },
                  message: ti("maximumWarning", "Value is above the maximum of {0}.", g),
                });
            })(i, t, n);
            break;
          case "property":
            return bi(i.valueNode, t, n, r);
        }
        !(function () {
          function e(e) {
          ...
          Array.isArray(t.type)
            ? t.type.some(e) ||
              n.problems.push({
                ...
                message:
                  t.errorMessage ||
                  ti("typeArrayMismatchWarning", "Incorrect type. Expected one of {0}.", t.type.join(", ")),
              })
            : t.type &&
              (e(t.type) ||
                n.problems.push({
                  location: { offset: i.offset, length: i.length },
                  message: t.errorMessage || ti("typeMismatchWarning", 'Incorrect type. Expected "{0}".', t.type),
                }));
          ...
          if (u) {
            ...
            bi(i, u, c, l),
              c.hasProblems() ||
                n.problems.push({
                  location: { offset: i.offset, length: i.length },
                  message: ti("notSchemaWarning", "Matches a schema that is not allowed."),
                });
          ...
          var m = function (e, t) {
            for (var o = [], a = void 0, s = 0, u = e; s < u.length; s++) {
              var c = fi(u[s]),
                l = new mi(),
                f = r.newSub();
              if ((bi(i, c, l, f), l.hasProblems() || o.push(c), a))
            ...
            return (
              o.length > 1 &&
                ...
                n.problems.push({
                  ...
                  message: ti("oneOfWarning", "Matches multiple schemas when only one must validate."),
                }),
              a &&
          ...
          p &&
            (function (e, t, n) {
              var o = fi(e),
                a = new mi(),
                s = r.newSub();
              bi(i, o, a, s), r.merge(s), a.hasProblems() ? n && g(n) : t && g(t);
            })(p, fi(t.then), fi(t.else));
          if (Array.isArray(t.enum)) {
            for (var v = gi(i), y = !1, b = 0, _ = t.enum; b < _.length; b++) {
              var C = _[b];
              if (ir(v, C)) {
                y = !0;
                break;
          ...
          if (ar(t.const)) {
            ir((v = gi(i)), t.const)
              ...
              : (n.problems.push({
                  location: { offset: i.offset, length: i.length },
                  code: Kr.EnumValueMismatch,
                  message: t.errorMessage || ti("constWarning", "Value must be {0}.", JSON.stringify(t.const)),
                }),
                (n.enumValueMatch = !1)),
    ...
    function _i(e, t) {
        ...
        for (;;) {
          ...
          switch ((l(), t)) {
            ...
            case 13:
              Array.isArray(a) &&
                a.push(
                  Nn.create(e.positionAt(o.getTokenOffset()), e.positionAt(o.getTokenOffset() + o.getTokenLength())),
                );
              break;
            case 15:
            case 14:
      ...
      function u(t, i, o, a, s) {
        if ((void 0 === s && (s = Un.Error), 0 === n.length || o !== r)) {
          var u = Nn.create(e.positionAt(o), e.positionAt(a));
          n.push(Wn.create(u, t, s, i, e.languageId)), (r = o);
        }
      }
      ...
      function l() {
        switch (o.getTokenError()) {
          case 4:
            return c(ti("InvalidUnicode", "Invalid unicode sequence in string."), Kr.InvalidUnicode), !0;
          case 5:
            return (
              c(ti("InvalidEscapeCharacter", "Invalid escape character in string."), Kr.InvalidEscapeCharacter), !0
            );
          case 3:
            return c(ti("UnexpectedEndOfNumber", "Unexpected end of number."), Kr.UnexpectedEndOfNumber), !0;
          case 1:
            return c(ti("UnexpectedEndOfComment", "Unexpected end of comment."), Kr.UnexpectedEndOfComment), !0;
          case 2:
            return c(ti("UnexpectedEndOfString", "Unexpected end of string."), Kr.UnexpectedEndOfString), !0;
          case 6:
            return (
              c(
                ti("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."),
                Kr.InvalidCharacter,
              ),
              !0
            );
      ...
      var h = new ui(void 0, 0, 0);
      function d(t, n) {
        var r = new ci(t, o.getTokenOffset(), h),
          i = m(r);
        if (!i) {
          if (16 !== o.getToken()) return;
          c(ti("DoubleQuotesExpected", "Property keys must be doublequoted"), Kr.Undefined);
          var a = new ui(r, o.getTokenOffset(), o.getTokenLength());
        ...
        if (
          (l
            ? (u(
                ti("DuplicateKeyWarning", "Duplicate object key"),
                Kr.DuplicateKey,
                r.keyNode.offset,
          ...
          (c(ti("ColonExpected", "Colon expected"), Kr.ColonExpected),
        ...
        return f
          ...
          : c(ti("ValueExpected", "Value expected"), Kr.ValueExpected, r, [], [2, 5]);
      }
      function m(e) {
        if (10 === o.getToken()) {
          var t = new ui(e, o.getTokenOffset());
      ...
      function g(e) {
        return (
          (function (e) {
            if (3 === o.getToken()) {
              var t = new ai(e, o.getTokenOffset());
              s();
              for (var n = !1; 4 !== o.getToken() && 17 !== o.getToken(); ) {
                if (5 === o.getToken()) {
                  n || c(ti("ValueExpected", "Value expected"), Kr.ValueExpected);
                  var r = o.getTokenOffset();
                  if ((s(), 4 === o.getToken())) {
                    n && u(ti("TrailingComma", "Trailing comma"), Kr.TrailingComma, r, r + 1);
                    continue;
                  }
                } else n && c(ti("ExpectedComma", "Expected comma"), Kr.CommaExpected);
                var i = g(t);
                i ? t.items.push(i) : c(ti("PropertyExpected", "Value expected"), Kr.ValueExpected, void 0, [], [4, 5]),
                  (n = !0);
              }
              return 4 !== o.getToken()
                ? c(ti("ExpectedCloseBracket", "Expected comma or closing bracket"), Kr.CommaOrCloseBacketExpected, t)
                : f(t, !0);
            }
          })(e) ||
          (function (e) {
            if (1 === o.getToken()) {
              ...
              for (var r = !1; 2 !== o.getToken() && 17 !== o.getToken(); ) {
                if (5 === o.getToken()) {
                  r || c(ti("PropertyExpected", "Property expected"), Kr.PropertyExpected);
                  var i = o.getTokenOffset();
                  if ((s(), 2 === o.getToken())) {
                    r && u(ti("TrailingComma", "Trailing comma"), Kr.TrailingComma, i, i + 1);
                    continue;
                  }
                } else r && c(ti("ExpectedComma", "Expected comma"), Kr.CommaExpected);
                var a = d(t, n);
                a
                  ? t.properties.push(a)
                  : c(ti("PropertyExpected", "Property expected"), Kr.PropertyExpected, void 0, [], [2, 5]),
                  (r = !0);
              }
              return 2 !== o.getToken()
                ? c(ti("ExpectedCloseBrace", "Expected comma or closing brace"), Kr.CommaOrCloseBraceExpected, t)
                : f(t, !0);
            }
          })(e) ||
          m(e) ||
          (function (e) {
            if (11 === o.getToken()) {
              var t = new si(e, o.getTokenOffset());
              if (0 === o.getTokenError()) {
                var n = o.getTokenValue();
                try {
                  var r = JSON.parse(n);
                  if (!or(r)) return c(ti("InvalidNumberFormat", "Invalid number format."), Kr.Undefined, t);
                  t.value = r;
                } catch (i) {
                  return c(ti("InvalidNumberFormat", "Invalid number format."), Kr.Undefined, t);
                }
          ...
          (function (e) {
            switch (o.getToken()) {
              case 7:
                return f(new ii(e, o.getTokenOffset()), !0);
              case 8:
                return f(new oi(e, !0, o.getTokenOffset()), !0);
              case 9:
                return f(new oi(e, !1, o.getTokenOffset()), !0);
              default:
                return;
            }
          })(e)
      ...
      return (
        17 !== s() &&
          ((p = g(p))
            ? 17 !== o.getToken() && c(ti("End of file expected", "End of file expected."), Kr.Undefined)
            : c(ti("Invalid symbol", "Expected a JSON object, array or literal."), Kr.Undefined)),
        new yi(p, n, a)
      );
    }
    function Ci(e, t) {
        ...
        return (
          ...
          (e.prototype.doComplete = function (e, t, n) {
            ...
            if (!s || ("string" !== s.type && "number" !== s.type && "boolean" !== s.type && "null" !== s.type)) {
              var f = a - l.length;
              f > 0 && '"' === o[f - 1] && f--, (c = Nn.create(e.positionAt(f), t));
            } else c = Nn.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length));
            var h = {},
              d = {
                add: function (e) {
                  var t = e.label,
                  ...
                  if (n) n.documentation || (n.documentation = e.documentation), n.detail || (n.detail = e.detail);
                    ...
                    c && void 0 !== e.insertText && (e.textEdit = Kn.replace(c, e.insertText)),
                      (e.label = t),
                      (h[t] = e),
                      i.items.push(e);
                  }
            ...
            return this.schemaService.getSchemaForResource(e.uri, n).then(function (t) {
              ...
              if (s && "string" === s.type) {
                ...
                p &&
                  "property" === p.type &&
                  p.keyNode === s &&
                  ((f = !p.valueNode), (g = p), (m = o.substr(s.offset + 1, s.length - 2)), p && (s = p.parent));
              }
              if (s && "object" === s.type) {
                if (s.offset === a) return i;
                s.properties.forEach(function (e) {
                  (g && g === e) || (h[e.keyNode.value] = br.create("__"));
                });
                var v = "";
                f && (v = r.evaluateSeparatorAfter(e, e.offsetAt(c.end))),
                  t ? r.getPropertyCompletions(t, n, s, f, v, d) : r.getSchemaLessPropertyCompletions(n, s, m, d);
                var y = pi(s);
                r.contributions.forEach(function (t) {
                  var n = t.collectPropertyCompletions(e.uri, y, l, f, "" === v, d);
                  n && u.push(n);
                }),
                  !t &&
                    l.length > 0 &&
              ...
              var b = {};
              return (
                t ? r.getValueCompletions(t, n, s, a, e, d, b) : r.getSchemaLessValueCompletions(n, s, a, e, d),
          ...
          (e.prototype.getValueCompletions = function (e, t, n, r, i, o, a) {
            ...
            if (
              ...
              if (n && (void 0 !== u || "array" === n.type)) {
                for (
                  var f = this.evaluateSeparatorAfter(i, s), h = 0, d = t.getMatchingSchemas(e.schema, n.offset, c);
                  h < d.length;
                  h++
                ) {
                  var m = d[h];
                  if (m.node === n && !m.inverted && m.schema) {
                    ...
                    if (void 0 !== u) {
                      ...
                      if (m.schema.properties)
                        (_ = m.schema.properties[u]) && ((p = !0), this.addSchemaValueCompletions(_, f, o, a));
                      if (m.schema.patternProperties && !p)
                        for (var v = 0, y = Object.keys(m.schema.patternProperties); v < y.length; v++) {
                          ...
                          if (new RegExp(b).test(u)) {
                            ...
                            this.addSchemaValueCompletions(_, f, o, a);
                          }
                        }
          ...
          (e.prototype.collectTypes = function (e, t) {
            if (!Array.isArray(e.enum) && !ar(e.const)) {
              var n = e.type;
              Array.isArray(n)
            ...
            if (t) {
              if (Array.isArray(t.defaultSnippets)) {
                if (1 === t.defaultSnippets.length) {
                  ...
                  ar(u) && (o = this.getInsertTextForSnippetValue(u, ""));
                }
              ...
              if (
                (t.enum &&
                  ...
                  (s += t.enum.length)),
                ar(t.default) && (o || (o = this.getInsertTextForGuessedValue(t.default, "")), s++),
          ...
          (e.prototype.findItemAtOffset = function (e, t, n) {
            for (var r = Zn(t.getText(), !0), i = e.items, o = i.length - 1; o >= 0; o--) {
              var a = i[o];
          ...
          (e.prototype.fromMarkup = function (e) {
            if (e && this.doesSupportMarkdown()) return { kind: hr.Markdown, value: e };
          }),
          (e.prototype.doesSupportMarkdown = function () {
            if (!ar(this.supportsMarkdown)) {
              ...
              this.supportsMarkdown =
                ...
                -1 !== e.completionItem.documentationFormat.indexOf(hr.Markdown);
            }
            return this.supportsMarkdown;
          }),
          (e.prototype.doesSupportsCommitCharacters = function () {
            if (!ar(this.supportsCommitCharacters)) {
              var e = this.clientCapabilities.textDocument && this.clientCapabilities.textDocument.completion;
      ...
      Ai = (function () {
        ...
        return (
          (e.prototype.doHover = function (e, t, n) {
            ...
            if ("string" === i.type) {
              var a = i.parent;
              if (a && "property" === a.type && a.keyNode === i && !(i = a.valueNode))
                return this.promise.resolve(null);
            }
            for (
              var s = Nn.create(e.positionAt(o.offset), e.positionAt(o.offset + o.length)),
                u = function (e) {
              ...
              if (e && i) {
                ...
                t.every(function (e) {
                  if (
                    ...
                    e.schema &&
                    ((r = r || e.schema.title),
                    (o = o || e.schema.markdownDescription || wi(e.schema.description)),
                    e.schema.enum)
                  ) {
                    var t = e.schema.enum.indexOf(gi(i));
                    e.schema.markdownEnumDescriptions
                      ? (a = e.schema.markdownEnumDescriptions[t])
                      : e.schema.enumDescriptions && (a = wi(e.schema.enumDescriptions[t])),
        ...
        function e(e, t) {
          ...
          try {
            for (var n = 0, r = e; n < r.length; n++) {
              var i = r[n],
                o = "!" !== i[0];
              o || (i = i.substring(1)), this.patternRegExps.push(new RegExp(Si(i) + "$")), this.isInclude.push(o);
            }
            this.uris = t;
          } catch (a) {
      ...
      Ti = (function () {
        function e(e, t, n) {
          (this.service = e),
            (this.url = t),
            (this.dependencies = {}),
            n && (this.unresolvedSchema = this.service.promise.resolve(new Oi(n)));
        }
        return (
        ...
        return (
          ...
          (e.prototype.loadSchema = function (e) {
            if (!this.requestService) {
              ...
              return this.promise.resolve(new Oi({}, [t]));
            }
            return this.requestService(e).then(
              function (t) {
                if (!t) {
                  var n = Li("json.schema.nocontent", "Unable to load schema from '{0}': No content.", ji(e));
                  return new Oi({}, [n]);
                }
                var r,
                  i = [];
              ...
              function (t) {
                ...
                return (
                  r.length > 1 && (n = r[1]),
                  Ci(n, ".") && (n = n.substr(0, n.length - 1)),
                  new Oi({}, [Li("json.schema.nocontent", "Unable to load schema from '{0}': {1}.", ji(e), n)])
                );
              },
            );
          }),
          (e.prototype.resolveSchemaContent = function (e, t, n) {
            ...
            if (o.$schema) {
              ...
              if ("http://json-schema.org/draft-03/schema" === a)
                return this.promise.resolve(
                  new Ii({}, [Li("json.schema.draft03.notsupported", "Draft-03 schemas are not supported.")]),
                );
              "https://json-schema.org/draft/2019-09/schema" === a &&
                i.push(
                  Li("json.schema.draft201909.notsupported", "Draft 2019-09 schemas are not yet fully supported."),
                );
            }
            var s = this.contextService,
              u = function (e, t, n, r) {
                ...
                else i.push(Li("json.schema.invalidref", "$ref '{0}' in '{1}' can not be resolved.", o, n));
              },
              c = function (e, t, n, o, a) {
                s && !/^\w+:\/\/.*/.test(t) && (t = s.resolveRelativePath(t, o)), (t = Ri(t));
                var c = r.getOrAddSchemaHandle(t);
                return c.getUnresolvedSchema().then(function (r) {
                  if (((a[t] = !0), r.errors.length)) {
                    var o = n ? t + "#" + n : t;
                    i.push(
                      Li("json.schema.problemloadingref", "Problems loading reference '{0}': {1}", o, r.errors[0]),
                    );
                  }
          ...
          (e.prototype.getSchemaForResource = function (e, t) {
            ...
            for (
              var a = Object.create(null),
                ...
                u = (function (e) {
                  try {
                    return Ei.a.parse(e).with({ fragment: null, query: null }).toString();
                  } catch (t) {
                    return e;
                  }
                })(e),
            ...
            var g = s.length > 0 ? this.createCombinedSchema(e, s).getResolvedSchema() : this.promise.resolve(void 0);
          ...
          (e.prototype.getMatchingSchemas = function (e, t, n) {
            if (n) {
              var r = n.id || "schemaservice://untitled/matchingSchemas/" + Mi++;
              return this.resolveSchemaContent(new Oi(n), r, {}).then(function (e) {
        ...
        return (
          (e.prototype.configure = function (e) {
            e &&
              ...
              (this.commentSeverity = e.allowComments ? void 0 : Un.Error));
          }),
          (e.prototype.doValidation = function (e, t, n, r) {
            ...
            var o = [],
              ...
              u = function (r) {
                var a = n ? Vi(n.trailingCommas) : Un.Error,
                  u = n ? Vi(n.comments) : i.commentSeverity,
                  c = (null === n || void 0 === n ? void 0 : n.schemaValidation) ? Vi(n.schemaValidation) : Un.Warning,
                  l = (null === n || void 0 === n ? void 0 : n.schemaRequest) ? Vi(n.schemaRequest) : Un.Warning;
                if (r) {
                  if (r.errors.length && t.root && l) {
                    ...
                    if (h && "$schema" === h.keyNode.value) {
                      var d = h.valueNode || h,
                        m = Nn.create(e.positionAt(d.offset), e.positionAt(d.offset + d.length));
                      s(Wn.create(m, r.errors[0], l, Kr.SchemaResolveError));
                    } else {
                      m = Nn.create(e.positionAt(f.offset), e.positionAt(f.offset + 1));
                      s(Wn.create(m, r.errors[0], l, Kr.SchemaResolveError));
                    }
                  } else if (c) {
                  ...
                  (function e(t) {
                    if (t && "object" === typeof t) {
                      if (sr(t.allowComments)) return t.allowComments;
                      if (t.allOf)
                    ...
                    (function e(t) {
                      if (t && "object" === typeof t) {
                        if (sr(t.allowTrailingCommas)) return t.allowTrailingCommas;
                        var n = t;
                        if (sr(n.allowsTrailingCommas)) return n.allowsTrailingCommas;
                        if (t.allOf)
                ...
                if ("number" === typeof u) {
                  var b = Di("InvalidCommentToken", "Comments are not permitted in JSON.");
                  t.comments.forEach(function (e) {
                    s(Wn.create(e, b, u, Kr.CommentNotPermitted));
                  });
                }
                return o;
              };
            if (r) {
              var c = r.id || "schemaservice://untitled/" + Ui++;
              return this.jsonSchemaService.resolveSchemaContent(new Oi(r), c, {}).then(function (e) {
                return u(e);
              });
            }
    ...
    function Wi(e) {
      if ("#" === e[0])
        switch (e.length) {
          case 4:
            return {
              red: (17 * qi(e.charCodeAt(1))) / 255,
              green: (17 * qi(e.charCodeAt(2))) / 255,
              blue: (17 * qi(e.charCodeAt(3))) / 255,
              alpha: 1,
            };
          case 5:
            return {
              ...
              green: (17 * qi(e.charCodeAt(2))) / 255,
              blue: (17 * qi(e.charCodeAt(3))) / 255,
              alpha: (17 * qi(e.charCodeAt(4))) / 255,
            };
          case 7:
            return {
              red: (16 * qi(e.charCodeAt(1)) + qi(e.charCodeAt(2))) / 255,
              green: (16 * qi(e.charCodeAt(3)) + qi(e.charCodeAt(4))) / 255,
              blue: (16 * qi(e.charCodeAt(5)) + qi(e.charCodeAt(6))) / 255,
              alpha: 1,
            };
          case 9:
            return {
              ...
              green: (16 * qi(e.charCodeAt(3)) + qi(e.charCodeAt(4))) / 255,
              blue: (16 * qi(e.charCodeAt(5)) + qi(e.charCodeAt(6))) / 255,
              alpha: (16 * qi(e.charCodeAt(7)) + qi(e.charCodeAt(8))) / 255,
            };
        }
    }
    var Bi = (function () {
      ...
      return (
        (e.prototype.findDocumentSymbols = function (e, t, n) {
          ...
          var o = n.resultLimit || Number.MAX_VALUE,
            a = e.uri;
          if (
            ("vscode://defaultsettings/keybindings.json" === a || Ci(a.toLowerCase(), "/user/keybindings.json")) &&
            "array" === i.type
          ) {
              ...
              if ("object" === l.type)
                for (var f = 0, h = l.properties; f < h.length; f++) {
                  ...
                  if ("key" === d.keyNode.value && d.valueNode) {
                    var m = On.create(e.uri, Ki(e, l));
                    if ((s.push({ name: gi(d.valueNode), kind: Er.Function, location: m }), --o <= 0))
        ...
        (e.prototype.findDocumentSymbols2 = function (e, t, n) {
              ...
              if ("object" === l.type)
                for (var f = 0, h = l.properties; f < h.length; f++) {
                  ...
                  if ("key" === d.keyNode.value && d.valueNode) {
                    var m = Ki(e, l),
                      g = Ki(e, d.keyNode);
                    if ((s.push({ name: gi(d.valueNode), kind: Er.Function, range: m, selectionRange: g }), --o <= 0))
                      return n && n.onResultLimitExceeded && n.onResultLimitExceeded(a), s;
                  }
                }
            }
          ...
          return b && n && n.onResultLimitExceeded && n.onResultLimitExceeded(a), p;
        }),
        ...
        (e.prototype.getColorPresentations = function (e, t, n, r) {
          ...
          return (
            ...
            o.push({ label: i, textEdit: Kn.replace(r, JSON.stringify(i)) }),
            o
          );
        }),
        e
    ...
    function Ki(e, t) {
      return Nn.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length));
    }
    var $i = Xr(),
      Hi = {
        schemaAssociations: [],
        schemas: {
          ...
          "http://json-schema.org/draft-04/schema#": {
            title: $i("schema.json", "Describes a JSON file using a schema. See json-schema.org for more info."),
      ...
      Yi = {
        id: $i("schema.json.id", "A unique identifier for the schema."),
        $schema: $i("schema.json.$schema", "The schema to verify this document against."),
        title: $i("schema.json.title", "A descriptive title of the element."),
        description: $i(
          "schema.json.description",
          "A long description of the element. Used in hover menus and suggestions.",
        ),
        default: $i("schema.json.default", "A default value. Used by suggestions."),
        multipleOf: $i(
          "schema.json.multipleOf",
          "A number that should cleanly divide the current value (i.e. have no remainder).",
        ),
        maximum: $i("schema.json.maximum", "The maximum numerical value, inclusive by default."),
        exclusiveMaximum: $i("schema.json.exclusiveMaximum", "Makes the maximum property exclusive."),
        minimum: $i("schema.json.minimum", "The minimum numerical value, inclusive by default."),
        exclusiveMinimum: $i("schema.json.exclusiveMininum", "Makes the minimum property exclusive."),
        maxLength: $i("schema.json.maxLength", "The maximum length of a string."),
        minLength: $i("schema.json.minLength", "The minimum length of a string."),
        pattern: $i(
          "schema.json.pattern",
        ...
        maxItems: $i("schema.json.maxItems", "The maximum number of items that can be inside an array. Inclusive."),
        minItems: $i("schema.json.minItems", "The minimum number of items that can be inside an array. Inclusive."),
        uniqueItems: $i(
        ...
        properties: $i("schema.json.properties", "A map of property names to schemas for each property."),
        patternProperties: $i(
        ...
        enum: $i("schema.json.enum", "The set of literal values that are valid."),
        type: $i(
          "schema.json.type",
        ...
        format: $i("schema.json.format", "Describes the format expected for the value."),
        allOf: $i("schema.json.allOf", "An array of schemas, all of which must match."),
        anyOf: $i("schema.json.anyOf", "An array of schemas, where at least one must match."),
        oneOf: $i("schema.json.oneOf", "An array of schemas, exactly one of which must match."),
        not: $i("schema.json.not", "A schema which must not match."),
        $id: $i("schema.json.$id", "A unique identifier for the schema."),
        $ref: $i("schema.json.$ref", "Reference a definition hosted on any location."),
        $comment: $i("schema.json.$comment", "Comments from schema authors to readers or maintainers of the schema."),
        readOnly: $i(
        ...
        contentMediaType: $i("schema.json.contentMediaType", "Describes the media type of a string property."),
        contentEncoding: $i("schema.json.contentEncoding", "Describes the content encoding of a string property."),
        if: $i(
          "schema.json.if",
          'The validation outcome of the "if" subschema controls which of the "then" or "else" keywords are evaluated.',
        ),
        then: $i("schema.json.then", 'The "if" subschema is used for validation when the "if" subschema succeeds.'),
        else: $i("schema.json.else", 'The "else" subschema is used for validation when the "if" subschema fails.'),
      };
    for (var Gi in Hi.schemas) {
      var zi = Hi.schemas[Gi];
      for (var Ji in zi.properties) {
        var Qi = zi.properties[Ji];
        "boolean" === typeof Qi && (Qi = zi.properties[Ji] = {});
        var Xi = Yi[Ji];
        Xi ? (Qi.description = Xi) : console.log(Ji + ": localize('schema.json." + Ji + '\', "")');
      }
    }
    function Zi(e, t) {
      var n = [],
        ...
        switch (s) {
          ...
          case 13:
            ...
            1 === a.getTokenError() && h + 1 < e.lineCount
              ? a.setPosition(e.offsetAt(En.create(h + 1, 0)))
              : h < d && (u({ startLine: h, endLine: d, kind: jn.Comment }), (o = h));
            break;
          case 12:
            var m = e
              .getText()
            ...
            if (m) {
              ...
              if (m[1]) {
                c = { startLine: f, endLine: f, kind: jn.Region };
                i.push(c);
              } else {
                for (var g = i.length - 1; g >= 0 && i[g].kind !== jn.Region; ) g--;
                if (g >= 0) {
                  c = i[g];
                  (i.length = g), f > c.startLine && o !== c.startLine && ((c.endLine = f), u(c), (o = c.startLine));
                }
              }
            }
        }
      ...
      for (g = 0; g < n.length; g++) {
        var x;
        "number" === typeof (x = r[g]) && (x < C || (x === C && _++ < p)) && k.push(n[g]);
      }
      return k;
    }
    function eo(e, t, n) {
      function r(t, n) {
        return Nn.create(e.positionAt(t), e.positionAt(n));
      }
      var i = Zn(e.getText(), !0);
      function o(e, t) {
      ...
      return t.map(function (t) {
        for (var i = e.offsetAt(t), a = n.getNodeFromOffset(i, !0), s = []; a; ) {
          switch (a.type) {
            ...
            case "array":
              ...
              u < c && i >= u && i <= c && s.push(r(u, c)), s.push(r(a.offset, a.offset + a.length));
              break;
            case "number":
            case "boolean":
            case "null":
        ...
        for (var f = void 0, h = s.length - 1; h >= 0; h--) f = Dr.create(s[h], f);
        return f || (f = Dr.create(Nn.create(t, t))), f;
      });
    }
    function to(e, t) {
      var n = [];
        ...
        t.visit(function (r) {
          ...
          if (
            ...
            var o = r.valueNode.value,
              a = (function (e, t) {
                var n = (function (e) {
                  ...
                  return e.substring(2).split(/\//).map(ro);
                })(t);
                if (!n) return null;
            ...
            if (a) {
              ...
              n.push({ target: e.uri + "#" + (s.line + 1) + "," + (s.character + 1), range: no(e, r.valueNode) });
            }
          }
          return !0;
        }),
    ...
    function no(e, t) {
      return Nn.create(e.positionAt(t.offset + 1), e.positionAt(t.offset + t.length - 1));
    }
    function ro(e) {
    ...
    function io(e) {
      var t = e.promiseConstructor || Promise,
        n = new Pi(e.schemaRequestService, e.workspaceContext, t);
      n.setSchemaContributions(Hi);
      var r = new xi(n, e.contributions, t, e.clientCapabilities),
        i = new Ai(n, e.contributions, t),
        o = new Bi(n),
        a = new Fi(n, t);
      return {
        ...
        parseJSONDocument: function (e) {
          return _i(e, { collectComments: !0 });
        },
        newJSONDocument: function (e, t) {
          return (function (e, t) {
            return void 0 === t && (t = []), new yi(e, t, []);
          })(e, t);
        },
        ...
        format: function (e, t, n) {
          ...
          return (function (e, t, n) {
            ...
            return Kn.replace(Nn.create(e.positionAt(t.offset), e.positionAt(t.offset + t.length)), t.content);
          });
        },
      };
    }
    ...
    var uo = (function () {
        function e(e, t) {
          (this._ctx = e),
            ...
            (this._languageService = io({
              workspaceContext: {
                resolveRelativePath: function (e, t) {
                  return (function (e, t) {
                    if (
                      (function (e) {
                        return e.charCodeAt(0) === co;
                      })(t)
                    ) {
                      var n = Ei.a.parse(e),
                        r = t.split("/");
                      return n.with({ path: fo(r) }).toString();
                    }
                    return (function (e) {
                      for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                      for (var r = Ei.a.parse(e), i = r.path.split("/"), o = 0, a = t; o < a.length; o++) {
                        var s = a[o];
                        i.push.apply(i, s.split("/"));
                      }
                      return r.with({ path: fo(i) }).toString();
                    })(e, t);
                  })(t.substr(0, t.lastIndexOf("/") + 1), e);
                },
              },
              schemaRequestService: t.enableSchemaRequest && oo,
            })),
        ...
        return (
          ...
          (e.prototype._getTextDocument = function (e) {
            for (var t = 0, n = this._ctx.getMirrorModels(); t < n.length; t++) {
              var r = n[t];
              if (r.uri.toString() === e) return Br.create(e, this._languageId, r.version, r.getValue());
            }
            return null;
          }),
          e
    ...
    function fo(e) {
      for (var t = [], n = 0, r = e; n < r.length; n++) {
        var i = r[n];
        0 === i.length ||
          (1 === i.length && i.charCodeAt(0) === lo) ||
          (2 === i.length && i.charCodeAt(0) === lo && i.charCodeAt(1) === lo ? t.pop() : t.push(i));
      }
