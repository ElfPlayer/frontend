!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e, r) {
      ...
      var a = !1,
        ...
        u = void 0;
      "undefined" !== typeof r ? (u = r) : "undefined" !== typeof h.vscode && (u = h.vscode.process);
      var d =
          "string" ===
            typeof (null === (i = null === u || void 0 === u ? void 0 : u.versions) || void 0 === i
              ? void 0
              : i.electron) && "renderer" === u.type,
        p = d && (null === u || void 0 === u ? void 0 : u.sandboxed);
      !(function () {
        if (p) return "bypassHeatCheck";
        var e = null === u || void 0 === u ? void 0 : u.env.ENABLE_VSCODE_BROWSER_CODE_LOADING;
      })();
      if ("object" !== typeof navigator || d)
        if ("object" === typeof u) {
          (a = "win32" === u.platform),
            (o = "darwin" === u.platform),
            (s = "linux" === u.platform) && !!u.env.SNAP && !!u.env.SNAP_REVISION,
            "en",
            "en";
          var m = u.env.VSCODE_NLS_CONFIG;
          if (m)
            try {
              var f = JSON.parse(m),
                g = f.availableLanguages["*"];
              f.locale, g || "en", f._translationsConfigFile;
            } catch (T) {}
          !0;
        } else console.error("Unable to resolve platform.");
      else
        (a = (c = navigator.userAgent).indexOf("Windows") >= 0),
      ...
      var v = a,
        ...
        w = h,
        y = (function () {
          if (w.setImmediate) return w.setImmediate.bind(w);
          if ("function" === typeof w.postMessage && !w.importScripts) {
            var e = [];
            ...
            return function (n) {
              var r = ++t;
              e.push({ id: r, callback: n }), w.postMessage({ vscodeSetImmediateId: r }, "*");
            };
          }
          if (u && "function" === typeof u.nextTick) return u.nextTick.bind(u);
      ...
      var r = (function () {
          var t = {
              470: function (t) {
                ...
                var i = {
                  resolve: function () {
                    for (var t, i = "", a = !1, o = arguments.length - 1; o >= -1 && !a; o--) {
                      var s;
                      o >= 0 ? (s = arguments[o]) : (void 0 === t && (t = e.cwd()), (s = t)),
                        n(s),
                        0 !== s.length && ((i = s + "/" + i), (a = 47 === s.charCodeAt(0)));
                    }
                  ...
                  relative: function (e, t) {
                    ...
                    for (var a = e.length, o = a - r, s = 1; s < t.length && 47 === t.charCodeAt(s); ++s);
                    for (var l = t.length - s, c = o < l ? o : l, h = -1, u = 0; u <= c; ++u) {
                      if (u === c) {
                        if (l > c) {
                          if (47 === t.charCodeAt(s + u)) return t.slice(s + u + 1);
                          if (0 === u) return t.slice(s + u);
                        } else o > c && (47 === e.charCodeAt(r + u) ? (h = u) : 0 === u && (h = 0));
                        break;
                      }
                      var d = e.charCodeAt(r + u);
                      if (d !== t.charCodeAt(s + u)) break;
                      47 === d && (h = u);
                    }
                    var p = "";
                    for (u = r + h + 1; u <= a; ++u)
                      (u !== a && 47 !== e.charCodeAt(u)) || (0 === p.length ? (p += "..") : (p += "/.."));
                    return p.length > 0 ? p + t.slice(s + h) : ((s += h), 47 === t.charCodeAt(s) && ++s, t.slice(s));
                  },
                    ...
                    if (void 0 !== t && t.length > 0 && t.length <= e.length) {
                      ...
                      for (r = e.length - 1; r >= 0; --r) {
                        ...
                        if (47 === c) {
                          ...
                          -1 === l && ((o = !1), (l = r + 1)),
                            s >= 0 && (c === t.charCodeAt(s) ? -1 == --s && (a = r) : ((s = -1), (a = l)));
                      }
                  ...
                  extname: function (e) {
                    ...
                    return -1 === t || -1 === i || 0 === o || (1 === o && t === i - 1 && t === r + 1)
                      ? ""
                      : e.slice(t, i);
                  },
                  format: function (e) {
                  ...
                  parse: function (e) {
                    ...
                    var r,
                      ...
                      a = 47 === i;
                    a ? ((t.root = "/"), (r = 1)) : (r = 0);
                    for (var o = -1, s = 0, l = -1, c = !0, h = e.length - 1, u = 0; h >= r; --h)
                      if (47 !== (i = e.charCodeAt(h)))
                        -1 === l && ((c = !1), (l = h + 1)),
                          46 === i ? (-1 === o ? (o = h) : 1 !== u && (u = 1)) : -1 !== o && (u = -1);
                      else if (!c) {
                        s = h + 1;
                        break;
                      }
                    return (
                      -1 === o || -1 === l || 0 === u || (1 === u && o === l - 1 && o === s + 1)
                        ? -1 !== l && (t.base = t.name = 0 === s && a ? e.slice(1, l) : e.slice(s, l))
                        : (0 === s && a
                            ? ((t.name = e.slice(1, o)), (t.base = e.slice(1, l)))
                            : ((t.name = e.slice(s, o)), (t.base = e.slice(s, l))),
                          (t.ext = e.slice(o, l))),
              ...
              447: function (t, n, r) {
                  ...
                  f = (function () {
                    ...
                    return (
                      ...
                      (e.parse = function (e, t) {
                        ...
                        var n = m.exec(e);
                        return n
                          ? new v(n[2] || d, S(n[4] || d), S(n[5] || d), S(n[7] || d), S(n[9] || d), t)
                          : new v(d, d, d, d, d);
                      }),
                      (e.file = function (e) {
                        var t = d;
                  ...
                  v = (function (e) {
                    ...
                    return (
                      ...
                      (t.prototype.toString = function (e) {
                        return (
                          void 0 === e && (e = !1),
                          e ? T(this, !0) : (this._formatted || (this._formatted = T(this, !1)), this._formatted)
                        );
                      }),
                ...
                function _(e, t) {
                  for (var n = void 0, r = -1, i = 0; i < e.length; i++) {
                    ...
                    if (
                      ...
                      var o = b[a];
                      void 0 !== o
                        ? (-1 !== r && ((n += encodeURIComponent(e.substring(r, i))), (r = -1)), (n += o))
                        : -1 === r && (r = i);
                    }
                  }
                ...
                function T(e, t) {
                  ...
                  if ((i && ((r += i), (r += ":")), (a || "file" === i) && ((r += p), (r += p)), a)) {
                    ...
                    if (-1 !== c) {
                      ...
                      (a = a.substr(c + 1)),
                        -1 === (c = h.indexOf(":"))
                          ? (r += n(h, !1))
                          : ((r += n(h.substr(0, c), !1)), (r += ":"), (r += n(h.substr(c + 1), !1))),
                        (r += "@");
                    }
                  ...
                  return s && ((r += "?"), (r += n(s, !1))), l && ((r += "#"), (r += t ? l : _(l, !1))), r;
                }
                ...
                !(function (e) {
                  (e.joinPath = function (e) {
                    ...
                    (e.resolvePath = function (e) {
                      for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                      var r = e.path || "/";
                      return e.with({ path: E.resolve.apply(E, C([r], t)) });
                    }),
  ...
  function (e, t, n) {
    var r = (function (e) {
      ...
      return (
        ...
        (e.mark = function (e) {
          return (
            Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : ((e.__proto__ = p), s(e, o, "GeneratorFunction")),
        ...
        (k.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            return (
              (o.type = e), (o.arg = t), a ? ((this.method = "next"), (this.next = a.finallyLoc), h) : this.complete(o)
            );
          },
  ...
  function (e, t, n) {
          ...
          function (i) {
            for (;;)
              switch ((i.prev = i.next)) {
                case 0:
                  for (e = h.length, t = new Array(e), n = 0; n < e; n++) t[n] = h[n];
                  (r = 0), (a = t);
                case 2:
                  if (!(r < a.length)) {
                    i.next = 24;
            ...
            for (;;)
              switch ((a.prev = a.next)) {
                ...
                case 3:
                  ...
                  (r = n.value), (i = _(r)), (a.prev = 6), i.s();
                case 8:
                  if ((o = i.n()).done) {
                    a.next = 14;
                    break;
                  }
                  return (s = o.value), (a.next = 12), s;
                case 12:
                  a.next = 8;
                  break;
                case 14:
                  ...
                  break;
                case 16:
                  (a.prev = 16), (a.t0 = a.catch(6)), i.e(a.t0);
                case 19:
                  return (a.prev = 19), i.f(), a.finish(19);
                case 22:
                  a.next = 3;
                  break;
                case 24:
                  ...
                  break;
                case 26:
                  (a.prev = 26), (a.t1 = a.catch(1)), t.e(a.t1);
                case 29:
                  return (a.prev = 29), t.f(), a.finish(29);
                case 32:
                case "end":
                  return a.stop();
              }
    ...
    var U = (function () {
      function e() {
        h(this, e), (this._store = new N()), E(this);
      }
      return (
        d(e, [
          {
    ...
    U.None = Object.freeze({ dispose: function () {} });
    var H = n(1);
    function z(e) {
      var t,
        n = [],
              ...
              value: function (e) {
                ...
                if (e.seq) {
                  ...
                  this._handler.handleMessage(a.method, a.args).then(
                    function (e) {
                      t._send({ vsWorker: t._workerId, seq: o, res: e, err: void 0 });
                    },
                    function (e) {
                      e.detail instanceof Error && (e.detail = f(e.detail)),
                        t._send({ vsWorker: t._workerId, seq: o, res: void 0, err: f(e) });
                    },
                  );
                }
              },
          ...
          d(e, [
            ...
            },
            {
              ...
              value: function (e, t, n, r) {
                ...
                var a = W(r, function (e, t) {
                  return i._protocol.sendMessage(e, t);
                });
                return this._requestHandlerFactory
                  ? ((this._requestHandler = this._requestHandlerFactory(a)), Promise.resolve(z(this._requestHandler)))
                  : (t &&
                      ...
                      self.require(
                        ...
                        function (n) {
                          (i._requestHandler = n.create(a)),
                            i._requestHandler ? e(z(i._requestHandler)) : t(new Error("No RequestHandler!"));
                        },
                        t,
                      );
                    }));
    ...
    function q(e, t) {
      return (
        (function e(t, n, r, i, a) {
          if (i <= r) return;
          var o = (r + (i - r) / 2) | 0;
          if ((e(t, n, r, o, a), e(t, n, o + 1, i, a), n(t[o], t[o + 1]) <= 0)) return;
          !(function (e, t, n, r, i, a) {
            for (var o = n, s = r + 1, l = n; l <= i; l++) a[l] = e[l];
            for (var c = n; c <= i; c++)
              o > r ? (e[c] = a[s++]) : s > i ? (e[c] = a[o++]) : t(a[s], a[o]) < 0 ? (e[c] = a[s++]) : (e[c] = a[o++]);
          })(t, n, r, o, i, a);
        })(e, t, 0, e.length - 1, []),
        e
      );
          ...
          d(e, [
            {
              ...
              value: function (e) {
                ...
                if (0 !== t) {
                  ...
                  for (0 !== o ? ((n = o), (r = -1), (o = 0)) : ((n = e.charCodeAt(0)), (r = 0)); ; ) {
                    var s = n;
                    if (B(n)) {
                      if (!(r + 1 < t)) {
                        o = n;
            ...
            },
            {
              ...
              value: function () {
                ...
                for (
                  var a, o, s, l = this._h0, c = this._h1, h = this._h2, u = this._h3, d = this._h4, p = 0;
                  p < 80;
                  p++
                )
                  p < 20
                    ...
                    (s = (J(l, 5) + a + d + o + t.getUint32(4 * p, !1)) & 4294967295),
                    (d = u),
                    (u = h),
                    (h = J(c, 30)),
                    (c = l),
    ...
    function te(e, t, n) {
      return new ae(new ee(e), new ee(t)).ComputeDiff(n).changes;
    }
    var ne = (function () {
        function e() {
          h(this, e);
          ...
          d(e, [
            {
              ...
              value: function () {
                (this.m_originalCount > 0 || this.m_modifiedCount > 0) &&
                  this.m_changes.push(
                    new j(this.m_originalStart, this.m_originalCount, this.m_modifiedStart, this.m_modifiedCount),
                  ),
                  (this.m_originalCount = 0),
                  (this.m_modifiedCount = 0),
                  (this.m_originalStart = 1073741824),
            ...
            [
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  return i && (o = this.PrettifyChanges(o)), { quitEarly: a[0], changes: o };
                },
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  if (!i[0]) {
                    ...
                    return (
                      (d = i[0]
                        ? [new j(c + 1, t - (c + 1) + 1, h + 1, r - (h + 1) + 1)]
                        : this.ComputeDiffRecursive(c + 1, t, h + 1, r, i)),
                      this.ConcatenateChanges(u, d)
                    );
                  }
                  return [new j(e, t - e + 1, n, r - n + 1)];
                },
              },
              {
                key: "WALKTRACE",
                value: function (e, t, n, r, i, a, o, s, l, c, h, u, d, p, m, f, g, v) {
                  var b,
                    _ = null,
                    w = new ie(),
                    y = t,
                  ...
                  do {
                    ...
                    L === y || (L < T && l[L - 1] < l[L + 1])
                      ...
                      : ((p = (h = l[L - 1] + 1) - k - r),
                        ...
                        (k = L - 1 - e)),
                      x >= 0 && ((e = (l = this.m_forwardHistory[x])[0]), (y = 1), (T = l.length - 1));
                  } while (--x >= -1);
                  if (((b = w.getReverseChanges()), v[0])) {
                    var C = d[0] + 1,
                      E = f[0] + 1;
                    if (null !== b && b.length > 0) {
                      var A = b[b.length - 1];
                      (C = Math.max(C, A.getOriginalEnd())), (E = Math.max(E, A.getModifiedEnd()));
                    }
                    _ = [new j(C, u - C + 1, E, m - E + 1)];
                  } else {
                    (w = new ie()),
                      (y = a),
                      (T = o),
                    ...
                    do {
                      ...
                      M === y || (M < T && c[M - 1] >= c[M + 1])
                        ...
                        : ((p = (h = c[M - 1]) - k - s),
                          ...
                          (k = M - 1 - i)),
                        x >= 0 && ((i = (c = this.m_reverseHistory[x])[0]), (y = 1), (T = c.length - 1));
                    } while (--x >= -1);
                    _ = w.getChanges();
                  }
              ...
              },
              {
                ...
                value: function (e, t, n, r, i, a, o) {
                  ...
                  for (var T = 1; T <= p / 2 + 1; T++) {
                    var k = 0,
                      S = 0;
                    (c = this.ClipDiagonalBound(v - T, T, v, m)), (h = this.ClipDiagonalBound(v + T, T, v, m));
                    for (var x = c; x <= h; x += 2) {
                      l = (s = x === c || (x < h && f[x - 1] < f[x + 1]) ? f[x + 1] : f[x - 1] + 1) - (x - v) - _;
                      for (var L = s; s < t && l < r && this.ElementsAreEqual(s + 1, l + 1); ) s++, l++;
                      if (
                        ((f[x] = s), s + l > k + S && ((k = s), (S = l)), !y && Math.abs(x - b) <= T - 1 && s >= g[x])
                      )
                        return (
                          (i[0] = s),
                          (a[0] = l),
                          L <= g[x] && T <= 1448
                            ? this.WALKTRACE(v, c, h, _, b, u, d, w, f, g, s, t, i, l, r, a, y, o)
                            : null
                        );
                    }
                    var C = (k - e + (S - n) - T) / 2;
                    if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(k, C))
                      return (
                        (o[0] = !0),
                        (i[0] = k),
                        (a[0] = S),
                        C > 0 && T <= 1448
                          ? this.WALKTRACE(v, c, h, _, b, u, d, w, f, g, s, t, i, l, r, a, y, o)
                          : (e++, n++, [new j(e, t - e + 1, n, r - n + 1)])
                      );
                    (u = this.ClipDiagonalBound(b - T, T, b, m)), (d = this.ClipDiagonalBound(b + T, T, b, m));
                    for (var E = u; E <= d; E += 2) {
                      l = (s = E === u || (E < d && g[E - 1] >= g[E + 1]) ? g[E + 1] - 1 : g[E - 1]) - (E - b) - w;
                      for (var A = s; s > e && l > n && this.ElementsAreEqual(s, l); ) s--, l--;
                      if (((g[E] = s), y && Math.abs(E - v) <= T && s <= f[E]))
                        return (
                          (i[0] = s),
                          (a[0] = l),
                          A >= f[E] && T <= 1448
                    ...
                    if (T <= 1447) {
                      ...
                      (M[0] = v - c + 1),
                        re.Copy2(f, c, M, 1, h - c + 1),
                        this.m_forwardHistory.push(M),
                        ((M = new Int32Array(d - u + 2))[0] = b - u + 1),
                        re.Copy2(g, u, M, 1, d - u + 1),
                        this.m_reverseHistory.push(M);
                    }
                  }
                  return this.WALKTRACE(v, c, h, _, b, u, d, w, f, g, s, t, i, l, r, a, y, o);
                },
              },
              {
                key: "PrettifyChanges",
                value: function (e) {
                  ...
                  for (var l = e.length - 1; l >= 0; l--) {
                    ...
                    if (l > 0) {
                      var d = e[l - 1];
                      d.originalLength > 0 && (h = d.originalStart + d.originalLength),
                        d.modifiedLength > 0 && (u = d.modifiedStart + d.modifiedLength);
                    }
                    for (
                      var p = c.originalLength > 0,
                        m = c.modifiedLength > 0,
                        f = 0,
                        g = this._boundaryScore(c.originalStart, c.originalLength, c.modifiedStart, c.modifiedLength),
                        v = 1;
                      ;
                      v++
                    ) {
                      var b = c.originalStart - v,
                        _ = c.modifiedStart - v;
                      if (b < h || _ < u) break;
                      if (p && !this.OriginalElementsAreEqual(b, b + c.originalLength)) break;
                      if (m && !this.ModifiedElementsAreEqual(_, _ + c.modifiedLength)) break;
                      var w = this._boundaryScore(b, c.originalLength, _, c.modifiedLength);
                      w > g && ((g = w), (f = v));
                    }
                    (c.originalStart -= f), (c.modifiedStart -= f);
                  }
                  if (this._hasStrings)
                    for (var y = 1, T = e.length; y < T; y++) {
                      var k = e[y - 1],
                        S = e[y],
                        x = S.originalStart - k.originalStart - k.originalLength,
                        L = k.originalStart,
                        C = S.originalStart + S.originalLength,
                        E = C - L,
                        A = k.modifiedStart,
                        M = S.modifiedStart + S.modifiedLength,
                        R = M - A;
                      if (x < 5 && E < 20 && R < 20) {
                        var I = this._findBetterContiguousSequence(L, E, A, R, x);
                        if (I) {
                          var N = F(I, 2),
                            U = N[0],
                            H = N[1];
                          (U === k.originalStart + k.originalLength && H === k.modifiedStart + k.modifiedLength) ||
                            ((k.originalLength = U - k.originalStart),
                            (k.modifiedLength = H - k.modifiedStart),
                            (S.originalStart = U + x),
                            (S.modifiedStart = H + x),
                            (S.originalLength = C - S.originalStart),
              ...
              },
              {
                ...
                value: function (e, t, n, r, i) {
                  ...
                  for (var a = e + t - i + 1, o = n + r - i + 1, s = 0, l = 0, c = 0, h = e; h < a; h++)
                    for (var u = n; u < o; u++) {
                      var d = this._contiguousSequenceScore(h, u, i);
                      d > 0 && d > s && ((s = d), (l = h), (c = u));
                    }
                  return s > 0 ? [l, c] : null;
                },
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (e._isStringArray(n)) {
                    for (var r = new Int32Array(n.length), i = 0, a = n.length; i < a; i++) r[i] = X(n[i], 0);
                    return [n, r, !0];
                  }
      ...
      se = (function (e) {
        ...
        function n(e, r, i) {
          ...
          var s = -1 !== e.indexOf(".") ? "property" : "argument",
            l = 'The "'.concat(e, '" ').concat(s, " ").concat(o, " of type ").concat(r);
          return (l += ". Received type ".concat(typeof i)), ((a = t.call(this, l)).code = "ERR_INVALID_ARG_TYPE"), a;
        }
        return d(n);
      })(y(Error));
    function le(e, t) {
          ...
          if (o === c - 1 || 1 === s);
            ...
            if (i.length < 2 || 2 !== a || 46 !== i.charCodeAt(i.length - 1) || 46 !== i.charCodeAt(i.length - 2)) {
              if (i.length > 2) {
                ...
                -1 === h ? ((i = ""), (a = 0)) : (a = (i = i.slice(0, h)).length - 1 - i.lastIndexOf(n)),
                  (o = c),
                  (s = 0);
                continue;
              }
            ...
            i.length > 0 ? (i += "".concat(n).concat(e.slice(o + 1, c))) : (i = e.slice(o + 1, c)), (a = c - o - 1);
          (o = c), (s = 0);
        } else 46 === l && -1 !== s ? ++s : (s = -1);
      }
      return i;
    ...
    var me = {
        resolve: function () {
          for (var e = "", t = "", n = !1, r = arguments.length - 1; r >= -1; r--) {
            var i = void 0;
            if (r >= 0) {
              if ((le((i = r < 0 || arguments.length <= r ? void 0 : arguments[r]), "path"), 0 === i.length)) continue;
            } else
              0 === e.length
                ? (i = oe.a())
                : (void 0 === (i = oe.b["=".concat(e)] || oe.a()) ||
            ...
            if (1 === a) ce(c) && ((o = 1), (l = !0));
              ...
              if (((l = !0), ce(i.charCodeAt(1)))) {
                for (var h = 2, u = h; h < a && !ce(i.charCodeAt(h)); ) h++;
                if (h < a && h !== u) {
                  var d = i.slice(u, h);
                  for (u = h; h < a && ce(i.charCodeAt(h)); ) h++;
                  if (h < a && h !== u) {
                    for (u = h; h < a && !ce(i.charCodeAt(h)); ) h++;
                    (h !== a && h === u) || ((s = "\\\\".concat(d, "\\").concat(i.slice(u, h))), (o = h));
                  }
                }
              } else o = 1;
            else
              ue(c) &&
                58 === i.charCodeAt(1) &&
                ((s = i.slice(0, 2)), (o = 2), a > 2 && ce(i.charCodeAt(2)) && ((l = !0), (o = 3)));
            if (s.length > 0)
              if (e.length > 0) {
            ...
            if (n) {
              if (e.length > 0) break;
            } else if (((t = "".concat(i.slice(o), "\\").concat(t)), (n = l), l && e.length > 0)) break;
          }
          return (t = de(t, !n, "\\", ce)), n ? "".concat(e, "\\").concat(t) : "".concat(e).concat(t) || ".";
        },
        normalize: function (e) {
          le(e, "path");
          var t = e.length;
          ...
          if (ce(a))
            if (((i = !0), ce(e.charCodeAt(1)))) {
              for (var o = 2, s = o; o < t && !ce(e.charCodeAt(o)); ) o++;
              if (o < t && o !== s) {
                var l = e.slice(s, o);
                for (s = o; o < t && ce(e.charCodeAt(o)); ) o++;
                if (o < t && o !== s) {
                  for (s = o; o < t && !ce(e.charCodeAt(o)); ) o++;
                  if (o === t) return "\\\\".concat(l, "\\").concat(e.slice(s), "\\");
                  o !== s && ((n = "\\\\".concat(l, "\\").concat(e.slice(s, o))), (r = o));
                }
              }
            } else r = 1;
          else
        ...
        isAbsolute: function (e) {
          ...
          return ce(n) || (t > 2 && ue(n) && 58 === e.charCodeAt(1) && ce(e.charCodeAt(2)));
        },
        join: function () {
          if (0 === arguments.length) return ".";
          for (var e, t, n = 0; n < arguments.length; ++n) {
            var r = n < 0 || arguments.length <= n ? void 0 : arguments[n];
            le(r, "path"), r.length > 0 && (void 0 === e ? (e = t = r) : (e += "\\".concat(r)));
          }
          if (void 0 === e) return ".";
          var i = !0,
            a = 0;
          if ("string" === typeof t && ce(t.charCodeAt(0))) {
            ++a;
            var o = t.length;
            o > 1 && ce(t.charCodeAt(1)) && (++a, o > 2 && (ce(t.charCodeAt(2)) ? ++a : (i = !1)));
          }
          if (i) {
            for (; a < e.length && ce(e.charCodeAt(a)); ) a++;
        ...
        relative: function (e, t) {
          ...
          for (var o = a - i, s = 0; s < t.length && 92 === t.charCodeAt(s); ) s++;
          ...
          if (d !== h) {
            ...
            o > h && (92 === e.charCodeAt(i + d) ? (u = d) : 2 === d && (u = 3)), -1 === u && (u = 0);
          }
          var m = "";
          for (d = i + u + 1; d <= a; ++d) (d !== a && 92 !== e.charCodeAt(d)) || (m += 0 === m.length ? ".." : "\\..");
          return (
            (s += u), m.length > 0 ? "".concat(m).concat(r.slice(s, l)) : (92 === r.charCodeAt(s) && ++s, r.slice(s, l))
          );
        },
        toNamespacedPath: function (e) {
          ...
          } else if (ue(t.charCodeAt(0)) && 58 === t.charCodeAt(1) && 92 === t.charCodeAt(2))
            return "\\\\?\\".concat(t);
          return e;
        },
        dirname: function (e) {
          ...
          if (ce(i)) {
            if (((n = r = 1), ce(e.charCodeAt(1)))) {
              for (var a = 2, o = a; a < t && !ce(e.charCodeAt(a)); ) a++;
              if (a < t && a !== o) {
                for (o = a; a < t && ce(e.charCodeAt(a)); ) a++;
                if (a < t && a !== o) {
                  for (o = a; a < t && !ce(e.charCodeAt(a)); ) a++;
                  if (a === t) return e;
                  a !== o && (n = r = a + 1);
          ...
          } else ue(i) && 58 === e.charCodeAt(1) && (r = n = t > 2 && ce(e.charCodeAt(2)) ? 3 : 2);
        ...
        basename: function (e, t) {
          ...
          var n,
            ...
            a = !0;
          if (
            (e.length >= 2 && ue(e.charCodeAt(0)) && 58 === e.charCodeAt(1) && (r = 2),
            ...
            for (n = e.length - 1; n >= r; --n) {
              ...
              if (ce(l)) {
                ...
                -1 === s && ((a = !1), (s = n + 1)),
                  o >= 0 && (l === t.charCodeAt(o) ? -1 === --o && (i = n) : ((o = -1), (i = s)));
            }
        ...
        extname: function (e) {
          ...
          var t = 0,
            ...
            a = !0,
            o = 0;
          e.length >= 2 && 58 === e.charCodeAt(1) && ue(e.charCodeAt(0)) && (t = r = 2);
        ...
        parse: function (e) {
          ...
          if (ce(i)) {
            if (((r = 1), ce(e.charCodeAt(1)))) {
              for (var a = 2, o = a; a < n && !ce(e.charCodeAt(a)); ) a++;
              if (a < n && a !== o) {
                for (o = a; a < n && ce(e.charCodeAt(a)); ) a++;
                if (a < n && a !== o) {
                  for (o = a; a < n && !ce(e.charCodeAt(a)); ) a++;
                  a === n ? (r = a) : a !== o && (r = a + 1);
                }
          ...
          for (var s = -1, l = r, c = -1, h = !0, u = e.length - 1, d = 0; u >= r; --u)
            if (ce((i = e.charCodeAt(u)))) {
              if (!h) {
                l = u + 1;
                break;
              }
              ...
              -1 === c && ((h = !1), (c = u + 1)),
                46 === i ? (-1 === s ? (s = u) : 1 !== d && (d = 1)) : -1 !== s && (d = -1);
          return (
            -1 !== c &&
              (-1 === s || 0 === d || (1 === d && s === c - 1 && s === l + 1)
                ? (t.base = t.name = e.slice(l, c))
                : ((t.name = e.slice(l, s)), (t.base = e.slice(l, c)), (t.ext = e.slice(s, c)))),
      ...
      fe = {
        resolve: function () {
          for (var e = "", t = !1, n = arguments.length - 1; n >= -1 && !t; n--) {
            var r = n >= 0 ? (n < 0 || arguments.length <= n ? void 0 : arguments[n]) : oe.a();
            le(r, "path"), 0 !== r.length && ((e = "".concat(r, "/").concat(e)), (t = 47 === r.charCodeAt(0)));
          }
          return (e = de(e, !t, "/", he)), t ? "/".concat(e) : e.length > 0 ? e : ".";
        },
        normalize: function (e) {
          if ((le(e, "path"), 0 === e.length)) return ".";
          var t = 47 === e.charCodeAt(0),
            n = 47 === e.charCodeAt(e.length - 1);
          return 0 === (e = de(e, !t, "/", he)).length
            ? t
              ? "/"
              : n
                ? "./"
        ...
        isAbsolute: function (e) {
          return le(e, "path"), e.length > 0 && 47 === e.charCodeAt(0);
        },
        join: function () {
          if (0 === arguments.length) return ".";
          for (var e, t = 0; t < arguments.length; ++t) {
            var n = t < 0 || arguments.length <= t ? void 0 : arguments[t];
            le(n, "path"), n.length > 0 && (void 0 === e ? (e = n) : (e += "/".concat(n)));
          }
        ...
        relative: function (e, t) {
          ...
          for (var n = e.length, r = n - 1, i = t.length - 1, a = r < i ? r : i, o = -1, s = 0; s < a; s++) {
          ...
          if (s === a)
            ...
            } else r > a && (47 === e.charCodeAt(1 + s) ? (o = s) : 0 === s && (o = 0));
          var c = "";
          for (s = 1 + o + 1; s <= n; ++s) (s !== n && 47 !== e.charCodeAt(s)) || (c += 0 === c.length ? ".." : "/..");
        ...
        parse: function (e) {
          ...
          var n,
            r = 47 === e.charCodeAt(0);
          r ? ((t.root = "/"), (n = 1)) : (n = 0);
          for (var i = -1, a = 0, o = -1, s = !0, l = e.length - 1, c = 0; l >= n; --l) {
            var h = e.charCodeAt(l);
            if (47 !== h)
              -1 === o && ((s = !1), (o = l + 1)),
                46 === h ? (-1 === i ? (i = l) : 1 !== c && (c = 1)) : -1 !== i && (c = -1);
            else if (!s) {
              a = l + 1;
              break;
            }
          ...
          if (-1 !== o) {
            ...
            -1 === i || 0 === c || (1 === c && i === o - 1 && i === a + 1)
              ...
              : ((t.name = e.slice(u, i)), (t.base = e.slice(u, o)), (t.ext = e.slice(i, o)));
          }
    ...
    (fe.win32 = me.win32 = me), (fe.posix = me.posix = fe);
    "win32" === oe.c ? me.normalize : fe.normalize,
      "win32" === oe.c ? me.resolve : fe.resolve,
      "win32" === oe.c ? me.relative : fe.relative,
      "win32" === oe.c ? me.dirname : fe.dirname,
      "win32" === oe.c ? me.basename : fe.basename,
      "win32" === oe.c ? me.extname : fe.extname,
      "win32" === oe.c ? me.sep : fe.sep;
    var ge,
      ve = /^\w[\w\d+.-]*$/,
      be = /^\//,
      _e = /^\/\//;
    ...
    var ke = "/",
              ...
              },
              {
                ...
                value: function (e) {
                  var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    n = Se.exec(e);
                  return n
                    ? new Ce(n[2] || "", Ue(n[4] || ""), Ue(n[5] || ""), Ue(n[7] || ""), Ue(n[9] || ""), t)
                    : new Ce("", "", "", "", "");
                },
              },
              {
                ...
                value: function (e) {
                  var t = "";
                  if ((H.d && (e = e.replace(/\\/g, ke)), e[0] === ke && e[1] === ke)) {
                    var n = e.indexOf(ke, 2);
                    -1 === n ? ((t = e.substring(2)), (e = ke)) : ((t = e.substring(2, n)), (e = e.substring(n) || ke));
                  }
                  return new Ce("file", t, e, "", "");
                },
              },
              {
                key: "from",
                value: function (e) {
                  return new Ce(e.scheme, e.authority, e.path, e.query, e.fragment);
                },
              },
              {
                key: "joinPath",
                value: function (t) {
                  ...
                  for (var n, r, i, a = arguments.length, o = new Array(a > 1 ? a - 1 : 0), s = 1; s < a; s++)
                    o[s - 1] = arguments[s];
                  H.d && "file" === t.scheme
                    ? (n = e.file((r = me).join.apply(r, [Re(t, !0)].concat(o))).path)
                    : (n = (i = fe).join.apply(i, [t.path].concat(o)));
              ...
              },
              {
                ...
                value: function (t) {
                  if (t) {
                    if (t instanceof e) return t;
                    var n = new Ce(t);
                    return (n._formatted = t.external), (n._fsPath = t._sep === Le ? t.fsPath : null), n;
                  }
                  return t;
                },
              },
      ...
      Ce = (function (e) {
        ...
        function n() {
          var e;
          return h(this, n), ((e = t.apply(this, arguments))._formatted = null), (e._fsPath = null), e;
        }
        return (
          d(n, [
            {
              key: "fsPath",
              get: function () {
                return this._fsPath || (this._fsPath = Re(this, !1)), this._fsPath;
              },
            },
            {
              key: "toString",
    ...
    function Me(e) {
      for (var t = void 0, n = 0; n < e.length; n++) {
        var r = e.charCodeAt(n);
        35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), (t += Ee[r])) : void 0 !== t && (t += e[n]);
      }
      return void 0 !== t ? t : e;
    }
    function Re(e, t) {
    ...
    function Ie(e, t) {
      var n = t ? Me : Ae,
        ...
        s = e.query,
        l = e.fragment;
      if ((i && ((r += i), (r += ":")), (a || "file" === i) && ((r += ke), (r += ke)), a)) {
        var c = a.indexOf("@");
        if (-1 !== c) {
          var h = a.substr(0, c);
          (a = a.substr(c + 1)),
      ...
      if (o) {
        if (o.length >= 3 && 47 === o.charCodeAt(0) && 58 === o.charCodeAt(2)) {
          ...
          u >= 65 && u <= 90 && (o = "/".concat(String.fromCharCode(u + 32), ":").concat(o.substr(3)));
        } else if (o.length >= 2 && 58 === o.charCodeAt(1)) {
          var d = o.charCodeAt(0);
          d >= 65 && d <= 90 && (o = "".concat(String.fromCharCode(d + 32), ":").concat(o.substr(2)));
        }
        r += n(o, !0);
      }
      return s && ((r += "?"), (r += n(s, !1))), l && ((r += "#"), (r += t ? l : Ae(l, !1))), r;
    }
    var Ne = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function Ue(e) {
      return e.match(Ne)
        ? e.replace(Ne, function (e) {
            return (function e(t) {
              try {
                return decodeURIComponent(t);
              } catch (n) {
              ...
              },
              {
                ...
                value: function (t, n) {
                  var r = t.startLineNumber,
                    ...
                    h = n.endColumn;
                  return (
                    r < s ? ((r = s), (i = l)) : r === s && (i = Math.max(i, l)),
                    a > c ? ((a = c), (o = h)) : a === c && (o = Math.min(o, h)),
                    ...
                    if (n === r) {
                      ...
                      if (i === a) {
                        var o = 0 | e.endLineNumber,
                          s = 0 | t.endLineNumber;
                        return o === s ? (0 | e.endColumn) - (0 | t.endColumn) : o - s;
                      }
                      return i - a;
                    }
                    return n - r;
    ...
    var Oe = (function () {
        function e(t) {
          h(this, e);
          for (var n = [], r = [], i = 0, a = t.length; i < a; i++) (n[i] = je(t[i], 1)), (r[i] = Be(t[i], 1));
              ...
              value: function (e, t, n) {
                for (var r = [], i = [], a = [], o = 0, s = t; s <= n; s++)
                  for (
                    ...
                    (r[o] = l.charCodeAt(u - 1)), (i[o] = s + 1), (a[o] = u), o++;
                return new De(r, i, a);
              },
            },
          ]),
      ...
      De = (function () {
        function e(t, n, r) {
          h(this, e), (this._charCodes = t), (this._lineNumbers = n), (this._columns = r);
        }
        return (
          d(e, [
            {
                ...
                return (
                  ...
                  0 === t.modifiedLength
                    ...
                    : ((l = r.getStartLineNumber(t.modifiedStart)),
                      ...
                      (u = r.getEndColumn(t.modifiedStart + t.modifiedLength - 1))),
                ...
                if (
                  ...
                  0 === n.modifiedLength
                    ...
                    : ((h = i.getStartLineNumber(n.modifiedStart)),
                      (u = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1))),
                  o &&
                    n.originalLength > 0 &&
                    n.originalLength < 20 &&
                    n.modifiedLength > 0 &&
                  ...
                  var p = r.createCharSequence(t, n.originalStart, n.originalStart + n.originalLength - 1),
                    m = i.createCharSequence(t, n.modifiedStart, n.modifiedStart + n.modifiedLength - 1),
                    f = We(p, m, a, !0).changes;
                  s &&
                    (f = (function (e) {
                      ...
                      for (var t = [e[0]], n = t[0], r = 1, i = e.length; r < i; r++) {
                        ...
                        Math.min(o, s) < 3
                          ? ((n.originalLength = a.originalStart + a.originalLength - n.originalStart),
                            (n.modifiedLength = a.modifiedStart + a.modifiedLength - n.modifiedStart))
                          : (t.push(a), (n = a));
                      }
                      return t;
                    })(f)),
                    (d = []);
                  for (var g = 0, v = f.length; g < v; g++) d.push(Pe.createFromDiffChange(f[g], p, m));
                }
      ...
      Fe = (function () {
        function e(t, n, r) {
          h(this, e),
            ...
            (this.original = new Oe(t)),
            (this.modified = new Oe(n)),
            (this.continueLineDiff = Ge(r.maxComputationTime)),
            (this.continueCharDiff = Ge(0 === r.maxComputationTime ? 0 : Math.min(r.maxComputationTime, 5e3)));
        }
        return (
          d(e, [
            {
              ...
              value: function () {
                ...
                var e = We(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
                  t = e.changes,
                  n = e.quitEarly;
                ...
                for (var o = [], s = 0, l = 0, c = -1, h = t.length; c < h; c++) {
                  for (
                    ...
                    if (m !== f) {
                      for (var g = je(m, 1), v = je(f, 1); g > 1 && v > 1; ) {
                        if (m.charCodeAt(g - 2) !== f.charCodeAt(v - 2)) break;
                        g--, v--;
                      }
                      (g > 1 || v > 1) && this._pushTrimWhitespaceCharChange(o, s + 1, 1, g, l + 1, 1, v);
                      for (var b = Be(m, 1), _ = Be(f, 1), w = m.length + 1, y = f.length + 1; b < w && _ < y; ) {
                        if (m.charCodeAt(b - 1) !== m.charCodeAt(_ - 1)) break;
                        b++, _++;
                      }
                      (b < w || _ < y) && this._pushTrimWhitespaceCharChange(o, s + 1, b, w, l + 1, _, y);
                    }
                    s++, l++;
                  }
                  u &&
            ...
            },
            {
              ...
              value: function (e, t, n, r, i, a, o) {
                if (!this._mergeTrimWhitespaceCharChange(e, t, n, r, i, a, o)) {
                  var s = void 0;
                  this.shouldComputeCharChanges && (s = [new Pe(t, n, t, r, i, a, i, o)]),
            ...
            },
            {
              ...
              value: function (e, t, n, r, i, a, o) {
                ...
                return (
                  ...
                  this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new Pe(t, n, t, r, i, a, i, o)),
                  !0)
                );
              },
            },
        ...
        return (
          d(e, [
            ...
            },
            {
              ...
              value: function (e) {
                return e < 0 ? 0 : ((e = Ke(e)), this._getAccumulatedValue(e));
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                for (var t = 0, n = this.values.length - 1, r = 0, i = 0, a = 0; t <= n; )
                  if (((r = (t + (n - t) / 2) | 0), e < (a = (i = this.prefixSum[r]) - this.values[r]))) n = r - 1;
                  else {
                    if (!(e >= i)) break;
                    t = r + 1;
                  }
    ...
    var $e = { maxLen: 1e3, windowSize: 15, timeBudget: 150 };
    function Ze(e, t, n, r) {
    ...
    var et = (function () {
      ...
      tt = (function () {
        function e(t, n, r) {
          h(this, e);
          for (var i = new Uint8Array(t * n), a = 0, o = t * n; a < o; a++) i[a] = r;
      ...
      nt = (function () {
        function e(t) {
          ...
          n++, r++;
          for (var u = new tt(r, n, 0), d = 0, p = t.length; d < p; d++) {
            var m = F(t[d], 3),
              f = m[0],
              g = m[1],
              v = m[2];
    ...
    function ot() {
      if (null === at) {
        ...
        for (var t = 0; t < ".,;".length; t++) at.set(".,;".charCodeAt(t), 2);
      }
      return at;
    }
    var st = (function () {
            ...
            value: function (e, t, n, r, i) {
              ...
              if (r > 0) {
                var s = t.charCodeAt(r - 1),
                  l = t.charCodeAt(a);
                ((40 === s && 41 === l) || (91 === s && 93 === l) || (123 === s && 125 === l)) && a--;
              }
              return {
                range: { startLineNumber: n, startColumn: r + 1, endLineNumber: n, endColumn: a + 2 },
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                for (
                  var s = t.getLineContent(a), l = s.length, c = 0, h = 0, u = 0, d = 1, p = !1, m = !1, f = !1, g = !1;
                  c < l;
                  ...
                  if (13 === d) {
                    ...
                    1 === _ && (i.push(e._createLink(r, s, a, h, c)), (v = !0));
                  } else if (12 === d) {
                    var w = void 0;
                    91 === b ? ((m = !0), (w = 0)) : (w = r.get(b)), 1 === w ? (v = !0) : (d = 13);
                  } else 0 === (d = n.nextState(d, b)) && (v = !0);
                  v && ((d = 1), (p = !1), (m = !1), (g = !1), (h = c + 1), (u = b)), c++;
                }
      ...
      return (
        d(e, [
          ...
          },
          {
            ...
            value: function (e, t, n) {
              for (var r = null, i = 0, a = e.length; null === r && i < a; i++) r = this.valueSetReplace(e[i], t, n);
              return r;
            },
          },
          {
    ...
    ct.INSTANCE = new ct();
    var ht = d(function e(t) {
      h(this, e), (this.element = t), (this.next = e.Undefined), (this.prev = e.Undefined);
    });
    ht.Undefined = new ht(void 0);
    var ut,
      dt = (function (e) {
        function t() {
          h(this, t), (this._first = ht.Undefined), (this._last = ht.Undefined), (this._size = 0);
        }
        return (
          d(t, [
            {
            ...
            },
            {
              key: "isEmpty",
              value: function () {
                return this._first === ht.Undefined;
              },
            },
            {
              key: "clear",
              value: function () {
                (this._first = ht.Undefined), (this._last = ht.Undefined), (this._size = 0);
              },
            },
            {
              key: "unshift",
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this,
                  r = new ht(e);
                if (this._first === ht.Undefined) (this._first = r), (this._last = r);
                else if (t) {
                  var i = this._last;
            ...
            },
            {
              key: "_remove",
              value: function (e) {
                if (e.prev !== ht.Undefined && e.next !== ht.Undefined) {
                  var t = e.prev;
                  (t.next = e.next), (e.next.prev = t);
                } else
                  e.prev === ht.Undefined && e.next === ht.Undefined
                    ? ((this._first = ht.Undefined), (this._last = ht.Undefined))
                    : e.next === ht.Undefined
                      ? ((this._last = this._last.prev), (this._last.next = ht.Undefined))
                      : e.prev === ht.Undefined &&
                        ((this._first = this._first.next), (this._first.prev = ht.Undefined));
                this._size -= 1;
              },
            },
            {
      ...
      pt = H.a.performance && "function" === typeof H.a.performance.now,
      mt = (function () {
        function e(t) {
          h(this, e), (this._highResolution = pt && t), (this._startTime = this._now()), (this._stopTime = -1);
        }
        return (
          d(
            e,
            [
              ...
              },
              {
                key: "_now",
                value: function () {
                  return this._highResolution ? H.a.performance.now() : Date.now();
                },
              },
            ],
            [
              ...
              n = e(function (e) {
                l++,
                  ...
                  (s = setTimeout(function () {
                    var e = o;
                    (o = void 0), (s = void 0), (!i || l > 1) && c.fire(e), (l = 0);
                  }, r));
              });
            },
            onLastListenerRemove: function () {
      ...
      (e.chain = function (e) {
        ...
        (e.fromNodeEventEmitter = function (e, t) {
          var n =
            ...
            o = new gt({ onFirstListenerAdd: i, onLastListenerRemove: a });
          return o.event;
        }),
      ...
      function e(t) {
        ...
        h(this, e),
          ...
          (this._perfMon = (null === (n = this._options) || void 0 === n ? void 0 : n._profName)
            ? new ft(this._options._profName)
            : void 0);
      }
      return (
        d(e, [
              ...
              return (
                this._event ||
                  (this._event = function (n, r, i) {
                    var a;
                    t._listeners || (t._listeners = new dt());
                    ...
                    o && t._options && t._options.onFirstListenerDidAdd && t._options.onFirstListenerDidAdd(t),
                      t._options && t._options.onListenerDidAdd && t._options.onListenerDidAdd(t, n, r);
                    var l,
                      c = null === (a = t._leakageMon) || void 0 === a ? void 0 : a.check(t._listeners.size);
                    return (
                      (l = {
                        dispose: function () {
                          (c && c(), (l.dispose = e._noop), t._disposed) ||
                            (s(),
                            t._options &&
                      ...
                      i instanceof N ? i.add(l) : Array.isArray(i) && i.push(l),
                      l
                    );
                  }),
                this._event
            ...
            value: function (e) {
              ...
              if (this._listeners) {
                ...
                for (
                  ...
                  var o = F(this._deliveryQueue.shift(), 2),
                    s = o[0],
                    l = o[1];
                  try {
                    "function" === typeof s ? s.call(void 0, l) : s[0].call(s[1], l);
                  } catch (h) {
                    m(h);
                  }
                }
    ...
    ((bt = vt || (vt = {})).isCancellationToken = function (e) {
      return (
        e === bt.None ||
        e === bt.Cancelled ||
        e instanceof yt ||
      ...
      (bt.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: ut.None })),
      (bt.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: _t }));
    var wt,
      yt = (function () {
        function e() {
        ...
        return (
          d(e, [
            ...
            },
            {
              ...
              get: function () {
                return this._isCancelled ? _t : (this._emitter || (this._emitter = new gt()), this._emitter.event);
              },
            },
            {
              key: "dispose",
        ...
        return (
          d(e, [
            ...
            },
            {
              key: "cancel",
              value: function () {
                this._token ? this._token instanceof yt && this._token.cancel() : (this._token = vt.Cancelled);
              },
            },
            {
              key: "dispose",
              value: function () {
                ...
                e && this.cancel(),
                  ...
                  this._token ? this._token instanceof yt && this._token.dispose() : (this._token = vt.None);
              },
            },
          ]),
          e
      ...
      kt = (function () {
        function e() {
          h(this, e), (this._keyCodeToStr = []), (this._strToKeyCode = Object.create(null));
        }
        return (
          d(e, [
            {
    ...
    !(function () {
      function e(e, t) {
        ...
        St.define(e, t), xt.define(e, n), Lt.define(e, r);
      }
      e(0, "unknown"),
        e(1, "Backspace"),
        e(2, "Tab"),
      ...
      (function (e) {
        (e.toString = function (e) {
          return St.keyCodeToStr(e);
        }),
          (e.fromString = function (e) {
            return St.strToKeyCode(e);
          }),
          ...
          (e.fromUserSettings = function (e) {
            return xt.strToKeyCode(e) || Lt.strToKeyCode(e);
          });
      })(wt || (wt = {}));
    var Ct,
      Et,
      ...
      cn = (function () {
        function e(t, n, r) {
          h(this, e), (this.offset = 0 | t), (this.type = n), (this.language = r);
        }
        return (
          d(e, [
            {
    ...
    (hn.CtrlCmd = 2048), (hn.Shift = 1024), (hn.Alt = 512), (hn.WinCtrl = 256);
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = (function e(t, n, r, i) {
                  var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : $e;
                  if (r.length > a.maxLen) {
                    var o = t - a.maxLen / 2;
                    return o < 0 ? (o = 0) : (i += o), e(t, n, (r = r.substring(o, t + a.maxLen / 2)), i, a);
                  }
                  for (
                    var s = Date.now(), l = t - 1 - i, c = -1, h = null, u = 1;
                    !(Date.now() - s >= a.timeBudget);
                    u++
                  ) {
                    var d = l - a.windowSize * u;
                    n.lastIndex = Math.max(0, d);
                    var p = Ze(n, r, l, c);
                    if (!p && h) break;
                    if (((h = p), d <= 0)) break;
                    c = d;
                  ...
                  if (h) {
                    var m = { word: h[0], startColumn: i + 1 + h.index, endColumn: i + 1 + h.index + h[0].length };
                      ...
                      for (;;)
                        switch ((s.prev = s.next)) {
                          case 0:
                            ...
                            return (l = i.substring(o[a].start, o[a].end)), (a += 1), (s.next = 6), l;
                          case 6:
                            s.next = 16;
                            break;
                          case 8:
                            ...
                            (i = t[r]), (o = n(i, e)), (a = 0), (r += 1), (s.next = 16);
                            break;
                          case 15:
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                try {
                  for (a.s(); !(n = a.n()).done; ) {
                    var o = n.value;
                    i.push({ word: r.substring(o.start, o.end), startColumn: o.start + 1, endColumn: o.end + 1 });
                  }
                } catch (s) {
                  a.e(s);
                } finally {
        ...
        return (
          d(e, [
            ...
            },
            {
              key: "acceptNewModel",
              value: function (e) {
                this._models[e.url] = new dn(xe.parse(e.url), e.lines, e.EOL, e.versionId);
              },
            },
            {
                    ...
                    return x.a.wrap(
                      function (i) {
                        for (;;)
                          switch ((i.prev = i.next)) {
                            case 0:
                              if (((a = this._getModel(e)), (o = this._getModel(t)), a && o)) {
                                i.next = 4;
                                break;
                              }
                            ...
                            case 4:
                              return (
                                ...
                                (h = c.computeDiff()),
                                (u = !(h.changes.length > 0) && this._modelsAreIdentical(a, o)),
                                i.abrupt("return", { quitEarly: h.quitEarly, identical: u, changes: h.changes })
                              );
                            case 10:
                            case "end":
                              return i.stop();
            ...
            },
            {
              ...
              value: function (t, n) {
                return un(
                  ...
                  void 0,
                  x.a.mark(function r() {
                    var i, a, o, s, l, c, h, u, d, p, m, f, g, v, b, w, y, T;
                    return x.a.wrap(
                      function (r) {
                        for (;;)
                          switch ((r.prev = r.next)) {
                              ...
                              (a = []),
                                ...
                                (n = q(n, function (e, t) {
                                  return e.range && t.range
                                    ? ze.compareRangesUsingStarts(e.range, t.range)
                            ...
                            case 14:
                              if (((p = i.getValueInRange(h)), (u = u.replace(/\r\n|\n|\r/g, i.eol)), p !== u)) {
                                r.next = 18;
                                break;
                              }
                              return r.abrupt("continue", 25);
                            case 18:
                              if (!(Math.max(u.length, p.length) > e._diffLimit)) {
                                r.next = 21;
                                break;
                              }
                              return a.push({ range: h, text: u }), r.abrupt("continue", 25);
                            case 21:
                              (m = te(p, u, !1)), (f = i.offsetAt(ze.lift(h).getStartPosition())), (g = _(m));
                              try {
                                for (g.s(); !(v = g.n()).done; )
                                  (b = v.value),
                                    (w = i.positionAt(f + b.originalStart)),
                                    (y = i.positionAt(f + b.originalStart + b.originalLength)),
                                    (T = {
                                    ...
                                    i.getValueInRange(T.range) !== T.text && a.push(T);
                              } catch (k) {
                                g.e(k);
                              } finally {
                                g.f();
                        ...
                        for (;;)
                          switch ((a.prev = a.next)) {
                            ...
                            case 6:
                              ...
                              if (((u = h.value), (d = this._getModel(u)))) {
                                a.next = 11;
                                break;
                              }
                              return a.abrupt("continue", 31);
                            case 11:
                              (p = _(d.words(s))), (a.prev = 12), p.s();
                            case 14:
                              if ((m = p.n()).done) {
                                a.next = 23;
                                break;
                              }
                              if ((f = m.value) !== n && isNaN(Number(f))) {
                                a.next = 18;
                                break;
                              }
                              return a.abrupt("continue", 21);
                            case 18:
                              if ((l.add(f), !(l.size > e._suggestionsLimit))) {
                                a.next = 21;
                                break;
                              }
                              return a.abrupt("break", 33);
                            case 21:
                              a.next = 14;
                              break;
                            case 23:
                              ...
                              break;
                            case 25:
                              (a.prev = 25), (a.t0 = a.catch(12)), p.e(a.t0);
                            case 28:
                              return (a.prev = 28), p.f(), a.finish(28);
                            case 31:
                              a.next = 6;
                              break;
                            case 33:
                              ...
                              break;
                            case 35:
                              (a.prev = 35), (a.t1 = a.catch(4)), c.e(a.t1);
                            case 38:
                              return (a.prev = 38), c.f(), a.finish(38);
                            case 41:
                              return a.abrupt("return", { words: Array.from(l), duration: o.elapsed() });
                            case 42:
                            case "end":
                              return a.stop();
                          }
                      ...
                      function (i) {
                        for (;;)
                          switch ((i.prev = i.next)) {
                            ...
                            case 3:
                              (o = new RegExp(n, r)), (s = Object.create(null)), (l = t.startLineNumber);
                            case 6:
                              if (!(l < t.endLineNumber)) {
                                i.next = 31;
                                break;
                              }
                              (c = a.getLineWords(l, o)), (h = _(c)), (i.prev = 9), h.s();
                            case 11:
                              if ((u = h.n()).done) {
                                i.next = 20;
                                break;
                          ...
                          switch ((a.prev = a.next)) {
                            ...
                            case 3:
                              if (
                                ...
                                (c = o.getWordAtPosition({ lineNumber: t.startLineNumber, column: t.startColumn }, s)))
                              ) {
                                a.next = 9;
                                break;
                              }
                            ...
                            case 9:
                              return (
                                ...
                                (u = ct.INSTANCE.navigateValueSet(t, l, c, h, n)),
                                a.abrupt("return", u)
                              );
                            case 12:
                            case "end":
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                return this._foreignModuleFactory
                  ? ((this._foreignModule = this._foreignModuleFactory(i, t)), Promise.resolve(z(this._foreignModule)))
    ...
    (self.onmessage = function (e) {
      ...
      ((vn = gn || (gn = {})).create = function (e, t) {
        return (
          e === Number.MAX_VALUE && (e = fn.MAX_VALUE),
          t === Number.MAX_VALUE && (t = fn.MAX_VALUE),
          { line: e, character: t }
        );
      }),
      (vn.is = function (e) {
        var t = e;
        return Lr.objectLiteral(t) && Lr.uinteger(t.line) && Lr.uinteger(t.character);
      }),
      ((_n = bn || (bn = {})).create = function (e, t, n, r) {
        if (Lr.uinteger(e) && Lr.uinteger(t) && Lr.uinteger(n) && Lr.uinteger(r))
          return { start: gn.create(e, t), end: gn.create(n, r) };
        if (gn.is(e) && gn.is(t)) return { start: e, end: t };
        throw new Error("Range#create called with invalid arguments[" + e + ", " + t + ", " + n + ", " + r + "]");
      }),
      (_n.is = function (e) {
        var t = e;
        return Lr.objectLiteral(t) && gn.is(t.start) && gn.is(t.end);
      }),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && bn.is(t.range) && (Lr.string(t.uri) || Lr.undefined(t.uri));
          });
      })(wn || (wn = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              Lr.defined(t) &&
              bn.is(t.targetRange) &&
              Lr.string(t.targetUri) &&
              (bn.is(t.targetSelectionRange) || Lr.undefined(t.targetSelectionRange)) &&
              (bn.is(t.originSelectionRange) || Lr.undefined(t.originSelectionRange))
            );
          });
      })(yn || (yn = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              Lr.numberRange(t.red, 0, 1) &&
              Lr.numberRange(t.green, 0, 1) &&
              Lr.numberRange(t.blue, 0, 1) &&
              Lr.numberRange(t.alpha, 0, 1)
            );
          });
      })(Tn || (Tn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return bn.is(t.range) && Tn.is(t.color);
          });
      })(kn || (kn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              Lr.string(t.label) &&
              (Lr.undefined(t.textEdit) || Nn.is(t)) &&
              (Lr.undefined(t.additionalTextEdits) || Lr.typedArray(t.additionalTextEdits, Nn.is))
            );
          });
      })(Sn || (Sn = {})),
      (function (e) {
      ...
      (function (e) {
        (e.create = function (e, t, n, r, i) {
          ...
          return (
            Lr.defined(n) && (a.startCharacter = n),
            Lr.defined(r) && (a.endCharacter = r),
            Lr.defined(i) && (a.kind = i),
            a
          );
        }),
          (e.is = function (e) {
            var t = e;
            return (
              Lr.uinteger(t.startLine) &&
              Lr.uinteger(t.startLine) &&
              (Lr.undefined(t.startCharacter) || Lr.uinteger(t.startCharacter)) &&
              (Lr.undefined(t.endCharacter) || Lr.uinteger(t.endCharacter)) &&
              (Lr.undefined(t.kind) || Lr.string(t.kind))
            );
          });
      })(Ln || (Ln = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && wn.is(t.location) && Lr.string(t.message);
          });
      })(Cn || (Cn = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          var t = e;
          return void 0 !== t && null !== t && Lr.string(t.href);
        };
      })(Mn || (Mn = {})),
      (function (e) {
        (e.create = function (e, t, n, r, i, a) {
          ...
          return (
            Lr.defined(n) && (o.severity = n),
            Lr.defined(r) && (o.code = r),
            Lr.defined(i) && (o.source = i),
            Lr.defined(a) && (o.relatedInformation = a),
            o
          );
        }),
          (e.is = function (e) {
            ...
            return (
              ...
              bn.is(n.range) &&
              Lr.string(n.message) &&
              (Lr.number(n.severity) || Lr.undefined(n.severity)) &&
              (Lr.integer(n.code) || Lr.string(n.code) || Lr.undefined(n.code)) &&
              (Lr.undefined(n.codeDescription) ||
                Lr.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) &&
              (Lr.string(n.source) || Lr.undefined(n.source)) &&
              (Lr.undefined(n.relatedInformation) || Lr.typedArray(n.relatedInformation, Cn.is))
            );
          });
      })(Rn || (Rn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          return Lr.defined(n) && n.length > 0 && (i.arguments = n), i;
        }),
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && Lr.string(t.title) && Lr.string(t.command);
          });
      })(In || (In = {})),
      (function (e) {
        (e.replace = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.objectLiteral(t) && Lr.string(t.newText) && bn.is(t.range);
          });
      })(Nn || (Nn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              Lr.objectLiteral(t) &&
              Lr.string(t.label) &&
              (Lr.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) &&
              (Lr.string(t.description) || void 0 === t.description)
            );
          });
      })(Un || (Un = {})),
      (function (e) {
      ...
      (function (e) {
        (e.replace = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return Nn.is(t) && (Un.is(t.annotationId) || Hn.is(t.annotationId));
          });
      })(zn || (zn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && Xn.is(t.textDocument) && Array.isArray(t.edits);
          });
      })(Wn || (Wn = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              Lr.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.overwrite || Lr.boolean(t.options.overwrite)) &&
                  (void 0 === t.options.ignoreIfExists || Lr.boolean(t.options.ignoreIfExists)))) &&
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              Lr.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.recursive || Lr.boolean(t.options.recursive)) &&
                  (void 0 === t.options.ignoreIfNotExists || Lr.boolean(t.options.ignoreIfNotExists)))) &&
              (void 0 === t.annotationId || Hn.is(t.annotationId))
            );
          });
      })(Pn || (Pn = {})),
          ...
          return (
            ...
            (void 0 === t.documentChanges ||
              t.documentChanges.every(function (e) {
                return Lr.string(e.kind) ? On.is(e) || Dn.is(e) || Pn.is(e) : Wn.is(e);
              }))
          );
        };
      })(qn || (qn = {}));
      ...
      Object.defineProperty(e.prototype, "edit", {
        ...
        (e.prototype.getTextEditChange = function (e) {
          if (Xn.is(e)) {
            ...
            if (!(r = this._textEditChanges[t.uri])) {
              ...
              this._workspaceEdit.documentChanges.push(n),
                (r = new kr(i, this._changeAnnotations)),
          ...
          if (!(r = this._textEditChanges[e])) {
            var i = [];
            (this._workspaceEdit.changes[e] = i), (r = new kr(i)), (this._textEditChanges[e] = r);
          }
          return r;
        }),
        (e.prototype.initDocumentChanges = function () {
          void 0 === this._workspaceEdit.documentChanges &&
            ...
            ((this._changeAnnotations = new Sr()),
        ...
        (e.prototype.createFile = function (e, t, n) {
          ...
          var r, i, a;
          if (
            (Un.is(t) || Hn.is(t) ? (r = t) : (n = t),
            void 0 === r
              ? (i = On.create(e, n))
              : ((a = Hn.is(r) ? r : this._changeAnnotations.manage(r)), (i = On.create(e, n, a))),
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
          ...
          var i, a, o;
          if (
            (Un.is(n) || Hn.is(n) ? (i = n) : (r = n),
            void 0 === i
              ? (a = Dn.create(e, t, r))
              : ((o = Hn.is(i) ? i : this._changeAnnotations.manage(i)), (a = Dn.create(e, t, r, o))),
        ...
        (e.prototype.deleteFile = function (e, t, n) {
          ...
          if (
            ...
            void 0 === r
              ? (i = Pn.create(e, n))
              : ((a = Hn.is(r) ? r : this._changeAnnotations.manage(r)), (i = Pn.create(e, n, a))),
            this._workspaceEdit.documentChanges.push(i),
            void 0 !== a)
          )
            return a;
    ...
    !(function (e) {
      (e.create = function (e) {
        ...
        (e.is = function (e) {
          var t = e;
          return Lr.defined(t) && Lr.string(t.uri);
        });
    })(Kn || (Kn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && Lr.string(t.uri) && Lr.integer(t.version);
          });
      })(Yn || (Yn = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && Lr.string(t.uri) && (null === t.version || Lr.integer(t.version));
          });
      })(Xn || (Xn = {})),
      (function (e) {
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            var t = e;
            return (
              Lr.defined(t) && Lr.string(t.uri) && Lr.string(t.languageId) && Lr.integer(t.version) && Lr.string(t.text)
            );
          });
      })(Jn || (Jn = {})),
      (function (e) {
      ...
      (function (e) {
        e.is = function (e) {
          var t = e;
          return Lr.objectLiteral(e) && Qn.is(t.kind) && Lr.string(t.value);
        };
      })($n || ($n = {})),
      (function (e) {
        (e.Text = 1),
      ...
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return t && Lr.string(t.newText) && bn.is(t.insert) && bn.is(t.replace);
          });
      })(nr || (nr = {})),
      (function (e) {
      ...
      (function (e) {
        (e.fromPlainText = function (e) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.string(t) || (Lr.objectLiteral(t) && Lr.string(t.language) && Lr.string(t.value));
          });
      })(or || (or = {})),
      (function (e) {
        e.is = function (e) {
          ...
          return (
            !!t &&
            Lr.objectLiteral(t) &&
            ($n.is(t.contents) || or.is(t.contents) || Lr.typedArray(t.contents, or.is)) &&
            (void 0 === e.range || bn.is(e.range))
          );
        };
      })(sr || (sr = {})),
      (function (e) {
      ...
      (function (e) {
        e.create = function (e, t) {
          for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
          var i = { label: e };
          return Lr.defined(t) && (i.documentation = t), Lr.defined(n) ? (i.parameters = n) : (i.parameters = []), i;
        };
      })(cr || (cr = {})),
      (function (e) {
        ...
        (e.create = function (e, t, n, r, i, a) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              Lr.number(t.kind) &&
              bn.is(t.range) &&
              bn.is(t.selectionRange) &&
              (void 0 === t.detail || Lr.string(t.detail)) &&
              (void 0 === t.deprecated || Lr.boolean(t.deprecated)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            ...
            return (
              Lr.defined(t) &&
              Lr.typedArray(t.diagnostics, Rn.is) &&
              (void 0 === t.only || Lr.typedArray(t.only, Lr.string))
            );
          });
      })(vr || (vr = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          var r = { title: e },
            i = !0;
          return (
            "string" === typeof t ? ((i = !1), (r.kind = t)) : In.is(t) ? (r.command = t) : (r.edit = t),
            i && void 0 !== n && (r.kind = n),
            r
          );
        }),
          (e.is = function (e) {
            ...
            return (
              t &&
              Lr.string(t.title) &&
              (void 0 === t.diagnostics || Lr.typedArray(t.diagnostics, Rn.is)) &&
              (void 0 === t.kind || Lr.string(t.kind)) &&
              (void 0 !== t.edit || void 0 !== t.command) &&
              (void 0 === t.command || In.is(t.command)) &&
              (void 0 === t.isPreferred || Lr.boolean(t.isPreferred)) &&
      ...
      (function (e) {
        (e.create = function (e, t) {
          var n = { range: e };
          return Lr.defined(t) && (n.data = t), n;
        }),
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && bn.is(t.range) && (Lr.undefined(t.command) || In.is(t.command));
          });
      })(_r || (_r = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && Lr.uinteger(t.tabSize) && Lr.boolean(t.insertSpaces);
          });
      })(wr || (wr = {})),
      (function (e) {
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            var t = e;
            return Lr.defined(t) && bn.is(t.range) && (Lr.undefined(t.target) || Lr.string(t.target));
          });
      })(yr || (yr = {})),
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (t) {
            var n = t;
            return void 0 !== n && bn.is(n.range) && (void 0 === n.parent || e.is(n.parent));
          });
      })(Tr || (Tr = {}));
    var xr;
    !(function (e) {
      (e.create = function (e, t, n, r) {
        ...
        (e.is = function (e) {
          ...
          return !!(
            Lr.defined(t) &&
            Lr.string(t.uri) &&
            (Lr.undefined(t.languageId) || Lr.string(t.languageId)) &&
            Lr.uinteger(t.lineCount) &&
            Lr.func(t.getText) &&
            Lr.func(t.positionAt) &&
            Lr.func(t.offsetAt)
          );
        }),
        ...
        return (
          ...
          (e.prototype.positionAt = function (e) {
            ...
            var t = this.getLineOffsets(),
              n = 0,
              r = t.length;
            if (0 === r) return gn.create(0, e);
            for (; n < r; ) {
              var i = Math.floor((n + r) / 2);
              t[i] > e ? (r = i) : (n = i + 1);
            }
            var a = n - 1;
            return gn.create(a, e - t[a]);
          }),
    ...
    var Er,
      ...
      Nr = (function () {
        ...
        return (
            ...
            for (var r = 0, i = t; r < i.length; r++) {
              ...
              if (e.isIncremental(a)) {
                ...
                var c = Math.max(o.start.line, 0),
                  ...
                  u = this._lineOffsets,
                  d = Ur(a.text, !1, s);
                if (h - c === d.length) for (var p = 0, m = d.length; p < m; p++) u[p + c + 1] = d[p];
                else
                  d.length < 1e4
                    ? u.splice.apply(u, [c + 1, h - c].concat(d))
                    : (this._lineOffsets = u = u.slice(0, c + 1).concat(d, u.slice(h + 1)));
                var f = a.text.length - (l - s);
                if (0 !== f) for (p = c + 1 + d.length, m = u.length; p < m; p++) u[p] = u[p] + f;
              } else {
          ...
          (e.prototype.getLineOffsets = function () {
            return void 0 === this._lineOffsets && (this._lineOffsets = Ur(this._content, !0)), this._lineOffsets;
          }),
          (e.prototype.positionAt = function (e) {
            e = Math.max(Math.min(e, this._content.length), 0);
            var t = this.getLineOffsets(),
    ...
    function Ur(e, t, n) {
      ...
      for (var r = t ? [n] : [], i = 0; i < e.length; i++) {
        var a = e.charCodeAt(i);
        (13 !== a && 10 !== a) ||
          (13 === a && i + 1 < e.length && 10 === e.charCodeAt(i + 1) && i++, r.push(n + i + 1));
      }
      return r;
    }
    function Hr(e) {
    ...
    !(function (e) {
      (e.create = function (e, t, n, r) {
        ...
        (e.update = function (e, t, n) {
          if (e instanceof Nr) return e.update(t, n), e;
        ...
        (e.applyEdits = function (e, t) {
          for (
            ...
            l > r && i.push(n.substring(r, l)), s.newText.length && i.push(s.newText), (r = e.offsetAt(s.range.end));
          }
      ...
      ((Rr || (Rr = {})).LATEST = {
        textDocument: {
          completion: { completionItem: { documentationFormat: [Qn.Markdown, Qn.PlainText] } },
          hover: { contentFormat: [Qn.Markdown, Qn.PlainText] },
        },
      }),
      (function (e) {
        (e[(e.Unknown = 0)] = "Unknown"),
    ...
    var Wr = Vn(),
          ...
          (e.prototype.skipWhitespace = function () {
            return (
              this.advanceWhileChar(function (e) {
                return e === Jr || e === Qr || e === Kr || e === Xr || e === Yr;
              }) > 0
            );
          }),
      ...
      Jr = " ".charCodeAt(0),
      Qr = "\t".charCodeAt(0),
      $r = { "text/x-handlebars-template": !0 };
    function Zr(e, t, n, r) {
      void 0 === t && (t = 0), void 0 === n && (n = Mr.WithinContent), void 0 === r && (r = !1);
      var i,
        a,
        o,
        s,
        ...
        scan: function () {
          var e = c.pos(),
            ...
            n = (function e() {
              var t,
                n = c.pos();
              if (c.eos()) return m(n, Ar.EOS);
              switch (h) {
                case Mr.WithinComment:
                  return c.advanceIfChars([Pr, Pr, Fr])
                    ? ((h = Mr.WithinContent), m(n, Ar.EndCommentTag))
                    : (c.advanceUntilChars([Pr, Pr, Fr]), m(n, Ar.Comment));
                case Mr.WithinDoctype:
                  return c.advanceIfChar(Fr)
                    ? ((h = Mr.WithinContent), m(n, Ar.EndDoctypeTag))
                    : (c.advanceUntilChar(Fr), m(n, Ar.Doctype));
                case Mr.WithinContent:
                  if (c.advanceIfChar(qr)) {
                    if (!c.eos() && c.peekChar() === Dr) {
                      if (c.advanceIfChars([Dr, Pr, Pr])) return (h = Mr.WithinComment), m(n, Ar.StartCommentTag);
                      if (c.advanceIfRegExp(/^!doctype/i)) return (h = Mr.WithinDoctype), m(n, Ar.StartDoctypeTag);
                    }
                    return c.advanceIfChar(jr)
                      ? ((h = Mr.AfterOpeningEndTag), m(n, Ar.EndTagOpen))
                      : ((h = Mr.AfterOpeningStartTag), m(n, Ar.StartTagOpen));
                  }
                  return c.advanceUntilChar(qr), m(n, Ar.Content);
                case Mr.AfterOpeningEndTag:
                  return p().length > 0
                    ? ((h = Mr.WithinEndTag), m(n, Ar.EndTag))
                    : c.skipWhitespace()
                      ? m(
                          n,
                          Ar.Whitespace,
                          Wr("error.unexpectedWhitespace", "Tag name must directly follow the open bracket."),
                        )
                      : ((h = Mr.WithinEndTag),
                        c.advanceUntilChar(Fr),
                        n < c.pos() ? m(n, Ar.Unknown, Wr("error.endTagNameExpected", "End tag name expected.")) : e());
                case Mr.WithinEndTag:
                  if (c.skipWhitespace()) return m(n, Ar.Whitespace);
                  if (c.advanceIfChar(Fr)) return (h = Mr.WithinContent), m(n, Ar.EndTagClose);
                  if (r && c.peekChar() === qr)
                    return (
                      (h = Mr.WithinContent),
                      m(n, Ar.EndTagClose, Wr("error.closingBracketMissing", "Closing bracket missing."))
                    );
                  t = Wr("error.closingBracketExpected", "Closing bracket expected.");
                  break;
                case Mr.AfterOpeningStartTag:
                  return (
                    (o = p()),
                    (l = void 0),
                    (s = void 0),
                    o.length > 0
                      ? ((a = !1), (h = Mr.WithinTag), m(n, Ar.StartTag))
                      : c.skipWhitespace()
                        ? m(
                            n,
                            Ar.Whitespace,
                        ...
                        : ((h = Mr.WithinTag),
                          c.advanceUntilChar(Fr),
                          n < c.pos()
                            ? m(n, Ar.Unknown, Wr("error.startTagNameExpected", "Start tag name expected."))
                            : e())
                  );
                case Mr.WithinTag:
                  return c.skipWhitespace()
                    ? ((a = !0), m(n, Ar.Whitespace))
                    : a && (s = c.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()).length > 0
                      ? ((h = Mr.AfterAttributeName), (a = !1), m(n, Ar.AttributeName))
                      : c.advanceIfChars([jr, Fr])
                        ? ((h = Mr.WithinContent), m(n, Ar.StartTagSelfClose))
                        : c.advanceIfChar(Fr)
                          ? ((h =
                              "script" === o
                                ? l && $r[l]
                                  ? Mr.WithinContent
                                  : Mr.WithinScriptContent
                                : "style" === o
                                  ? Mr.WithinStyleContent
                                  : Mr.WithinContent),
                            m(n, Ar.StartTagClose))
                          : r && c.peekChar() === qr
                            ? ((h = Mr.WithinContent),
                              m(n, Ar.StartTagClose, Wr("error.closingBracketMissing", "Closing bracket missing.")))
                            : (c.advance(1),
                              m(n, Ar.Unknown, Wr("error.unexpectedCharacterInTag", "Unexpected character in tag.")));
                case Mr.AfterAttributeName:
                  return c.skipWhitespace()
                    ? ((a = !0), m(n, Ar.Whitespace))
                    : c.advanceIfChar(Br)
                      ? ((h = Mr.BeforeAttributeValue), m(n, Ar.DelimiterAssign))
                      : ((h = Mr.WithinTag), e());
                case Mr.BeforeAttributeValue:
                  if (c.skipWhitespace()) return m(n, Ar.Whitespace);
                  var i = c.advanceIfRegExp(/^[^\s"'`=<>]+/);
                  if (i.length > 0)
                    return (
                      c.peekChar() === Fr && c.peekChar(-1) === jr && (c.goBack(1), (i = i.substr(0, i.length - 1))),
                      "type" === s && (l = i),
                      (h = Mr.WithinTag),
                      (a = !1),
                      m(n, Ar.AttributeValue)
                    );
                  var u = c.peekChar();
                  return u === Vr || u === Gr
                    ? (c.advance(1),
                      c.advanceUntilChar(u) && c.advance(1),
                      "type" === s && (l = c.getSource().substring(n + 1, c.pos() - 1)),
                      (h = Mr.WithinTag),
                      (a = !1),
                      m(n, Ar.AttributeValue))
                    : ((h = Mr.WithinTag), (a = !1), e());
                case Mr.WithinScriptContent:
                  for (var d = 1; !c.eos(); ) {
                    var f = c.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
                    if (0 === f.length) return c.goToEnd(), m(n, Ar.Script);
                    if ("\x3c!--" === f) 1 === d && (d = 2);
                    else if ("--\x3e" === f) d = 1;
                    else if ("/" !== f[1]) 2 === d && (d = 3);
                    else {
                  ...
                  return (h = Mr.WithinContent), n < c.pos() ? m(n, Ar.Script) : e();
                case Mr.WithinStyleContent:
                  return c.advanceUntilRegExp(/<\/style/i), (h = Mr.WithinContent), n < c.pos() ? m(n, Ar.Styles) : e();
              }
              return c.advance(1), (h = Mr.WithinContent), m(n, Ar.Unknown, t);
            })();
          return n === Ar.EOS || e !== c.pos() || (r && (n === Ar.StartTagClose || n === Ar.EndTagClose))
            ? n
    ...
    function ii(e) {
      for (
        var t = Zr(e, void 0, void 0, !0),
          n = new ri(0, e.length, [], void 0),
          r = n,
          i = -1,
          a = void 0,
          o = null,
        ...
        switch (s) {
          case Ar.StartTagOpen:
            var l = new ri(t.getTokenOffset(), e.length, [], r);
            r.children.push(l), (r = l);
            break;
          case Ar.StartTag:
            r.tag = t.getTokenText();
            break;
          case Ar.StartTagClose:
            r.parent &&
              ((r.end = t.getTokenEnd()),
              t.getTokenLength()
                ? ((r.startTagEnd = t.getTokenEnd()), r.tag && ni(r.tag) && ((r.closed = !0), (r = r.parent)))
                : (r = r.parent));
            break;
          case Ar.StartTagSelfClose:
          ...
          case Ar.EndTagClose:
            ...
            break;
          case Ar.AttributeName:
            (o = t.getTokenText()), (h = r.attributes) || (r.attributes = h = {}), (h[o] = null);
            break;
          case Ar.AttributeValue:
            var h,
              u = t.getTokenText();
    ...
    function fi(e, t) {
      ...
      return (ci <= n && n <= hi) || (ui <= n && n <= di) || (pi <= n && n <= mi);
    }
    function gi(e) {
      return "undefined" !== typeof e;
    }
          ...
          (e.prototype.computeCompletions = function (e, t) {
            return _i(this, void 0, void 0, function () {
              ...
              return wi(this, function (d) {
                switch (d.label) {
                  case 0:
                    (n = { items: [], isIncomplete: !1 }), (r = 0), (i = this.atributeCompletions), (d.label = 1);
                  case 1:
                    return r < i.length
                      ? ((a = i[r]),
                        (function (e) {
                          if (oi(e, "http") || oi(e, "https") || oi(e, "//")) return !1;
                          return !0;
                        })(
                          (o = (function (e) {
                            return oi(e, "'") || oi(e, '"') ? e.slice(1, -1) : e;
                          })(e.getText(a.range))),
                        )
                          ? "." !== o && ".." !== o
                            ? [3, 2]
                      ...
                      (s = (function (e, t, n) {
                        ...
                        if (-1 === i)
                          r = (function (e, t, n) {
                            var r = Si(e.start, t),
                              i = Si(e.end, n);
                            return bn.create(r, i);
                          })(n, 1, -1);
                        else {
                          var a = t.slice(i + 1),
                            o = Si(n.end, -1 - a.length),
                            s = a.indexOf(" "),
                            l = void 0;
                          (l = -1 !== s ? Si(o, s) : Si(n.end, -1)), (r = bn.create(o, l));
                        }
                        return r;
                      })(a.value, o, a.range)),
                  ...
                  case 3:
                    for (l = d.sent(), c = 0, h = l; c < h.length; c++) (u = h[c]), n.items.push(u);
                    d.label = 4;
                  case 4:
                    return r++, [3, 1];
                  case 5:
          ...
          (e.prototype.providePathSuggestions = function (e, t, n, r) {
            return _i(this, void 0, void 0, function () {
              ...
              return wi(this, function (p) {
                switch (p.label) {
                  case 0:
                    if (((i = e.substring(0, e.lastIndexOf("/") + 1)), !(a = r.resolveReference(i || ".", n.uri))))
                      return [3, 4];
                    p.label = 1;
                  case 1:
                  ...
                  case 2:
                    for (s = p.sent(), l = 0, c = s; l < c.length; l++)
                      (h = c[l]),
                        (u = h[0]),
                        (d = h[1]),
                        u.charCodeAt(0) !== Ti && o.push(ki(u, d === Ir.Directory, t));
                    return [2, o];
                  case 3:
                    return p.sent(), [3, 4];
                  case 4:
    ...
    function ki(e, t, n) {
      return t
        ? {
            label: (e += "/"),
            kind: Zn.Folder,
            textEdit: Nn.replace(n, e),
            command: { title: "Suggest", command: "editor.action.triggerSuggest" },
          }
        : { label: e, kind: Zn.File, textEdit: Nn.replace(n, e) };
    }
    function Si(e, t) {
      return gn.create(e.line, e.character + t);
    }
    var xi = {
        a: "href",
        area: "href",
        ...
        return (
          ...
          (e.prototype._doComplete = function (e, t, n, r) {
            ...
            var u,
              ...
              p = "";
            function m(t, n) {
              return void 0 === n && (n = c), t > c && (t = c), { start: e.positionAt(t), end: e.positionAt(n) };
            }
            function f(e, t) {
              var n = m(e, t);
              return (
                o.forEach(function (e) {
                  e.provideTags().forEach(function (e) {
                    i.items.push({
                      label: e.name,
                      kind: Zn.Property,
                      documentation: bi(e, void 0, s),
                      textEdit: Nn.replace(n, e.name),
                      insertTextFormat: er.PlainText,
                    });
                  });
                }),
                i
            ...
            function v(e, t, n) {
              void 0 === n && (n = c);
              var r = m(e, n),
                a = Ri(l, n, Mr.WithinEndTag, Ar.EndTagClose) ? "" : ">",
                u = h;
              for (t && (u = u.parent); u; ) {
                var d = u.tag;
                if (d && (!u.closed || (u.endTagStart && u.endTagStart > c))) {
                  var p = {
                      ...
                      kind: Zn.Property,
                      filterText: "/" + d,
                      textEdit: Nn.replace(r, "/" + d + a),
                      insertTextFormat: er.PlainText,
                    },
                    f = g(u.start),
                    v = g(e - 1);
                  if (null !== f && null !== v && f !== v) {
                    var b = f + "</" + d + a;
                    (p.textEdit = Nn.replace(m(e - 1 - v.length), b)), (p.filterText = v + "</" + d);
                  }
                  ...
                  o.forEach(function (e) {
                    e.provideTags().forEach(function (e) {
                      i.items.push({
                        ...
                        documentation: bi(e, void 0, s),
                        filterText: "/" + e.name + a,
                        textEdit: Nn.replace(r, "/" + e.name + a),
                        insertTextFormat: er.PlainText,
                      });
                    });
                  }),
            ...
            function b(t, n) {
              ...
              if (!ni(n)) {
                ...
                i.items.push({
                  ...
                  kind: Zn.Property,
                  filterText: "</" + n + ">",
                  textEdit: Nn.insert(a, "$0</" + n + ">"),
                  insertTextFormat: er.Snippet,
                });
              }
              return i;
            }
            function _(e, t) {
              return f(e, t), v(e, !0, t), i;
            }
            function w(e, t) {
              void 0 === t && (t = c);
              for (var r = c; r < t && "<" !== l[r]; ) r++;
              var a = m(e, r),
                h = Ri(l, t, Mr.AfterAttributeName, Ar.DelimiterAssign) ? "" : '="$1"',
                  ...
                  e.provideAttributes(p).forEach(function (e) {
                    if (!u[e.name]) {
                      ...
                      "v" !== e.valueSet &&
                        ...
                        i.items.push({
                          label: e.name,
                          kind: "handler" === e.valueSet ? Zn.Function : Zn.Value,
                          documentation: bi(e, void 0, s),
                          textEdit: Nn.replace(a, n),
                          insertTextFormat: er.Snippet,
                          command: t,
                        });
                    }
            ...
            function y(n, r) {
              var h, d, f, g;
              if ((void 0 === r && (r = c), c > n && c <= r && ((g = l[n]), /^["']*$/.test(g)))) {
                var v = n + 1,
                  b = r;
                r > n && l[r - 1] === l[n] && b--;
                ...
                (h = m(_, w)), (f = c >= v && c <= b ? l.substring(v, c) : ""), (d = !1);
              } else (h = m(n, r)), (f = l.substring(n, c)), (d = !0);
              if (a.length > 0)
                for (var y = p.toLowerCase(), T = u.toLowerCase(), k = m(n, r), x = 0, L = a; x < L.length; x++) {
                  var C = L[x];
                  C.onHtmlAttributeValue &&
                    C.onHtmlAttributeValue({ document: e, position: t, tag: y, attribute: T, value: f, range: k });
                }
              return (
                o.forEach(function (e) {
            ...
            function T(e) {
              return c === d.getTokenEnd() && (L = d.scan()) === e && d.getTokenOffset() === c ? d.getTokenEnd() : c;
            }
            function k() {
              for (var n = 0, r = a; n < r.length; n++) {
                var i = r[n];
                i.onHtmlContent && i.onHtmlContent({ document: e, position: t });
              }
              return S();
            }
            function S() {
              for (var e = c - 1, n = t.character; e >= 0 && fi(l, e); ) e--, n--;
              if (e >= 0 && "&" === l[e]) {
                var r = bn.create(gn.create(t.line, n - 1), t);
                for (var a in ai)
                  if (si(a, ";")) {
                    var o = "&" + a;
                    i.items.push({
                      label: o,
                      kind: Zn.Keyword,
                      documentation: Ei("entity.propose", "Character entity representing '" + ai[a] + "'"),
                      textEdit: Nn.replace(r, o),
                      insertTextFormat: er.PlainText,
                    });
                  }
              }
            ...
            function x(e, t) {
              ...
              i.items.push({
                ...
                textEdit: Nn.replace(n, "!DOCTYPE html>"),
                insertTextFormat: er.PlainText,
              });
            }
            for (var L = d.scan(); L !== Ar.EOS && d.getTokenOffset() <= c; ) {
              switch (L) {
                case Ar.StartTagOpen:
                  if (d.getTokenEnd() === c) {
                    var C = T(Ar.StartTag);
                    return 0 === t.line && x(c, C), _(c, C);
                  }
                  break;
                case Ar.StartTag:
                  if (d.getTokenOffset() <= c && c <= d.getTokenEnd()) return f(d.getTokenOffset(), d.getTokenEnd());
                  p = d.getTokenText();
                  break;
                case Ar.AttributeName:
                  if (d.getTokenOffset() <= c && c <= d.getTokenEnd()) return w(d.getTokenOffset(), d.getTokenEnd());
                  u = d.getTokenText();
                  break;
                case Ar.DelimiterAssign:
                  if (d.getTokenEnd() === c) {
                    C = T(Ar.AttributeValue);
                    return y(c, C);
                  }
                  break;
                case Ar.AttributeValue:
                  if (d.getTokenOffset() <= c && c <= d.getTokenEnd()) return y(d.getTokenOffset(), d.getTokenEnd());
                  break;
                case Ar.Whitespace:
                  if (c <= d.getTokenEnd())
                    switch (d.getScannerState()) {
                      case Mr.AfterOpeningStartTag:
                        return _(d.getTokenOffset(), T(Ar.StartTag));
                      case Mr.WithinTag:
                      case Mr.AfterAttributeName:
                  ...
                  break;
                case Ar.EndTagOpen:
                  if (c <= d.getTokenEnd()) return v(d.getTokenOffset() + 1, !1, T(Ar.EndTag));
                  break;
                case Ar.EndTag:
                  if (c <= d.getTokenEnd())
                    for (var E = d.getTokenOffset() - 1; E >= 0; ) {
                      var A = l.charAt(E);
                      if ("/" === A) return v(E, !1, d.getTokenEnd());
                      if (!Mi(A)) break;
                      E--;
                    }
                  break;
                case Ar.StartTagClose:
                  if (c <= d.getTokenEnd() && p) return b(d.getTokenEnd(), p);
                  break;
                case Ar.Content:
          ...
          (e.prototype.doTagComplete = function (e, t, n) {
            ...
            if (">" === i) {
              if (
                ...
                for (var a = (s = Zr(e.getText(), o.start)).scan(); a !== Ar.EOS && s.getTokenEnd() <= r; ) {
                  if (a === Ar.StartTagClose && s.getTokenEnd() === r) return "$0</" + o.tag + ">";
                  a = s.scan();
                }
            } else if ("/" === i) {
              ...
              if (o && o.tag) {
                var s;
                for (a = (s = Zr(e.getText(), o.start)).scan(); a !== Ar.EOS && s.getTokenEnd() <= r; ) {
                  if (a === Ar.EndTagOpen && s.getTokenEnd() === r) return o.tag + ">";
                  a = s.scan();
                }
              }
            }
          ...
          (e.prototype.doesSupportMarkdown = function () {
            var e, t, n;
            if (!gi(this.supportsMarkdown)) {
              if (!gi(this.lsOptions.clientCapabilities)) return (this.supportsMarkdown = !0), this.supportsMarkdown;
              var r =
                null ===
                  (n =
                    null ===
              ...
              this.supportsMarkdown = Array.isArray(r) && -1 !== r.indexOf(Qn.Markdown);
            }
    ...
    function Ri(e, t, n, r) {
      for (var i = Zr(e, t, n), a = i.scan(); a === Ar.Whitespace; ) a = i.scan();
      return a === r;
    }
    var Ii = Vn(),
      Ni = (function () {
        ...
        return (
          (e.prototype.doHover = function (e, t, n, r) {
            ...
            var c = this.dataManager.getDataProviders().filter(function (t) {
                    ...
                    if (
                      (n.provideTags().forEach(function (n) {
                        if (n.name.toLowerCase() === e.toLowerCase()) {
                          var i = bi(n, r, a);
                          i || (i = { kind: a ? "markdown" : "plaintext", value: "" }), (o = { contents: i, range: t });
                        }
                      }),
                      o)
                    )
            ...
            function u(t, n) {
              for (
                var r = Zr(e.getText(), n), i = r.scan();
                i !== Ar.EOS && (r.getTokenEnd() < o || (r.getTokenEnd() === o && i !== t));

              )
                i = r.scan();
              return i === t && o <= r.getTokenEnd()
                ? { start: e.positionAt(r.getTokenOffset()), end: e.positionAt(r.getTokenEnd()) }
                : null;
            }
            if (s.endTagStart && o >= s.endTagStart) {
              var d = u(Ar.EndTag, s.endTagStart);
              return d ? h(s.tag, d) : null;
            }
            var p = u(Ar.StartTag, s.start);
            if (p) return h(s.tag, p);
            var m = u(Ar.AttributeName, s.start);
            if (m)
              return (function (e, t, n) {
                ...
                return null;
              })((v = s.tag), e.getText(m), m);
            var f = (function () {
              for (var e = o - 1, n = t.character; e >= 0 && fi(l, e); ) e--, n--;
              for (var r = e + 1, i = n; fi(l, r); ) r++, i++;
              if (e >= 0 && "&" === l[e]) {
                return ";" === l[r]
                  ? bn.create(gn.create(t.line, n), gn.create(t.line, i + 1))
                  : bn.create(gn.create(t.line, n), gn.create(t.line, i));
              }
              return null;
            })();
            if (f)
              return (function (e, t) {
                var n = (function (e) {
                  ...
                  for (; t >= 0 && fi(e, t); ) t--;
                  t += 1;
                  for (; fi(e, t); ) (n += e[t]), (t += 1);
                  return (n += ";");
                })(e);
                for (var r in ai) {
                  var a = null;
                  if (n === "&" + r) {
                    var s = ai[r].charCodeAt(0).toString(16).toUpperCase(),
                      l = "U+";
                    if (s.length < 4) for (var c = 4 - s.length, h = 0; h < c; ) (l += "0"), (h += 1);
                    l += s;
                    var u = Ii(
                      "entity.propose",
                      "Character entity representing '" + ai[r] + "', unicode equivalent '" + l + "'",
                    );
                    a = u ? { contents: u, range: t } : null;
                  }
                  if (a) return (a.contents = i(a.contents)), a;
                }
                return null;
              })(l, f);
            var g = u(Ar.AttributeValue, s.start);
            if (g) {
              var v = s.tag,
                b = (function (e) {
                ...
                _ = (function (t, n) {
                  for (var r = Zr(e.getText(), t), i = r.scan(), a = void 0; i !== Ar.EOS && r.getTokenEnd() <= n; )
                    (i = r.scan()) === Ar.AttributeName && (a = r.getTokenText());
                  return a;
                ...
                return (function (e, t, n, o) {
                  for (
                    var s = function (s) {
                        var l = null;
                        if (
                          (s.provideValues(e, t).forEach(function (e) {
                          ...
                          return (l.contents = i(l.contents)), { value: l };
                      },
                      l = 0,
                      h = c;
                    l < h.length;
          ...
          (p.prototype.eatString = function (e) {
            ...
            (p.prototype.beautify = function () {
              ...
              (this._output = new i(this._options, n)),
                ...
                (this._ch = null);
              for (
                var r, p, m = 0, f = !1, g = !1, v = !1, b = !1, _ = !1, w = this._ch;
                ...
                if ("/" === this._ch && "*" === this._input.peek()) {
                  ...
                  if ((this.preserveSingleSpace(r), "{" === this._input.peek()))
                    ...
                    k.match(/[ :]$/) &&
                      ...
                      this.print_string(k),
                      (this._output.space_before_token = !0)),
                      "extend" === (k = k.replace(/\s$/, "")) ? (b = !0) : "import" === k && (_ = !0),
                      k in this.NESTED_AT_RULE
                        ? ((this._nestedLevel += 1), k in this.CONDITIONAL_GROUP_RULE && (v = !0))
                  ...
                  "#" === this._ch && "{" === this._input.peek()
                    ...
                    : "{" === this._ch
                      ? (g && ((g = !1), this.outdent()),
                        v
                          ? ((v = !1), (f = this._indentLevel >= this._nestedLevel))
                                ...
                                ? this._input.lookBack("url")
                                  ? (this.print_string(this._ch),
                                    ...
                                    ")" === this._ch || '"' === this._ch || "'" === this._ch
                                      ? this._input.back()
                                      : this._ch &&
                                        (this.print_string(this._ch + this.eatString(")")), m && (m--, this.outdent())))
                                  : (this.preserveSingleSpace(r),
                                    this.print_string(this._ch),
                                    this.eatWhitespace(),
                                    m++,
      ...
      zi = (function (e) {
        ...
        function (e, t, n) {
          ...
          (l.prototype.tokenize = function () {
            ...
            for (var t = new i(s.START, ""), n = null, r = [], o = new a(); t.type !== s.EOF; ) {
              ...
              o.isEmpty() || ((e.comments_before = o), (o = new a())),
                ...
                this._is_opening(e)
                  ? (r.push(n), (n = e))
                  : n && this._is_closing(e, n) && ((e.opened = n), (n.closed = e), (n = r.pop()), (e.parent = n)),
                (e.previous = t),
                (t.next = e),
                this.__tokens.add(e),
                (t = e);
                ...
                "{" === t &&
                  ...
                  this._disabled.smarty ||
                    (this._disabled.django &&
                      ...
                      (e =
                        (e =
                          (e = e || this.__patterns.smarty_comment.read()) || this.__patterns.smarty_literal.read()) ||
              ...
              if ("" !== t.text) {
                ...
                if (a)
                  if (i) {
                    ...
                    (u.prototype = this._options.raw_options), (a = i(c + a, new u()));
                  } else {
              ...
              return (
                ...
                0 !== t.text.indexOf("</")
                  ? (e.traverse_whitespace(t),
                    ...
                    e.print_token(t))
                  : (e.add_raw_token(t), (i.start_tag_token = this._tag_stack.try_pop(i.tag_name))),
                ...
                i.tag_complete || i.is_unformatted || (e.alignment_size = i.alignment_size),
                i
              );
            });
          var f = function (e, t) {
          ...
          (m.prototype._get_tag_open_token = function (e) {
            ...
            (m.prototype._set_tag_position = function (e, t, n, r, i) {
              if (
                ...
                ("!--" === n.tag_name && i.type === o.TAG_CLOSE && r.is_end_tag && -1 === n.text.indexOf("\n")) ||
          ...
          (m.prototype._do_optional_end_element = function (e) {
            ...
            if (!e.is_empty_element && e.is_start_tag && e.parent) {
              if ("body" === e.tag_name) t = t || this._tag_stack.try_pop("head");
                ...
                (n && -1 !== v.indexOf(n.tag_name)) || (t = t || this._tag_stack.try_pop("p"));
              } else
                          ...
                          : "tbody" === e.tag_name || "tfoot" === e.tag_name
                            ...
                            : "tr" === e.tag_name
                              ...
                              : ("th" !== e.tag_name && "td" !== e.tag_name) ||
                                (t =
                                  (t =
                                    t || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])) ||
                      ...
                      (n =
                        (n =
                          (n =
                            (n =
                              (n =
                                (n = (n = n || this._read_open_handlebars(r, t)) || this._read_attribute(r, e, t)) ||
                                this._read_close(r, t)) || this._read_raw_content(r, e, t)) ||
                            this._read_content_word(r)) || this._read_comment_or_cdata(r)) ||
              ...
              "<" === e &&
                ("!" === this._input.peek(1) &&
                  ((n = this.__patterns.comment.read())
                    ? (r = c.get_directives(n)) && "start" === r.ignore && (n += c.readIgnored(this._input))
                ...
                t ||
                  (this._options.indent_handlebars &&
                    ...
                    ("!" === this._input.peek(2)
                      ...
                      : ((n = this.__patterns.handlebars_open.read()), (r = this._create_token(l.TAG_OPEN, n))))),
                r
              );
            }),
                ...
                t &&
                  ("<" === t.text[0] && (">" === e || ("/" === e && ">" === this._input.peek(1)))
                    ...
                    : "{" === t.text[0] &&
                      "}" === e &&
                      "}" === this._input.peek(1) &&
                      (this._input.next(), this._input.next(), (r = this._create_token(l.TAG_CLOSE, "}}")))),
                r
              );
            }),
              ...
              if (n && "<" === n.text[0])
                if ("=" === e) r = this._create_token(l.EQUALS, this._input.next());
                  ...
                  (i = this.__patterns.attribute.read()) &&
                    (r = t.type === l.EQUALS ? this._create_token(l.VALUE, i) : this._create_token(l.ATTRIBUTE, i));
              return r;
            }),
    ...
    function Wi(e, t, n) {
      var r = e.getText(),
        ...
        o = n.tabSize || 4;
      if (t) {
        for (var s = e.offsetAt(t.start), l = s; l > 0 && Fi(r, l - 1); ) l--;
        0 === l || qi(r, l - 1) ? (s = l) : l < s && (s = l + 1);
        for (var c = e.offsetAt(t.end), h = c; h < r.length && Fi(r, h); ) h++;
        (h === r.length || qi(r, h)) && (c = h), (t = bn.create(e.positionAt(s), e.positionAt(c)));
        var u = r.substring(0, s);
        if (new RegExp(/.*[<][^>]*$/).test(u)) return [{ range: t, newText: (r = r.substring(s, c)) }];
        if (((i = c === r.length), (r = r.substring(s, c)), 0 !== s)) {
          var d = e.offsetAt(gn.create(t.start.line, 0));
          a = (function (e, t, n) {
            var r = t,
              i = 0,
              a = n.tabSize || 4;
      ...
      } else t = bn.create(gn.create(0, 0), e.positionAt(r.length));
      var p = {
          indent_size: o,
          indent_char: n.insertSpaces ? " " : "\t",
          indent_empty_lines: Oi(n, "indentEmptyLines", !1),
          wrap_line_length: Oi(n, "wrapLineLength", 120),
          unformatted: Di(n, "unformatted", void 0),
          content_unformatted: Di(n, "contentUnformatted", void 0),
          indent_inner_html: Oi(n, "indentInnerHtml", !1),
          preserve_newlines: Oi(n, "preserveNewLines", !0),
          max_preserve_newlines: Oi(n, "maxPreserveNewLines", 32786),
          indent_handlebars: Oi(n, "indentHandlebars", !1),
          end_with_newline: i && Oi(n, "endWithNewline", !1),
          extra_liners: Di(n, "extraLiners", void 0),
          wrap_attributes: Oi(n, "wrapAttributes", "auto"),
          wrap_attributes_indent_size: Oi(n, "wrapAttributesIndentSize", void 0),
          eol: "\n",
          indent_scripts: Oi(n, "indentScripts", "normal"),
          templating: Pi(n, "all"),
          unformatted_content_delimiter: Oi(n, "unformattedContentDelimiter", ""),
        },
        m = (function (e, t) {
          return zi(e, t, Ui, Hi);
        })(r.replace(/^\s+/, ""), p);
      if (a > 0) {
        var f = n.insertSpaces ? li(" ", o * a) : li("\t", a);
    ...
    function Pi(e, t) {
      return !0 === Oi(e, "templating", t) ? ["auto"] : ["none"];
    }
    function qi(e, t) {
      return -1 !== "\r\n".indexOf(e.charAt(t));
    }
    ...
    function Gi(e, t, n, r, i, a) {
      ...
      if (
            ...
            return (
              ...
              /^https?:\/\//i.test(t) || /^file:\/\//i.test(t)
                ...
                : /^\#/i.test(t)
                  ? e + t
                  : /^\/\//i.test(t)
                    ? (oi(e, "https://") ? "https" : "http") + ":" + t.replace(/^\s*/g, "")
                    : n
        ...
        if (
          ...
          (function (e) {
            try {
              return ji.a.parse(e), !0;
            } catch (t) {
              return !1;
            }
          })(c)
        )
          return { range: bn.create(e.positionAt(r), e.positionAt(i)), target: c };
      }
    }
    function Vi(e, t) {
      for (var n = [], r = Zr(e.getText(), 0), i = r.scan(), a = void 0, o = !1, s = void 0, l = {}; i !== Ar.EOS; ) {
        switch (i) {
          case Ar.StartTag:
          ...
          case Ar.AttributeValue:
            if ("src" === a || "href" === a) {
              ...
              if (!o) (d = Gi(e, t, c, r.getTokenOffset(), r.getTokenEnd(), s)) && n.push(d);
              o && "undefined" === typeof s && (s = Bi(c)) && t && (s = t.resolveReference(s, e.uri)),
                (o = !1),
                (a = void 0);
            } else if ("id" === a) {
              l[Bi(r.getTokenText())] = r.getTokenOffset();
            }
        }
        i = r.scan();
      }
    ...
    function Ki(e, t, n) {
      ...
      if (!i.tag) return [];
      var a = [],
        o = Ji(Ar.StartTag, e, i.start),
        s = "number" === typeof i.endTagStart && Ji(Ar.EndTag, e, i.endTagStart);
      return (
        ((o && Xi(o, t)) || (s && Xi(s, t))) &&
          (o && a.push({ kind: hr.Read, range: o }), s && a.push({ kind: hr.Read, range: s })),
        a
      );
    }
    function Yi(e, t) {
    ...
    function Xi(e, t) {
      return Yi(e.start, t) && Yi(t, e.end);
    }
    function Ji(e, t, n) {
      for (var r = Zr(t.getText(), n), i = r.scan(); i !== Ar.EOS && i !== e; ) i = r.scan();
      return i !== Ar.EOS ? { start: t.positionAt(r.getTokenOffset()), end: t.positionAt(r.getTokenEnd()) } : null;
    }
    function Qi(e, t) {
      var n = [];
      return (
        t.roots.forEach(function (t) {
          !(function e(t, n, r, i) {
            var a = (function (e) {
              ...
              o = wn.create(t.uri, bn.create(t.positionAt(n.start), t.positionAt(n.end))),
              s = { name: a, location: o, containerName: r, kind: dr.Field };
            i.push(s),
    ...
    function Zi(e, t, n) {
      ...
      if (i.start + "<".length <= r && r <= i.start + "<".length + i.tag.length) {
        var a = r - "<".length - i.start + i.endTagStart + "</".length;
        return e.positionAt(a);
      }
      if (i.endTagStart + "</".length <= r && r <= i.endTagStart + "</".length + i.tag.length) {
    ...
    function ea(e, t, n) {
      ...
      return i.endTagStart &&
        ((i.start + "<".length <= r && r <= i.start + "<".length + a) ||
          (i.endTagStart + "</".length <= r && r <= i.endTagStart + "</".length + a))
        ? [
            bn.create(e.positionAt(i.start + "<".length), e.positionAt(i.start + "<".length + a)),
            bn.create(e.positionAt(i.endTagStart + "</".length), e.positionAt(i.endTagStart + "</".length + a)),
          ]
        : null;
    }
    function ta(e, t) {
        ...
        switch (r) {
          ...
          case Ar.StartTagSelfClose:
            ...
            if (u >= 0) {
              var d = a[u];
              (a.length = u),
                (m = e.positionAt(n.getTokenOffset()).line - 1) > (h = d.startLine) &&
                  s !== h &&
            ...
            if (p)
              if (p[1]) a.push({ startLine: h, tagName: "" });
                ...
                if (u >= 0) {
                  ...
                  d = a[u];
                  (a.length = u),
                    (m = h) > (h = d.startLine) && s !== h && l({ startLine: h, endLine: m, kind: xn.Region });
                }
              }
            else
              h < (m = e.positionAt(n.getTokenOffset() + n.getTokenLength()).line) &&
                l({ startLine: h, endLine: m, kind: xn.Comment });
        }
        r = n.scan();
      }
      ...
      return i.length > f
        ? (function (e, t) {
            ...
            for (s = 0; s < e.length; s++) {
              var p = i[s];
              "number" === typeof p && (p < h || (p === h && c++ < t)) && d.push(e[s]);
            }
            return d;
          })(i, f)
        : i;
        ...
        for (
          var n = (function (e, t) {
              var n = ii(e.getText()),
                ...
                a = (function (e) {
                  ...
                  for (; t.parent; )
                    (t = t.parent),
                      ((r = t),
                      r.startTagEnd && r.endTagStart && r.startTagEnd < r.endTagStart
                        ? [
              ...
              if (i.startTagEnd && !i.endTagStart) {
                ...
                var o = bn.create(e.positionAt(i.startTagEnd - 2), e.positionAt(i.startTagEnd));
                "/>" === e.getText(o)
              ...
              if ((a.unshift([i.start, i.end]), i.start < r && r < i.startTagEnd)) {
                a.unshift([i.start + 1, i.startTagEnd - 1]);
                s = ra(e, i, r);
                return (a = s.concat(a));
              }
              return i.startTagEnd <= r && r <= i.endTagStart
                ...
                : (r >= i.endTagStart + 2 && a.unshift([i.endTagStart + 2, i.end - 1]), a);
            })(e, t),
            r = void 0,
            i = void 0,
            a = n.length - 1;
          ...
          var o = n[a];
          (r && o[0] === r[0] && o[1] === r[1]) ||
            (i = Tr.create(bn.create(e.positionAt(n[a][0]), e.positionAt(n[a][1])), i)),
            (r = o);
        }
        return i || (i = Tr.create(bn.create(t, t))), i;
      });
    }
    function ra(e, t, n) {
      for (
        var r = bn.create(e.positionAt(t.start), e.positionAt(t.end)),
          i = e.getText(r),
          a = n - t.start,
          o = Zr(i),
          s = o.scan(),
      ...
      aa = (function () {
        ...
        return (
          (e.prototype.setDataProviders = function (e, t) {
            var n;
            (this.dataProviders = []),
              e && this.dataProviders.push(new vi("html5", ia)),
          ...
          (this._ctx = e),
            ...
            (this._languageService = (function (e) {
              ...
              return {
                ...
                format: Wi,
                findDocumentHighlights: Ki,
                findDocumentLinks: Vi,
                findDocumentSymbols: Qi,
                getFoldingRanges: ta,
                getSelectionRanges: na,
        ...
        return (
            ...
            return la(this, void 0, void 0, function () {
              ...
              return ca(this, function (o) {
                return (
                  ...
                  (i = sa(sa({}, this._languageSettings.format), n)),
          ...
          (e.prototype._getTextDocument = function (e) {
            for (var t = 0, n = this._ctx.getMirrorModels(); t < n.length; t++) {
              var r = n[t];
              if (r.uri.toString() === e) return Er.create(e, this._languageId, r.version, r.getValue());
            }
            return null;
          }),
          e
